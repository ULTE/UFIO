...
int main()
{
	::ufio::iobuf_io_file file(::ufio::io_cookie_type<::ufio::native_file>, u8"io_file_deco.txt", ::ufio::open_mode::out);

	::ufio::operations::add_io_decos(file, bidecorator{});
	::ufio::io::print(file, "Hello World\nHello World\nHello World\nHello World\nHello World\nHello World\nHello World\nHello World\nHello World\nHello World\nHello World\n");
}
