...
public:
	...
	using observer_type = decltype(::ufio::operations::io_stream_ref(*((handle_type *)nullptr)));
	...
	constexpr basic_generic_posix_dev_urandom()
		: handle(u8"/dev/urandom", ::ufio::open_mode::in)
	{}
...
using basic_posix_dev_urandom = basic_generic_posix_dev_urandom<::ufio::basic_posix_file<char_type>, char_type>;
