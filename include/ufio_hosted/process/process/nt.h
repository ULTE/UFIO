...
inline void close_nt_user_process_information_not_null(nt_user_process_information hnt_user_process_info) noexcept
{
	...
	{
		::ufio::win32::nt::nt_close<family == nt_family::zw>(hnt_user_process_info.hthread);
		hnt_user_process_info.hthread = nullptr;
	}
	if (hnt_user_process_info.hprocess) [[likely]]
	{
		::ufio::win32::nt::nt_close<family == nt_family::zw>(hnt_user_process_info.hprocess);
...
{
	return ::ufio::win32::nt::nt_wait_for_single_object<family == nt_family::zw>(hprocess_thread, false, nullptr);
}
...
inline void nt_wait_and_close_user_process_or_thread(void *handle) noexcept(!throw_eh)
{
	...
	::ufio::win32::nt::nt_close<family == nt_family::zw>(handle);
...
struct rtl_guard
{
	...
	constexpr ~rtl_guard()
	{
		if (rtl_up) [[likely]]
		{
			::ufio::win32::nt::RtlDestroyProcessParameters(rtl_up);
			rtl_up = nullptr;
		}
	};
...
struct unicode_string_guard
{
	...
	constexpr ~unicode_string_guard()
	{
		if (us) [[likely]]
		{
			::ufio::native_thread_local_allocator::deallocate(us);
			us = nullptr;
		}
	};
	constexpr void clear() noexcept
...
inline void nt_duplicate_object_std(void *parent_process, void *&standard_io_handle, void *process_handle)
{
	...
	check_nt_status(::ufio::win32::nt::nt_duplicate_object<family>(
...
inline void *nt_duplicate_process_std_handle_impl(void *__restrict hprocess, win32_io_redirection const &redi)
{
	...
	{
		check_nt_status(::ufio::win32::nt::nt_duplicate_object<zw>(
																			...
																			void *__restrict remote_peb)
{
	...
	::ufio::win32::nt::nt_query_object<zw>(fhandle, object_information_class::ObjectNameInformation, nullptr, 0,
											  __builtin_addressof(NtImagePath_len));
	auto NtImagePath{
		reinterpret_cast<unicode_string *>(::ufio::native_thread_local_allocator::allocate(NtImagePath_len))};
	unicode_string_guard us_man{NtImagePath};
	check_nt_status(::ufio::win32::nt::nt_query_object<zw>(fhandle, object_information_class::ObjectNameInformation,
	...
	if (args)
	{
		...
		ps_para.Length = static_cast<decltype(ps_para.Length)>(::ufio::cstr_len(args) * sizeof(char16_t));
		ps_para.MaximumLength = static_cast<decltype(ps_para.MaximumLength)>(ps_para.Length + sizeof(char16_t));
	}
	rtl_user_process_parameters *rtl_up{};
	check_nt_status(::ufio::win32::nt::RtlCreateProcessParameters(
	...
	auto const current_peb{::ufio::win32::nt::nt_get_current_peb()};
	...
	if (!processio.in.is_dev_null)
	{
		if (processio.in.win32_pipe_in_handle && *processio.in.win32_pipe_in_handle)
		{
			...
			::ufio::win32::nt::object_handle_attribute_information ohaoi{.Inherit = 1};
			check_nt_status(::ufio::win32::nt::nt_set_information_object<zw>(*processio.in.win32_pipe_out_handle,
																				::ufio::win32::nt::object_information_class::ObjectHandleFlagInformation,
	...
	if (!processio.out.is_dev_null)
	{
		if (processio.out.win32_pipe_out_handle && *processio.out.win32_pipe_out_handle)
		{
			...
			::ufio::win32::nt::object_handle_attribute_information ohaoi{.Inherit = 1};
			check_nt_status(::ufio::win32::nt::nt_set_information_object<zw>(*processio.out.win32_pipe_in_handle,
																				::ufio::win32::nt::object_information_class::ObjectHandleFlagInformation,
																				__builtin_addressof(ohaoi), static_cast<::std::uint_least32_t>(sizeof(ohaoi))));
		}
	...
	if (!processio.err.is_dev_null)
	{
		if (processio.err.win32_pipe_out_handle && *processio.err.win32_pipe_out_handle)
		{
			...
			::ufio::win32::nt::object_handle_attribute_information ohaoi{.Inherit = 1};
			check_nt_status(::ufio::win32::nt::nt_set_information_object<zw>(*processio.err.win32_pipe_in_handle,
																				::ufio::win32::nt::object_information_class::ObjectHandleFlagInformation,
																				__builtin_addressof(ohaoi), static_cast<::std::uint_least32_t>(sizeof(ohaoi))));
		}
	...
	check_nt_status(::ufio::win32::nt::nt_allocate_virtual_memory<zw>(
	...
	check_nt_status(
		::ufio::win32::nt::nt_write_virtual_memory<zw>(hprocess, RemoteParameters, rtl_up, rtl_up->Length, nullptr));

	/* Write the PEB Pointer */
	check_nt_status(::ufio::win32::nt::nt_write_virtual_memory<zw>(
															 ...
															 win32_process_io const &__restrict processio)
{
	...
	// Section
	void *hsection{};
	check_nt_status(::ufio::win32::nt::nt_create_section<zw>(
	...
	// Process
	void *hprocess{};
	check_nt_status(::ufio::win32::nt::nt_create_process<zw>(
	...
	check_nt_status(::ufio::win32::nt::nt_query_information_process<zw>(
	...
	check_nt_status(
		::ufio::win32::nt::nt_query_section<zw>(hsection, section_information_class::SectionImageInformation,
												   __builtin_addressof(sec_info), sizeof(sec_info), nullptr));

	check_nt_status(::ufio::win32::nt::RtlCreateUserThread(
	...
	check_nt_status(::ufio::win32::nt::nt_resume_thread<zw>(hthread, __builtin_addressof(lprevcount)));
															 ...
															 win32_process_io const &__restrict processio)
{
	...
	check_nt_status(::ufio::win32::nt::RtlCreateProcessParametersEx(
	...
	::ufio::win32::nt::section_image_information sif{};
	...
	::ufio::win32::nt::ps_std_handle_info pshi{};
	...
	void *hProcess{};
	void *hThread{};
	check_nt_status(::ufio::win32::nt::nt_create_user_process<zw>(
...
template <nt_family family, typename path_type>
inline nt_user_process_information nt_create_process_overloads(::ufio::nt_fs_dirent ent, nt_process_args const &args,
															   nt_process_envs const &envs,
															   win32_process_io const &processio)
{
...
inline nt_wait_status wait(nt_family_process_observer<family> ppob) noexcept(!throw_eh)
{
	...
	// get exit code
	::ufio::win32::nt::process_basic_information pbi{};
	auto const status2{
		::ufio::win32::nt::nt_query_information_process<family == nt_family::zw>(ppob.hnt_user_process_info.hprocess,
																					::ufio::win32::nt::process_information_class::ProcessBasicInformation,
...
public:
	...
	explicit nt_family_process(::ufio::nt_fs_dirent ent, nt_process_args const &args, nt_process_envs const &envs,
							   win32_process_io const &processio)
		: nt_family_process_observer<family>{
