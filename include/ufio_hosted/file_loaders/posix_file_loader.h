...
inline char *posix_load_address_options(int fd, ::std::size_t file_size, ::ufio::posix_mmap_options const &options)
{
	if (file_size == 0)
	{
...
{
	posix_file pf(::ufio::freestanding::forward<Args>(args)...);
	return posix_load_address_impl(pf.fd);
}

inline posix_file_loader_return_value_t posix_load_address_options_impl(::ufio::posix_mmap_options const &options,
																		int fd)
{
	::std::size_t size{posix_loader_get_file_size(fd)};
...
template <typename... Args>
inline auto posix_load_file_options_impl(::ufio::posix_mmap_options const &options, Args &&...args)
{
	posix_file pf(::ufio::freestanding::forward<Args>(args)...);
...
public:
	...
	{
		auto ret{::ufio::details::posix_load_address_impl(pate.fd)};
	...
	{
		auto ret{::ufio::details::posix_load_file_impl(fsdirent, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	inline explicit posix_file_loader(T const &filename, open_mode om = open_mode::in,
									  perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::details::posix_load_file_impl(filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit posix_file_loader(native_at_entry ent, T const &filename, open_mode om = open_mode::in,
									  perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::details::posix_load_file_impl(ent, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	inline explicit posix_file_loader(posix_mmap_options const &options, posix_at_entry pate)
	{
		auto ret{::ufio::details::posix_load_address_options_impl(options, pate.fd)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	{
		auto ret{::ufio::details::posix_load_file_options_impl(options, fsdirent, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit posix_file_loader(posix_mmap_options const &options, T const &filename,
									  open_mode om = open_mode::in, perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::details::posix_load_file_options_impl(options, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit posix_file_loader(posix_mmap_options const &options, native_at_entry ent, T const &filename,
									  open_mode om = open_mode::in, perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::details::posix_load_file_options_impl(options, ent, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	{
		::ufio::details::posix_unload_address(address_begin,
