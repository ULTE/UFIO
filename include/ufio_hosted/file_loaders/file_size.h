...
namespace ufio::win32::details
{
inline ::std::size_t win32_load_file_get_file_size(void *handle)
{
	::ufio::win32::by_handle_file_information bhdi;
...
struct linux_struct_statx
{
	...
	::ufio::details::linux_statx_timestamp stx_atime;
	::ufio::details::linux_statx_timestamp stx_btime;
	::ufio::details::linux_statx_timestamp stx_ctime;
	::ufio::details::linux_statx_timestamp stx_mtime;
...
inline ::std::size_t posix_loader_get_file_size(int fd)
{
	...
	return ::ufio::win32::details::win32_load_file_get_file_size(
