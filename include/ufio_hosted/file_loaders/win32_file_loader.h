																			   ...
																			   ::std::uint_least32_t dwDesiredAccess)
{
	...
	::ufio::win32_file map_hd{hfilemappingobj};
	auto base_ptr{::ufio::win32::MapViewOfFile(hfilemappingobj, dwDesiredAccess, 0, 0, file_size)};
	if (base_ptr == nullptr)
	{
		throw_win32_error();
	}
...
inline win32_file_loader_return_value_t win32_load_address_impl(void *handle)
{
	...
	if constexpr (family == win32_family::wide_nt)
	{
		return win32_load_address_common_impl(
			::ufio::win32::CreateFileMappingW(handle, nullptr, 0x08, 0, 0, nullptr), file_size);
	}
	else
	{
		return win32_load_address_common_impl(
			::ufio::win32::CreateFileMappingA(handle, nullptr, 0x08, 0, 0, nullptr), file_size);
	}
}
...
{
	::ufio::basic_win32_family_file<family, char> wf(::ufio::freestanding::forward<Args>(args)...);
...
inline win32_file_loader_return_value_t win32_load_address_options_impl(win32_mmap_options const &options, void *handle)
{
...
#endif
		= ::ufio::win32::security_attributes *;
	if constexpr (family == win32_family::wide_nt)
	{
		...
		return win32_load_address_common_options_impl(
			::ufio::win32::CreateFileMappingW(handle, reinterpret_cast<secattr_ptr>(options.lpFileMappingAttributes),
	...
	{
		return win32_load_address_common_options_impl(
			::ufio::win32::CreateFileMappingA(handle, reinterpret_cast<secattr_ptr>(options.lpFileMappingAttributes),
												 options.flProtect, 0, 0,
...
inline void win32_unload_address(void const *address) noexcept
{
	if (address)
	{
		::ufio::win32::UnmapViewOfFile(address);
	}
}
...
public:
	...
	{
		auto ret{::ufio::win32::details::win32_load_address_impl<family>(ent.handle)};
	...
	{
		auto ret{::ufio::win32::details::win32_load_file_impl<family>(fsdirent, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	inline explicit win32_family_file_loader(T const &filename, open_mode om = open_mode::in,
											 perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::win32::details::win32_load_file_impl<family>(filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit win32_family_file_loader(nt_at_entry ent, T const &filename, open_mode om = open_mode::in,
											 perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::win32::details::win32_load_file_impl<family>(ent, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	...
	{
		auto ret{::ufio::win32::details::win32_load_address_options_impl<family>(options, ent.handle)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	{
		auto ret{::ufio::win32::details::win32_load_file_options_impl<family>(options, fsdirent, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit win32_family_file_loader(win32_mmap_options const &options, T const &filename,
											 open_mode om = open_mode::in, perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::win32::details::win32_load_file_options_impl<family>(options, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	template <::ufio::constructible_to_os_c_str T>
	inline explicit win32_family_file_loader(win32_mmap_options const &options, nt_at_entry ent, T const &filename,
											 open_mode om = open_mode::in, perms pm = static_cast<perms>(436))
	{
		auto ret{::ufio::win32::details::win32_load_file_options_impl<family>(options, ent, filename, om, pm)};
		address_begin = ret.address_begin;
		address_end = ret.address_end;
	}
	...
	{
		::ufio::win32::details::win32_unload_address(address_begin);
