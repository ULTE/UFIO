...
{
	constexpr ufio::win32::nt::details::nt_open_mode create_dir_mode{
		ufio::win32::nt::details::calculate_nt_open_mode(
			{ufio::open_mode::creat | ufio::open_mode::directory})};
...
inline void nt_faccessat_impl(void *dirhd, char16_t const *path_c_str, ::std::size_t path_size, access_how mode, nt_at_flags flags)
{
	...
	::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char> file{
	...
	case ::ufio::access_how::w_ok:
	{
		::ufio::win32::nt::file_basic_information fbi;
		::ufio::win32::nt::io_status_block isb;

		auto status{::ufio::win32::nt::nt_query_information_file<zw>(
			file.native_handle(), __builtin_addressof(isb), __builtin_addressof(fbi),
			static_cast<::std::uint_least32_t>(sizeof(fbi)),
			::ufio::win32::nt::file_information_class::FileBasicInformation)};
...
inline void nt_fchmodat_impl(void *dirhd, char16_t const *path_c_str, ::std::size_t path_size, perms pm, nt_at_flags flags)
{
	...
	status = ::ufio::win32::nt::nt_set_information_file<zw>(
		file.native_handle(), __builtin_addressof(isb), __builtin_addressof(fbi),
		static_cast<::std::uint_least32_t>(sizeof(fbi)),
		::ufio::win32::nt::file_information_class::FileBasicInformation);
...
inline posix_file_status nt_fstatat_impl(void *dirhd, char16_t const *path_c_str, ::std::size_t path_size, nt_at_flags flags)
{
	...
	return ::ufio::win32::nt::details::nt_status_impl<(zw ? nt_family::zw : nt_family::nt)>(file.native_handle());
}
							  ...
							  unix_timestamp_option last_access_time, unix_timestamp_option last_modification_time, nt_at_flags flags)
{
	...
	{
		current_time = static_cast<::std::uint_least64_t>(::ufio::win32::nt::RtlGetSystemTimePrecise());
	}
	else
	{
	...
	auto status{::ufio::win32::nt::nt_set_information_file<zw>(
		file.native_handle(), __builtin_addressof(isb), __builtin_addressof(fbi),
		static_cast<::std::uint_least32_t>(sizeof(fbi)),
		::ufio::win32::nt::file_information_class::FileBasicInformation)};
...
template <bool zw>
inline nt_create_file_nothrow_common_return_t nt_create_file_nothrow_common(void *directory, ::ufio::win32::nt::unicode_string *relative_path, nt_open_mode const &mode) noexcept
{
	::ufio::win32::security_attributes sec_attr{sizeof(::ufio::win32::security_attributes), nullptr, true};
	::ufio::win32::nt::object_attributes obj{.Length = sizeof(::ufio::win32::nt::object_attributes),
	...
	void *handle;
	::ufio::win32::nt::io_status_block block;
	auto const status{::ufio::win32::nt::nt_create_file<zw>(
...
struct nt_create_nothrow_callback
{
	...
	[[msvc::forceinline]]
#endif
	auto operator()(void *directory_handle, ::ufio::win32::nt::unicode_string *relative_path) const
	{
							  ...
							  void *newdirhd, char16_t const *newpath_c_str, ::std::size_t newpath_size, nt_at_flags flags)
{
	...
	// use nt path in root
	::ufio::win32::nt::unicode_string us{};
	::ufio::win32::nt::rtl_unicode_string_unique_ptr us_guard{};
	...
	{
		auto rpt{::ufio::win32::nt::RtlDetermineDosPathNameType_U(oldpath_c_str)};
		switch (rpt)
		{
		...
		{
			char16_t buf[32767];
			::std::size_t end{::ufio::win32::nt::RtlGetFullPathName_U(oldpath_c_str, 32767 * sizeof(char16_t), buf, nullptr)};
			if (end == 0) [[unlikely]]
			{
			...
			::ufio::win32::nt::details::nt_file_rtl_path(buf, us, tmp_part_name, tmp_relative_name);
		...
		default:
		{
			...
			char16_t const *tmp_part_name{};
			win32::nt::rtl_relative_name_u tmp_relative_name{};
			::ufio::win32::nt::details::nt_file_rtl_path(
	...
	::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char> check_file{};
	...
	if (!status)
	{
		...
		::ufio::win32::nt::file_basic_information fbi;
		status = ::ufio::win32::nt::nt_query_information_file<zw>(handle, __builtin_addressof(isb), __builtin_addressof(fbi),
																	 static_cast<::std::uint_least32_t>(sizeof(fbi)),
																	 ::ufio::win32::nt::file_information_class::FileBasicInformation);
		if (status) [[unlikely]]
		{
	...
	::ufio::details::local_operator_new_array_ptr<char> buffer(cbReparseData);
	...
	::ufio::freestanding::non_overlapped_copy_n(oldpath_real_c_str, oldpath_real_size, pBufTail);
	...
	::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char> new_file(
		nt_call_callback(newdirhd, newpath_c_str, newpath_size, nt_path, nt_create_callback<zw>{symbol_mode}));

	status = ::ufio::win32::nt::nt_fs_control_file<zw>(
	...
	if (status) [[unlikely]]
	{
		::ufio::win32::nt::file_disposition_information DispInfo{1};
		::ufio::win32::nt::nt_set_information_file<zw>(new_file.native_handle(), __builtin_addressof(isb), __builtin_addressof(DispInfo),
														  static_cast<::std::uint_least32_t>(sizeof(DispInfo)), ::ufio::win32::nt::file_information_class::FileDispositionInformation);
		throw_nt_error(status);
	}
#else
	constexpr nt_open_mode symbol_mode{::ufio::win32::nt::details::calculate_nt_open_mode({::ufio::open_mode::out, static_cast<perms>(436)})};

	::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char8_t> new_file(
		nt_call_callback(newdirhd, newpath_c_str, newpath_size, nt_path, nt_create_callback<zw>{symbol_mode}));

	char8_t buffer[510];
	::ufio::freestanding::my_memset(buffer, u8' ', 510);
	::ufio::u8obuffer_view u8obv{buffer, buffer + 510};
	::ufio::operations::print_freestanding<false>(u8obv, u8"!<symlink>",
													 ::ufio::mnp::code_cvt(::ufio::mnp::strvw(oldpath_c_str, oldpath_c_str + oldpath_size)),
													 u8"\nThis is just a text to force symlink file to be 510 bytes long. Do not delete it nor spaces following it.");

	::ufio::operations::write_all(new_file, buffer, buffer + 510);
#endif
}
							 ...
							 void *newdirhd, char16_t const *newpath_c_str, ::std::size_t newpath_size, nt_at_flags flags)
{
	...
	nt_call_callback(
		...
		[&](void *directory_hd, win32::nt::unicode_string const *ustr) {
			...
			::ufio::details::local_operator_new_array_ptr<char> buffer(sizeof(::ufio::win32::nt::file_rename_information) + pth_size2 + sizeof(char16_t));
			...
			::ufio::win32::nt::file_rename_information *info{reinterpret_cast<file_rename_information_may_alias_ptr>(buffer.get())};
			info->ReplaceIfExists = 1;
			info->RootDirectory = directory_hd;
			info->FileNameLength = pth_size2;
			::ufio::freestanding::my_memcpy(info->FileName, pth_cstr, pth_size2 + sizeof(char16_t));

			::ufio::win32::nt::io_status_block block;
			::std::uint_least32_t status{::ufio::win32::nt::nt_set_information_file<zw>(
				file.handle, __builtin_addressof(block), info,
				static_cast<::std::uint_least32_t>(sizeof(::ufio::win32::nt::file_rename_information) + pth_size2 + sizeof(char16_t)), file_information_class::FileRenameInformation)};
			if (status) [[unlikely]]
			{
				throw_nt_error(status);
			}
						   ...
						   char16_t const *newpath_c_str, ::std::size_t newpath_size, nt_at_flags flags)
{
	...
	::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char> basic_file{};
	::ufio::basic_nt_family_io_observer<(zw ? nt_family::zw : nt_family::nt), char> file{};

	bool const nt_path{(flags & nt_at_flags::nt_path) == nt_at_flags::nt_path};

	if ((flags & nt_at_flags::empty_path) == nt_at_flags::empty_path && oldpath_size == 0)
	{
		file = ::ufio::basic_nt_family_io_observer<(zw ? nt_family::zw : nt_family::nt), char>{olddirhd};
	}
	else
	{
		basic_file = ::ufio::basic_nt_family_file<(zw ? nt_family::zw : nt_family::nt), char>{
			nt_call_callback(olddirhd, oldpath_c_str, oldpath_size, nt_path, nt_create_callback<zw>{md})};
		file = basic_file;
	}
	...
	nt_call_callback(
		...
		[&](void *directory_hd, win32::nt::unicode_string const *ustr) {
			char16_t const *pth_cstr{ustr->Buffer};
			::std::uint_least32_t pth_size2{ustr->Length};
			::ufio::details::local_operator_new_array_ptr<char> buffer(sizeof(::ufio::win32::nt::file_link_information) + pth_size2 + sizeof(char16_t));
			...
			::ufio::win32::nt::file_link_information *info{reinterpret_cast<file_link_information_may_alias_ptr>(buffer.get())};
			...
			::std::uint_least32_t status{::ufio::win32::nt::nt_set_information_file<zw>(
				file.handle, __builtin_addressof(block), info,
				static_cast<::std::uint_least32_t>(sizeof(::ufio::win32::nt::file_link_information) + pth_size2 + sizeof(char16_t)), file_information_class::FileLinkInformation)};
...
template <bool zw, ::ufio::details::posix_api_22 dsp, typename... Args>
...
template <bool zw, ::ufio::details::posix_api_12 dsp, typename... Args>
...
template <bool zw, ::ufio::details::posix_api_1x dsp, typename... Args>
...
template <nt_family family, ::ufio::details::posix_api_1x dsp, typename path_type, typename... Args>
...
template <nt_family family, ::ufio::details::posix_api_12 dsp, ::ufio::constructible_to_os_c_str old_path_type,
...
template <nt_family family, ::ufio::details::posix_api_22 dsp, typename oldpath_type, typename newpath_type, typename... Args>
...
// 1x
template <nt_family family, ::ufio::constructible_to_os_c_str path_type>
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::faccessat>(ent.handle, path, mode, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::faccessat>(ent.handle, path, mode, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::faccessat>(ent.handle, path, mode, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::fchmodat>(ent.handle, path, mode, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline void nt_fchmodat(nt_at_entry ent, path_type const &path, perms mode, nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::fchmodat>(ent.handle, path, mode, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline void zw_fchmodat(nt_at_entry ent, path_type const &path, perms mode, nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::fchmodat>(ent.handle, path, mode, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::fchownat>(ent.handle, path, owner, group, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::fchownat>(ent.handle, path, owner, group, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::fchownat>(ent.handle, path, owner, group, flags);
}
...
{
	return ::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::fstatat>(ent.handle, path, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline posix_file_status nt_fstatat(nt_at_entry ent, path_type const &path, nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	return ::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::fstatat>(ent.handle, path, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline posix_file_status zw_fstatat(nt_at_entry ent, path_type const &path, nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	return ::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::fstatat>(ent.handle, path, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::utimensat>(ent.handle, path, creation_time, last_access_time, last_modification_time, flags);
}
...
inline void nt_utimensat(nt_at_entry ent, path_type const &path, unix_timestamp_option creation_time,
						 ...
						 nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::utimensat>(ent.handle, path, creation_time, last_access_time, last_modification_time, flags);
}
...
inline void zw_utimensat(nt_at_entry ent, path_type const &path, unix_timestamp_option creation_time,
						 ...
						 nt_at_flags flags = nt_at_flags::symlink_nofollow)
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::utimensat>(ent.handle, path, creation_time, last_access_time, last_modification_time, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::mkdirat>(ent.handle, path, pm, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline void nt_mkdirat(nt_at_entry ent, path_type &&path, perms pm = static_cast<perms>(436), nt_at_flags flags = {})
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::mkdirat>(ent.handle, path, pm, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline void zw_mkdirat(nt_at_entry ent, path_type &&path, perms pm = static_cast<perms>(436), nt_at_flags flags = {})
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::mkdirat>(ent.handle, path, pm, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<family, details::posix_api_1x::unlinkat>(ent.handle, path, flags);
}

template <::ufio::constructible_to_os_c_str path_type>
inline void nt_unlinkat(nt_at_entry ent, path_type &&path, nt_at_flags flags = {})
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, details::posix_api_1x::unlinkat>(ent.handle, path,
																								  flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::zw, details::posix_api_1x::unlinkat>(ent.handle, path,
																								  flags);
}

// 12
template <nt_family family, ::ufio::constructible_to_os_c_str old_path_type, ::ufio::constructible_to_os_c_str new_path_type>
	requires(family == nt_family::nt || family == nt_family::zw)
...
{
	::ufio::win32::nt::details::nt_deal_with12<family, details::posix_api_12::symlinkat>(oldpath, newdirfd.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with12<nt_family::nt, details::posix_api_12::symlinkat>(oldpath, newdirfd.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with12<nt_family::zw, details::posix_api_12::symlinkat>(oldpath, newdirfd.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with22<family, ::ufio::details::posix_api_22::renameat>(oldent.handle, oldpath,
...
{
	::ufio::win32::nt::details::nt_deal_with22<nt_family::nt, ::ufio::details::posix_api_22::renameat>(oldent.handle, oldpath,
																											 newent.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with22<nt_family::zw, ::ufio::details::posix_api_22::renameat>(oldent.handle, oldpath,
																											 newent.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with22<family, ::ufio::details::posix_api_22::linkat>(oldent.handle, oldpath,
																									newent.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with22<nt_family::nt, ::ufio::details::posix_api_22::linkat>(oldent.handle, oldpath,
																										   newent.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with22<nt_family::zw, ::ufio::details::posix_api_22::linkat>(oldent.handle, oldpath,
																										   newent.handle, newpath, flags);
}
...
{
	::ufio::win32::nt::details::nt_deal_with1x<nt_family::nt, ::ufio::details::posix_api_1x::unlinkat>(
