...
inline constexpr ::std::conditional_t<
	stem, ::ufio::manipulators::basic_os_str_known_size_without_null_terminated<return_char_type>,
	::ufio::manipulators::basic_os_c_str_with_known_size<return_char_type>>
