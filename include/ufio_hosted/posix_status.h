...
inline constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, ufio::posix_file_status>)
{
...
{
template <::std::integral char_type>
inline constexpr char_type *print_file_status_impl(char_type *iter, ufio::posix_file_status const &status)
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, ufio::posix_file_status>,
												 char_type *iter, ufio::posix_file_status const &status)
{
