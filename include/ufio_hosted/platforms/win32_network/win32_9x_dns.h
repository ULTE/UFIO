...
inline constexpr ::ufio::ip_address hostent_to_ip_address_impl(::ufio::win32::hostent *ent,
																  ::std::size_t pos) noexcept
{
	::ufio::ip_address ipaddr;
	if (ent->h_addrtype == 2)
	{
...
inline constexpr ::ufio::ip hostent_to_ip_impl(::ufio::win32::hostent *ent, ::std::size_t pos,
												  ::std::uint_least16_t port) noexcept
{
	return ::ufio::ip{hostent_to_ip_address_impl(ent, pos), port};
}
...
{
public:
	using native_handle_type = ::ufio::win32::hostent *;
...
inline constexpr ::ufio::ip to_ip(win32_9x_dns_io_observer d, ::std::uint_least16_t port) noexcept
{
	return ::ufio::details::hostent_to_ip_impl(d.res, 0u, port);
}

inline constexpr ::ufio::ip_address to_ip_address(win32_9x_dns_io_observer d) noexcept
{
	return ::ufio::details::hostent_to_ip_address_impl(d.res, 0u);
}
...
inline constexpr ::ufio::ip to_ip(win32_9x_dns_iterator d, ::std::uint_least16_t port)
{
	return ::ufio::details::hostent_to_ip_impl(d.res, d.pos, port);
}

namespace details
{
inline ::ufio::win32::hostent *win32_9x_gethostbyname_impl(char const *name)
{
	::ufio::win32::hostent *ret{::ufio::win32::gethostbyname(name)};
	if (ret == nullptr)
	{
...
struct win32_9x_dns_open_parameter
{
	...
	{
		return ::ufio::details::win32_9x_gethostbyname_impl(node_name_c_str);
	}
};
...
{
	return ::ufio::posix_api_common(t, win32_9x_dns_open_parameter{});
}
...
public:
	...
	explicit win32_9x_dns_file(T const &t)
		: win32_9x_dns_io_observer{::ufio::details::win32_9x_dns_open_impl(t)}
	{
	}
	void close() noexcept
	{
