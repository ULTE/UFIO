...
public:
	...
	using native_handle_type = ::ufio::win32::win32_family_addrinfo<fam> *;
...
namespace details
{
inline constexpr ::ufio::ip_address win32_to_ip_address_with_ai_addr_impl(int ai_family,
...
inline constexpr ::ufio::ip win32_to_ip_with_ai_addr_impl(int ai_family, posix_sockaddr const *ai_addr,
															 ::std::uint_least16_t port) noexcept
{
	return ::ufio::ip{win32_to_ip_address_with_ai_addr_impl(ai_family, ai_addr), port};
}

} // namespace details

template <win32_family fam>
inline constexpr ::ufio::ip to_ip(win32_family_dns_io_observer<fam> d, ::std::uint_least16_t port) noexcept
{
	return ::ufio::details::win32_to_ip_with_ai_addr_impl(d.res->ai_family, d.res->ai_addr, port);
}

template <win32_family fam>
inline constexpr ::ufio::ip_address to_ip_address(win32_family_dns_io_observer<fam> d) noexcept
{
	return ::ufio::details::win32_to_ip_address_with_ai_addr_impl(d.res->ai_family, d.res->ai_addr);
}
...
template <win32_family fam>
inline ::ufio::win32::win32_family_addrinfo<fam> *
win32_getaddrinfo_impl(::std::conditional_t<fam == win32_family::wide_nt, char16_t, char> const *node,
					   ...
					   ::ufio::win32::win32_family_addrinfo<fam> const *hints)
{
	::ufio::win32::win32_family_addrinfo<fam> *res{};
	if constexpr (win32_family::ansi_9x == fam)
	{
		int ret{::ufio::win32::getaddrinfo(node, service, hints, __builtin_addressof(res))};
		if (ret)
		{
	...
	{
		int ret{::ufio::win32::GetAddrInfoW(node, service, hints, __builtin_addressof(res))};
		if (ret)
		{
			throw_win32_error(static_cast<::std::uint_least32_t>(ret));
		}
...
template <::ufio::win32_family fam>
inline void win32_family_freeaddrinfo_impl(::ufio::win32::win32_family_addrinfo<fam> *paddrinfo)
{
	if constexpr (fam == ::ufio::win32_family::ansi_9x)
	{
		::ufio::win32::freeaddrinfo(paddrinfo);
	}
	else
	{
		::ufio::win32::FreeAddrInfoW(paddrinfo);
	}
}
...
{
	constexpr ::ufio::win32::win32_family_addrinfo<fam> info{.ai_family = 0};
...
struct win32_family_dns_open_parameter
{
	...
	{
		return ::ufio::details::win32_family_dns_open_internal_impl<fam>(node_name_c_str);
	}
};
...
{
	return ::ufio::win32_family_api_common<fam>(t, win32_family_dns_open_parameter<fam>{});
}
...
public:
	...
	win32_family_dns_file(char_type const *node, char_type const *service,
						  ::ufio::win32::win32_family_addrinfo<fam> const *hints)
		: win32_family_dns_io_observer<fam>{::ufio::details::win32_getaddrinfo_impl<fam>(node, service, hints)}
	{
	}
	template <typename T>
		requires ::ufio::constructible_to_os_c_str<T>
	explicit win32_family_dns_file(T const &t)
		: win32_family_dns_io_observer<fam>{::ufio::details::win32_family_dns_open_impl<fam>(t)}
	{
	}
	...
	win32_family_dns_file &operator=(win32_family_dns_file &&__restrict other) noexcept
	{
		if (this->res) [[likely]]
		{
			::ufio::details::win32_family_freeaddrinfo_impl<fam>(this->res);
		}
		this->res = other.res;
		other.res = nullptr;
		return *this;
...
using ::ufio::win32::win32_addrinfo_9xa;
using ::ufio::win32::win32_addrinfo_ntw;
using ::ufio::win32::win32_family_addrinfo;
using win32_addrinfo = ::ufio::win32::win32_family_addrinfo<::ufio::win32_family::native>;
