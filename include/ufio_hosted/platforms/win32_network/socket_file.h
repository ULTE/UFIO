...
inline ::std::byte const *win32_socket_write_bytes_impl(::std::size_t socket, ::std::byte const *first,
														::std::byte const *last)
{
	wsabuf buffer{::ufio::details::read_write_bytes_compute<::std::uint_least32_t>(first, last),
				  const_cast<char *>(reinterpret_cast<char const *>(first))};
	::std::uint_least32_t sent{};
	if (::ufio::win32::WSASend(socket, __builtin_addressof(buffer), 1, __builtin_addressof(sent), 0, nullptr,
								  nullptr))
	{
...
{
	int recved{::ufio::win32::recv(socket, reinterpret_cast<char *>(first),
									  ::ufio::details::read_write_bytes_compute<::std::int_least32_t>(first, last),
									  0)};
	if (recved == -1)
	{
		throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
...
{
	if (::ufio::win32::WSAConnect(hsocket, addr, addrlen, nullptr, nullptr, nullptr, nullptr))
	{
		throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
	}
}
...
{
	if (::ufio::win32::bind(hsocket, addr, addrlen) == -1)
	{
		throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
	}
}
...
{
	if (::ufio::win32::listen(hsocket, backlog) == -1)
	{
		throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
	}
}
...
{
	::std::size_t accepted_socket{::ufio::win32::WSAAccept(hsocket, addr, addrlen, nullptr, 0)};
...
{
	auto soc{::ufio::win32::recvfrom(hsocket, reinterpret_cast<char *>(buf), static_cast<int>(len), flags, src_addr, addrlen)};
	if (soc == -1)
	{
		throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
	}
...
{
	auto soc{::ufio::win32::sendto(hsocket, reinterpret_cast<char const *>(msg), static_cast<int>(len), flags, to, tolen)};
...
{
	return ::ufio::win32::details::win32_socket_read_bytes_impl(wiob.hsocket, first, last);
}
...
{
	return ::ufio::win32::details::win32_socket_write_bytes_impl(wiob.hsocket, first, last);
}
...
inline ::std::size_t win32_dup2hsocket(::std::size_t handle, ::std::size_t newhandle)
{
	...
	if (newhandle) [[likely]]
	{
		::ufio::win32::closesocket(newhandle);
	}
	return temp;
}
...
inline ::std::size_t open_win32_socket_raw_impl(int af, int tp, int prt, ::std::uint_least32_t dwflags)
{
	...
	{
		::std::size_t ret{::ufio::win32::WSASocketW(af, tp, prt, nullptr, 0, dwflags)};
		if (ret == UINTPTR_MAX)
		{
			throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
		}
	...
	{
		::std::size_t ret{::ufio::win32::WSASocketA(af, tp, prt, nullptr, 0, dwflags)};
		if (ret == UINTPTR_MAX)
		{
			throw_win32_error(static_cast<::std::uint_least32_t>(::ufio::win32::WSAGetLastError()));
		}
	...
	win32_socket_factory
{
	...
	~win32_socket_factory()
	{
		if (hsocket) [[likely]]
		{
			::ufio::win32::closesocket(hsocket);
		}
	}
};
...
inline win32_socket_factory posix_accept(basic_win32_family_socket_io_observer<family, ch_type> h, void *addr,
										 win32_socklen_t *addrlen)
{
	return win32_socket_factory{::ufio::win32::details::posix_accept_win32_socket_impl(h.hsocket, addr, addrlen)};
}

template <win32_family family, ::std::integral ch_type>
inline win32_socket_factory tcp_accept(basic_win32_family_socket_io_observer<family, ch_type> h)
{
	return win32_socket_factory{::ufio::win32::details::posix_accept_win32_socket_impl(h.hsocket, nullptr, nullptr)};
}
...
public:
	...
	basic_win32_family_socket_file(io_dup_t, basic_win32_family_socket_io_observer<family, ch_type> wsiob)
		: basic_win32_family_socket_io_observer<family, ch_type>{
			  ::ufio::win32::details::win32_duphsocket(wsiob.hsocket)}
	{
	}
	basic_win32_family_socket_file(sock_family d, sock_type t, open_mode m, sock_protocol p)
		: basic_win32_family_socket_file<family, ch_type>{
			  ::ufio::win32::details::open_win32_socket_impl<family>(d, t, m, p)}
	{
	}
	...
	basic_win32_family_socket_file(basic_win32_family_socket_file const &dp)
		: basic_win32_family_socket_io_observer<family, char_type>{
			  ::ufio::win32::details::win32_duphsocket(dp.hsocket)}
	{
	}
	basic_win32_family_socket_file &operator=(basic_win32_family_socket_file const &dp)
	{
		this->hsocket = ::ufio::win32::details::win32_dup2hsocket(dp.hsocket, this->hsocket);
		return *this;
	}
	...
	basic_win32_family_socket_file &operator=(basic_win32_family_socket_file &&__restrict b) noexcept
	{
		...
		{
			::ufio::win32::closesocket(this->hsocket);
		}
	...
	void close()
	{
		if (this->hsocket) [[likely]]
		{
			auto ret{::ufio::win32::closesocket(this->hsocket)};
...
inline void win32_tcp_listen_common_impl(::std::size_t hsocket, ::std::uint_least16_t port)
{
	...
	::ufio::win32::details::posix_bind_win32_socket_impl(hsocket, __builtin_addressof(in), sizeof(in));
	::ufio::win32::details::posix_listen_win32_socket_impl(hsocket, 128);
}
