...
_ZN7ufio7details5win3230crypt_acquire_context_fallbackILNS_12win32_familyE0EEEjv
*/
template <::ufio::win32_family family>
inline ::std::size_t crypt_acquire_context_fallback()
{
	::std::size_t hprov{};
	if constexpr (family == ::ufio::win32_family::ansi_9x)
	{
		if (!::ufio::win32::CryptAcquireContextA(__builtin_addressof(hprov), nullptr, nullptr, 0x1, 0xf0000000))
		{
			::std::uint_least32_t firsterr{::ufio::win32::GetLastError()};
			if (!::ufio::win32::CryptAcquireContextA(
					__builtin_addressof(hprov),
					u8"_ZN7ufio7details5win3230crypt_acquire_context_fallbackILNS_12win32_familyE0EEEjv", nullptr,
					0x1, 0x8))
			{
				if (!::ufio::win32::CryptAcquireContextA(
						__builtin_addressof(hprov),
						u8"_ZN7ufio7details5win3230crypt_acquire_context_fallbackILNS_12win32_familyE0EEEjv",
	...
	{
		if (!::ufio::win32::CryptAcquireContextW(__builtin_addressof(hprov), nullptr, nullptr, 0x1, 0xf0000000))
		{
			::std::uint_least32_t firsterr{::ufio::win32::GetLastError()};
			if (!::ufio::win32::CryptAcquireContextW(
					__builtin_addressof(hprov),
					u"_ZN7ufio7details5win3230crypt_acquire_context_fallbackILNS_12win32_familyE0EEEjv", nullptr,
					0x1, 0x8))
			{
				if (!::ufio::win32::CryptAcquireContextW(
						__builtin_addressof(hprov),
...
struct win32_family_hcryptprov_guard
{
	...
	~win32_family_hcryptprov_guard()
	{
		::ufio::win32::CryptReleaseContext(hprov, 0);
	}
};
...
inline void *create_win32_temp_file_impl()
{
	...
	{
		temp_path_size =
			::ufio::win32::GetTempPathW(maximum_temp_path_size, reinterpret_cast<char_type_may_alias_ptr>(arr));
	}
	else
	{
		temp_path_size =
			::ufio::win32::GetTempPathA(maximum_temp_path_size, reinterpret_cast<char_type_may_alias_ptr>(arr));
	}
	if (temp_path_size == 0)
	{
		throw_win32_error();
	...
	::std::conditional_t<winver_support_rtl_gen_random, ::ufio::details::empty,
						 ::ufio::details::win32::win32_family_hcryptprov_guard<family>>
		hcryptguard;
	for (::std::size_t retries{}; retries != 100; ++retries) // retry 100 times. Or reporting error
	{
		...
		{
			if (!::ufio::win32::SystemFunction036(uuid_buffer, uuid_buffer_sz))
			{
				throw_win32_error();
			}
		}
		...
		{
			if (!::ufio::win32::CryptGenRandom(hcryptguard.hprov, uuid_buffer_sz,
												  reinterpret_cast<char unsigned *>(uuid_buffer)))
			{
				throw_win32_error();
			}
		}
		auto p{::ufio::details::pr_rsv_uuid<false>(arrp, uuid_buffer)};
		if constexpr (is_nt)
		{
		...
		{
			::std::uint_least32_t code{::ufio::win32::GetLastError()};
...
{
	void *ptr{::ufio::win32::CreateIoCompletionPort(filehandle, existing_completionport, completionkey,
	...
	win32_open_mode const &mode)
{
	if constexpr (family == win32_family::wide_nt)
	{
		...
		auto handle(::ufio::win32::CreateFileW(lpFileName, mode.dwDesiredAccess, mode.dwShareMode,
	...
	{
		auto handle(::ufio::win32::CreateFileA(lpFileName, mode.dwDesiredAccess, mode.dwShareMode,
...
template <win32_family family, typename T>
	requires(::ufio::constructible_to_os_c_str<T>)
inline void *win32_create_file_impl(T const &t, open_mode_perms ompm)
{
	return ::ufio::win32_family_api_common<family>(t, win32_family_open_file_parameter<family>{ompm});
}
...
{
	return ::ufio::win32::nt::details::nt_create_file_at_impl<false>(directory_handle, t, ompm);
}
...
{
	return ::ufio::win32::nt::details::nt_family_create_file_fs_dirent_impl<false>(directory_handle, filename_c_str,
...
inline void *win32_dup_impl(void *handle)
{
	...
	void *new_handle{};
	if (!::ufio::win32::DuplicateHandle(current_process, handle, current_process, __builtin_addressof(new_handle), 0,
...
inline void *win32_dup2_impl(void *handle, void *newhandle)
{
	...
	if (newhandle) [[likely]]
	{
		::ufio::win32::CloseHandle(newhandle);
	}
	return temp;
}
...
{
	if (!::ufio::win32::FlushFileBuffers(handle))
	{
		throw_win32_error();
	}
}
...
#else
	::ufio::win32::nt::details::nt_data_sync_impl<false>(handle, flags);
#endif
}
...
{
	::ufio::win32::details::win32_flush_impl(wiob.handle);
}
...
{
	::ufio::win32::details::win32_data_sync_impl(wiob.handle, flags);
}

namespace win32::details
{

inline ::ufio::intfpos_t seek_impl(void *handle, ::ufio::intfpos_t offset, seekdir s)
{
#if (defined(_WIN32_WINNT) && _WIN32_WINNT <= 0x0500) || defined(_WIN32_WINDOWS)
	if constexpr (sizeof(::ufio::intfpos_t) > sizeof(::std::int_least32_t))
	{
		constexpr ::ufio::intfpos_t l32mx{INT_LEAST32_MAX};
		constexpr ::ufio::intfpos_t l32mn{INT_LEAST32_MIN};
	...
	if (::ufio::win32::SetFilePointer(handle, static_cast<::std::int_least32_t>(offset),
										 __builtin_addressof(distance_to_move_high),
										 static_cast<::std::uint_least32_t>(s)) == invalid)
	{
		throw_win32_error();
	}
	return static_cast<::ufio::intfpos_t>(distance_to_move_high);
#else
	if constexpr (sizeof(::ufio::intfpos_t) > sizeof(::std::int_least64_t))
	{
		constexpr ::ufio::intfpos_t l64mx{INT_LEAST64_MAX};
		constexpr ::ufio::intfpos_t l64mn{INT_LEAST64_MIN};
	...
	if (!::ufio::win32::SetFilePointerEx(handle, static_cast<::std::int_least64_t>(offset),
											__builtin_addressof(distance_to_move_high),
...
inline void win32_calculate_offset_impl(void *__restrict handle, ::ufio::win32::overlapped &overlap,
										::ufio::intfpos_t off)
{
	::std::uint_least64_t u64off{static_cast<::std::uint_least64_t>(
		::ufio::win32::nt::details::nt_calculate_offset_impl(off))};
...
inline ::std::byte *read_or_pread_some_bytes_common_impl(void *__restrict handle, ::std::byte *first, ::std::byte *last,
														 ::ufio::win32::overlapped *lpoverlapped)
{
	::std::uint_least32_t number_of_bytes{};
	if (!::ufio::win32::ReadFile(handle, first,
									::ufio::details::read_write_bytes_compute<::std::uint_least32_t>(first, last),
									__builtin_addressof(number_of_bytes), lpoverlapped)) [[unlikely]]
	{
		auto err(::ufio::win32::GetLastError());
		if (err == 109) [[likely]]
		{
			return first;
		}
...
{
	return ::ufio::win32::details::read_or_pread_some_bytes_common_impl(handle, first, last, nullptr);
}

inline ::std::byte *pread_some_bytes_impl(void *__restrict handle, ::std::byte *first, ::std::byte *last,
										  ::ufio::intfpos_t off)
{
	::ufio::win32::overlapped overlap{};
	::ufio::win32::details::win32_calculate_offset_impl(handle, overlap, off);
	return ::ufio::win32::details::read_or_pread_some_bytes_common_impl(handle, first, last,
...
{
	::std::uint_least32_t number_of_bytes{};
	if (!::ufio::win32::WriteFile(handle, first,
									 ::ufio::details::read_write_bytes_compute<::std::uint_least32_t>(first, last),
...
inline ::std::byte const *write_some_bytes_impl(void *__restrict handle, ::std::byte const *first,
												::std::byte const *last)
{
	return ::ufio::win32::details::write_or_pwrite_some_bytes_common_impl(handle, first, last, nullptr);
}
												 ...
												 ::std::byte const *last, ::ufio::intfpos_t off)
{
	::ufio::win32::overlapped overlap{};
	::ufio::win32::details::win32_calculate_offset_impl(handle, overlap, off);
	return ::ufio::win32::details::write_or_pwrite_some_bytes_common_impl(handle, first, last,
																			 __builtin_addressof(overlap));
}
...
{
	return ::ufio::win32::details::read_some_bytes_impl(wiob.handle, first, last);
}
...
{
	return ::ufio::win32::details::write_some_bytes_impl(wiob.handle, first, last);
}

template <win32_family family, ::std::integral ch_type>
inline ::ufio::intfpos_t io_stream_seek_bytes_define(basic_win32_family_io_observer<family, ch_type> wiob,
														::ufio::intfpos_t off, ::ufio::seekdir sdir)
{
	return ::ufio::win32::details::seek_impl(wiob.handle, off, sdir);
}
...
{
	return ::ufio::win32::details::pread_some_bytes_impl(niob.handle, first, last, off);
}
...
inline ::std::byte const *pwrite_some_bytes_overflow_define(basic_win32_family_io_observer<family, ch_type> niob,
															...
															::ufio::intfpos_t off)
{
	return ::ufio::win32::details::pwrite_some_bytes_impl(niob.handle, first, last, off);
}
...
template <win32_family family, ::std::integral ch_type, typename... Args>
	requires requires(basic_win32_family_io_observer<family, ch_type> h, Args &&...args) {
		::ufio::win32::DeviceIoControl(h.handle, ::std::forward<Args>(args)...);
	}
inline void io_control(basic_win32_family_io_observer<family, ch_type> h, Args &&...args)
{
	if (!ufio::win32::DeviceIoControl(h.handle, ::std::forward<Args>(args)...))
	{
		throw_win32_error();
	}
}
...
struct find_struct_guard
{
	...
	~find_struct_guard()
	{
		...
		{
			::ufio::win32::FindClose(file_struct);
		}
	}
};
...
{
	::ufio::win32::win32_find_dataa wfda{};
	auto temp_find_path{::ufio::tlc::u8concat_ufio_tlc(h.path, u8"\\*")};
	auto find_struct{::ufio::win32::FindFirstFileA(reinterpret_cast<char const *>(temp_find_path.c_str()), __builtin_addressof(wfda))};
	...
	{
		::ufio::win32::FindClose(find_struct);
	}
}
...
inline win9x_dir_handle basic_win9x_create_dir_file_impl(char const *filename_c_str, ::std::size_t filename_c_str_len)
{
	...
	::ufio::u8string path{::ufio::u8concat_ufio(::ufio::mnp::os_c_str_with_known_size(
																	  ...
																	  ::std::size_t filename_c_str_len)
{
	...
	win9x_dir_handle ret{::ufio::u8concat_ufio(::ufio::mnp::code_cvt(directory_handle->path), u8"\\", ::ufio::mnp::os_c_str_with_known_size(beg, filename_c_str_len))};
													   ...
													   ::std::size_t filename_c_str_len, open_mode_perms ompm)
{
	...
	::ufio::u8string str{::ufio::u8concat_ufio(::ufio::mnp::code_cvt(directory_handle->path), u8"\\", ::ufio::mnp::os_c_str_with_known_size(beg, filename_c_str_len))};
	auto handle{::ufio::details::win32_create_file_impl<win32_family::ansi_9x>(str, ompm)};
	return handle;
}
...
inline win9x_dir_handle win9x_create_dir_file_at_fs_dirent_impl(win9x_dir_handle const &directory_handle, char_type const *filename_c_str,
																::std::size_t filename_c_str_len)
{
	return win32_api_common_9xa(::ufio::mnp::os_c_str_with_known_size(filename_c_str, filename_c_str_len),
...
struct win9x_fs_dirent
{
	...
	::ufio::manipulators::basic_os_c_str_with_known_size<char8_t> filename{}; // file
};
...
{
	return win9x_at_entry{{::ufio::u8concat_ufio(u8".")}};
}
	...
	win9x_dir_file_factory
{
	...
	~win9x_dir_file_factory()
	{
		...
		{
			::ufio::win32::details::close_win9x_dir_handle(handle);
		}
	}
};
...
public:
	...
	void reset(native_handle_type newhandle = {}) noexcept
	{
		if (*this) [[likely]]
		{
			::ufio::win32::details::close_win9x_dir_handle(this->handle);
		}
	...
	win9x_dir(io_dup_t, win9x_dir_io_observer wiob)
		: win9x_dir_io_observer{::ufio::win32::details::win9x_dir_dup_impl(wiob.handle)}
	{
	}
	...
	explicit win9x_dir(win9x_at_entry nate, T const &filename, [[maybe_unused]] open_mode om, [[maybe_unused]] perms pm = static_cast<perms>(436))
		: win9x_dir_io_observer{
			  ::ufio::win32::details::win9x_create_dir_file_at_impl(nate.handle, filename)}
	{
	}
...
public:
	...
	basic_win32_family_file(basic_win32_family_file const &other)
		: basic_win32_family_io_observer<family, ch_type>{::ufio::win32::details::win32_dup_impl(other.handle)}
	{
	}
	basic_win32_family_file &operator=(basic_win32_family_file const &other)
	{
		this->handle = ::ufio::win32::details::win32_dup2_impl(other.handle, this->handle);
		return *this;
	}
	...
	basic_win32_family_file &operator=(basic_win32_family_file &&__restrict b) noexcept
	{
		if (*this) [[likely]]
		{
			::ufio::win32::CloseHandle(this->handle);
		}
	...
	void close()
	{
		if (*this) [[likely]]
		{
			auto error{::ufio::win32::CloseHandle(this->handle)};
	...
	basic_win32_family_file(io_dup_t, basic_win32_family_io_observer<family, ch_type> wiob)
		: basic_win32_family_io_observer<family, ch_type>{::ufio::win32::details::win32_dup_impl(wiob.handle)}
	{
	}
	...
	explicit basic_win32_family_file(io_temp_t)
		: basic_win32_family_io_observer<family, char_type>{::ufio::details::create_win32_temp_file_impl<family>()}
	{
	}
	...
	explicit basic_win32_family_file(nt_fs_dirent fsdirent, open_mode om, perms pm = static_cast<perms>(436))
		: basic_win32_family_io_observer<family, char_type>{
			  ::ufio::details::win32_create_file_at_fs_dirent_impl<family>(
	...
	explicit basic_win32_family_file(win9x_fs_dirent fsdirent, open_mode om, perms pm = static_cast<perms>(436))
		: basic_win32_family_io_observer<family, char_type>{
			  ::ufio::win32::details::win9x_create_file_at_fs_dirent_impl(
				  fsdirent.handle, fsdirent.filename.c_str(), fsdirent.filename.size(), {om, pm})}
	{
	}
	...
	explicit basic_win32_family_file(T const &filename, open_mode om, perms pm = static_cast<perms>(436))
		: basic_win32_family_io_observer<family, char_type>{
			  ::ufio::details::win32_create_file_impl<family>(filename, {om, pm})}
	{
	}
	...
	explicit basic_win32_family_file(nt_at_entry nate, T const &filename, open_mode om,
		...
		: basic_win32_family_io_observer<family, char_type>{
			  ::ufio::details::win32_create_file_at_impl<family>(nate.handle, filename, {om, pm})}
	{
	}
	...
	explicit basic_win32_family_file(win9x_at_entry nate, T const &filename, open_mode om,
									 perms pm = static_cast<perms>(436))
		: basic_win32_family_io_observer<family, char_type>{
			  ::ufio::win32::details::win9x_create_file_at_impl(nate.handle, filename, {om, pm})}
	{
	}
...
template <win32_family family, ::std::integral ch_type>
inline void truncate(basic_win32_family_io_observer<family, ch_type> handle, ::ufio::uintfpos_t size)
{
	win32::details::seek_impl(handle, size, seekdir::beg);
	if (!::ufio::win32::SetEndOfFile(handle.handle))
	{
		throw_win32_error();
	}
}
...
struct map_guard
{
	...
	constexpr ~map_guard()
	{
		if (map) [[likely]]
		{
			::ufio::win32::UnmapViewOfFile(map);
			map = nullptr;
		}
	};
	constexpr void clear() noexcept
...
inline file_type file_type_impl(void *handle)
{
	...
	*/
	::std::uint_least32_t ftvalue{::ufio::win32::GetFileType(handle)};
	switch (ftvalue)
	{
	case 0x0002:
	...
	case 0x0000:
	{
		auto errcd = ::ufio::win32::GetLastError();
		if (errcd == 0)
		{
...
inline posix_file_status win32_status_impl(void *__restrict handle)
{
	...
	if (!::ufio::win32::GetFileInformationByHandle(handle, __builtin_addressof(bhdi)))
	{
		throw_win32_error();
	}
...
{
	return (::ufio::win32::GetFileType(handle) & 0xFFFF7FFF) == 2;
}
...
struct win32_console_mode_guard
{
	...
	win32_console_mode_guard(void *hd)
		: out_hdl{hd}
	{
		if (!::ufio::win32::GetConsoleMode(out_hdl, __builtin_addressof(mode)))
		{
			throw_win32_error();
		}
		if (!::ufio::win32::SetConsoleMode(out_hdl, mode | 0x0004))
		{
			throw_win32_error();
		}
	}
	...
	{
		::ufio::win32::SetConsoleMode(out_hdl, mode);
	}
};
...
inline void win32_clear_screen_main(void *out_hdl)
{
	...
	*/
	...
	constexpr ::std::uint_least32_t written_chars{
		static_cast<::std::uint_least32_t>(::ufio::details::string_literal_size(str))};
	// not bytes, but chars
	win32_console_mode_guard guard{out_hdl};
	if (!::ufio::win32::WriteFile(out_hdl, str, written_chars, nullptr, nullptr))
	{
		throw_win32_error();
	}
}
...
public:
	...
	basic_win32_family_pipe()
	{
		...
		if (!::ufio::win32::CreatePipe(__builtin_addressof(pipes[0].handle),
...
{
	return {::ufio::win32::GetStdHandle(win32_stdin_number)};
}
template <::std::integral char_type = char>
inline basic_win32_io_observer_9xa<char_type> win32_stdout_9xa() noexcept
{
	return {::ufio::win32::GetStdHandle(win32_stdout_number)};
}
template <::std::integral char_type = char>
inline basic_win32_io_observer_9xa<char_type> win32_stderr_9xa() noexcept
{
	return {::ufio::win32::GetStdHandle(win32_stderr_number)};
}
