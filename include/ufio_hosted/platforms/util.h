...
inline ::std::int_least64_t nt_fpos_offset_addition(::std::uint_least64_t ucurrent, ::ufio::intfpos_t off) noexcept
{
	if constexpr (sizeof(::std::int_least64_t) < sizeof(::ufio::intfpos_t))
	{
