...
template <bool zw>
inline void *nt_create_file_common(void *directory, ::ufio::win32::nt::unicode_string *relative_path, nt_open_mode const &mode)
{
...
struct nt_create_callback
{
	...
	[[msvc::forceinline]]
#endif
	void *operator()(void *directory_handle, ::ufio::win32::nt::unicode_string *relative_path) const
	{
...
{
	return ::ufio::win32::nt::details::nt_call_invoke_without_directory_handle_impl(
		filename_cstr, static_cast<bool>(ompm.om & ::ufio::open_mode::nt_path),
		nt_create_callback<zw>{::ufio::win32::nt::details::calculate_nt_open_mode(ompm)});
}
										   ...
										   ::std::size_t filename_c_str_len, open_mode_perms md)
{
	if constexpr (kernel)
	{
		return ::ufio::win32::nt::details::nt_call_kernel_callback(
			directory_handle, filename_c_str, filename_c_str_len,
			nt_create_callback<zw>{::ufio::win32::nt::details::calculate_nt_open_mode(md)});
	}
	else
	{
		return ::ufio::win32::nt::details::nt_call_callback(
			directory_handle, filename_c_str, filename_c_str_len, static_cast<bool>(md.om & ::ufio::open_mode::nt_path),
			nt_create_callback<zw>{::ufio::win32::nt::details::calculate_nt_open_mode(md)});
	}
}
...
#endif
		= char16_t const *;
	return ::ufio::win32::nt::details::nt_call_kernel_fs_dirent_callback(
...
inline void *nt_family_create_file_kernel_impl(char16_t const *filename_cstr, ::std::size_t filename_c_str_len,
											   open_mode_perms ompm)
{
	return ::ufio::win32::nt::details::nt_call_kernel_nodir_callback(
...
template <::ufio::nt_family family>
inline ::std::uint_least64_t nt_calculate_current_file_offset(void *__restrict handle)
{
	::ufio::win32::nt::io_status_block block;
	::std::uint_least64_t fps{};
	auto status{::ufio::win32::nt::nt_query_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(block), __builtin_addressof(fps),
																									static_cast<::std::uint_least32_t>(sizeof(::std::uint_least64_t)),
																									::ufio::win32::nt::file_information_class::FilePositionInformation)};
	if (status)
	{
		throw_nt_error(status);
	}
...
inline ::std::int_least64_t nt_calculate_offset_impl(::ufio::intfpos_t off)
{
														 ...
														 ::std::int_least64_t *pbyteoffset)
{
	...
	::ufio::win32::nt::io_status_block block;
	auto const status{::ufio::win32::nt::nt_read_file<family == ::ufio::nt_family::zw>(handle, nullptr, nullptr, nullptr, __builtin_addressof(block), first,
																							 ::ufio::details::read_write_bytes_compute<::std::uint_least32_t>(first, last), pbyteoffset, nullptr)};
	if (status) [[unlikely]]
	{
...
{
	return ::ufio::win32::nt::details::nt_read_pread_some_bytes_common_impl<family>(handle, first, last, nullptr);
}
											 ...
											 ::ufio::intfpos_t off)
{
	...
	return ::ufio::win32::nt::details::nt_read_pread_some_bytes_common_impl<family>(handle, first, last,
...
{
	::ufio::win32::nt::io_status_block block;
	auto const status{::ufio::win32::nt::nt_write_file<family == ::ufio::nt_family::zw>(handle, nullptr, nullptr, nullptr, __builtin_addressof(block), first,
																							  ::ufio::details::read_write_bytes_compute<::std::uint_least32_t>(first, last), pbyteoffset, nullptr)};
	if (status)
	{
		throw_nt_error(status);
...
inline ::std::byte const *nt_write_some_bytes_impl(void *__restrict handle, ::std::byte const *first,
												   ::std::byte const *last)
{
	return ::ufio::win32::nt::details::nt_write_pwrite_some_bytes_common_impl<family>(handle, first, last, nullptr);
}
...
{
	::std::int_least64_t offs{nt_calculate_offset_impl(off)};
	return ::ufio::win32::nt::details::nt_write_pwrite_some_bytes_common_impl<family>(handle, first, last,
																						 __builtin_addressof(offs));
}
...
{
	void *handle{};
	::ufio::manipulators::basic_os_c_str_with_known_size<char16_t> filename{};
};
...
{
	return ::ufio::win32::nt::details::nt_read_some_bytes_impl<family>(niob.handle, first, last);
}
...
{
	return ::ufio::win32::nt::details::nt_write_some_bytes_impl<family>(niob.handle, first, last);
}
...
{
	return ::ufio::win32::nt::details::nt_pread_some_bytes_impl<family>(niob.handle, first, last, off);
}
...
inline ::std::byte const *pwrite_some_bytes_overflow_define(basic_nt_family_io_observer<family, ch_type> niob,
															...
															::ufio::intfpos_t off)
{
	return ::ufio::win32::nt::details::nt_pwrite_some_bytes_impl<family>(niob.handle, first, last, off);
}
...
{
	::ufio::win32::nt::io_status_block block;
	::std::uint_least32_t status{::ufio::win32::nt::nt_flush_buffers_file<zw>(handle, __builtin_addressof(block))};
	if (status)
	{
		throw_nt_error(status);
	}
...
inline void nt_data_sync_impl(void *handle, data_sync_flags flags [[maybe_unused]])
{
	...
	*/
	::ufio::win32::nt::io_status_block block;
	::std::uint_least32_t status{::ufio::win32::nt::nt_flush_buffers_file_ex<zw>(
...
{
	::ufio::win32::nt::details::nt_flush_impl<family == nt_family::zw>(ntiob.handle);
}

template <nt_family family, ::std::integral ch_type>
inline void data_sync(basic_nt_family_io_observer<family, ch_type> ntiob, data_sync_flags flags)
{
	::ufio::win32::nt::details::nt_data_sync_impl<family == nt_family::zw>(ntiob.handle, flags);
}
														 ...
														 seekdir s)
{
	...
	case seekdir::end:
	{
		::ufio::win32::nt::file_standard_information fsi;
		auto status{::ufio::win32::nt::nt_query_information_file<zw>(
			handle, __builtin_addressof(block), __builtin_addressof(fsi),
			static_cast<::std::uint_least32_t>(sizeof(::ufio::win32::nt::file_standard_information)),
			::ufio::win32::nt::file_information_class::FileStandardInformation)};
		if (status)
		{
			return {status};
		}
...
inline ::std::int_least64_t nt_seek64_impl(void *__restrict handle, ::std::int_least64_t offset, seekdir s)
{
	...
	::ufio::win32::nt::io_status_block block;
	status = ::ufio::win32::nt::nt_set_information_file<zw>(handle, __builtin_addressof(block),
...
template <bool zw>
inline ::ufio::intfpos_t nt_seek_impl(void *__restrict handle, ::ufio::intfpos_t offset, seekdir s)
{
	return static_cast<::ufio::intfpos_t>(nt_seek64_impl<zw>(handle, static_cast<::std::int_least64_t>(offset), s));
}
...
inline void *nt_dup_impl(void *handle)
{
	...
	void *new_handle{};
	auto status{::ufio::win32::nt::nt_duplicate_object<zw>(current_process, handle, current_process,
...
inline void *nt_dup2_impl(void *handle, void *newhandle)
{
	...
	if (newhandle) [[likely]]
	{
		::ufio::win32::nt::nt_close<zw>(newhandle);
	}
	return temp;
}
...
inline void nt_truncate_impl(void *handle, ::std::uintmax_t newfilesizem)
{
	...
	::ufio::win32::nt::io_status_block block;
	auto status{::ufio::win32::nt::nt_set_information_file<zw>(handle, __builtin_addressof(block),
																  __builtin_addressof(newfilesize), sizeof(::std::uint_least64_t),
																  ::ufio::win32::nt::file_information_class::FileEndOfFileInformation)};
	if (status)
	{
		throw_nt_error(status);
	}
															 ...
															 bool failedimmediately)
{
	...
	{
		status = ::ufio::win32::nt::nt_unlock_file<zw>(handle, __builtin_addressof(block), __builtin_addressof(file_position),
														  __builtin_addressof(len), 0u);
	}
	else
	{
		status = ::ufio::win32::nt::nt_lock_file<zw>(handle, nullptr, nullptr, nullptr, __builtin_addressof(block),
...
inline void nt_family_file_unlock_common_impl(void *__restrict handle, flock_request_l64 &req) noexcept
{
	...
	req.len = len;
	::ufio::win32::nt::io_status_block block;
	::ufio::win32::nt::nt_unlock_file<zw>(handle, __builtin_addressof(block), __builtin_addressof(file_position),
											 __builtin_addressof(len), 0u);
}
...
template <nt_family family, ::std::integral ch_type>
inline ::ufio::intfpos_t io_stream_seek_bytes_define(basic_nt_family_io_observer<family, ch_type> handle,
														::ufio::intfpos_t offset, seekdir s)
{
	return ::ufio::win32::nt::details::nt_seek_impl<family == nt_family::zw>(handle.handle, offset, s);
}

template <nt_family family, ::std::integral ch_type>
inline void truncate(basic_nt_family_io_observer<family, ch_type> handle, ::std::uintmax_t newfilesize)
{
	::ufio::win32::nt::details::nt_truncate_impl<family == nt_family::zw>(handle.handle, newfilesize);
}
...
inline posix_file_status nt_status_impl(void *__restrict handle)
{
	...
	::ufio::win32::nt::file_fs_device_type ffdt;
	auto status{::ufio::win32::nt::nt_query_volume_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(isb), __builtin_addressof(ffdt),
																										   static_cast<::std::uint_least32_t>(sizeof(ffdt)),
																										   ::ufio::win32::nt::fs_information_class::FileFsDeviceInformation)};
	if (status) [[unlikely]]
	{
		throw_nt_error(status);
	}
	...
	status = ::ufio::win32::nt::nt_query_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(isb), __builtin_addressof(fbi),
	...
	::ufio::win32::nt::file_internal_information fii;
	status = ::ufio::win32::nt::nt_query_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(isb), __builtin_addressof(fii),
																								 static_cast<::std::uint_least32_t>(sizeof(fii)),
																								 ::ufio::win32::nt::file_information_class::FileInternalInformation);
	...
	struct
	{
		::ufio::win32::nt::file_fs_volume_information FileFsVolume;
		char16_t Name[255];
	} ffvi;

	status = ::ufio::win32::nt::nt_query_volume_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(isb),
																										__builtin_addressof(ffvi), static_cast<::std::uint_least32_t>(sizeof(ffvi)),
																										::ufio::win32::nt::fs_information_class::FileFsVolumeInformation);
	if (status) [[unlikely]]
	{
		throw_nt_error(status);
	}
	...
	::ufio::win32::nt::file_standard_information fsi;
	status = ::ufio::win32::nt::nt_query_information_file<family == ::ufio::nt_family::zw>(handle, __builtin_addressof(isb), __builtin_addressof(fsi),
...
struct nt_family_file_lock
{
	...
	{
		::ufio::win32::nt::details::nt_family_file_lock_impl<family == nt_family::zw>(this->handle, t);
	}
	template <::std::signed_integral int_type>
		requires(sizeof(int_type) >= sizeof(::std::int_least64_t))
	inline void unlock(basic_flock_request<int_type> &__restrict t) noexcept
	{
		::ufio::win32::nt::details::nt_family_file_unlock_impl<family == nt_family::zw>(this->handle, t);
	}
	template <::std::signed_integral int_type>
		requires(sizeof(int_type) >= sizeof(::std::int_least64_t))
	inline bool try_lock(basic_flock_request<int_type> &__restrict t) noexcept
	{
		return ::ufio::win32::nt::details::nt_family_file_try_lock_impl<family == nt_family::zw>(this->handle, t);
	}
};
	...
	nt_family_file_factory
{
	...
	~nt_family_file_factory()
	{
		if (handle) [[likely]]
		{
			::ufio::win32::nt::nt_close<family == nt_family::zw>(this->handle);
		}
	}
};
...
public:
	...
	explicit basic_nt_family_file(io_dup_t, basic_nt_family_io_observer<family, ch_type> wiob)
		: basic_nt_family_io_observer<family, ch_type>{
			  ::ufio::win32::nt::details::nt_dup_impl<family == nt_family::zw>(wiob.handle)}
	{
	}
	explicit basic_nt_family_file(nt_fs_dirent fsdirent, open_mode om, perms pm = static_cast<perms>(436))
		: basic_nt_family_io_observer<family, char_type>{
			  ::ufio::win32::nt::details::nt_family_create_file_fs_dirent_impl<family == nt_family::zw>(fsdirent.handle, fsdirent.filename.c_str(), fsdirent.filename.size(), {om, pm})}
	{
	}
	...
	explicit basic_nt_family_file(T const &t, open_mode om, perms pm = static_cast<perms>(436))
		: basic_nt_family_io_observer<family, ch_type>{
			  ::ufio::win32::nt::details::nt_create_file_impl<family == nt_family::zw>(t, {om, pm})}
	{
	}
	template <::ufio::constructible_to_os_c_str T>
	explicit basic_nt_family_file(nt_at_entry ent, T const &t, open_mode om, perms pm = static_cast<perms>(436))
		: basic_nt_family_io_observer<family, ch_type>{
			  ::ufio::win32::nt::details::nt_create_file_at_impl<family == nt_family::zw>(ent.handle, t, {om, pm})}
	{
	}
	...
	explicit basic_nt_family_file(io_kernel_t, T const &t, open_mode om, perms pm = static_cast<perms>(436))
		: basic_nt_family_io_observer<family, ch_type>{
			  ::ufio::win32::nt::details::nt_create_file_kernel_impl<family == nt_family::zw>(t, {om, pm})}
	{
	}
	template <::ufio::constructible_to_os_c_str T>
	explicit basic_nt_family_file(io_kernel_t, nt_at_entry ent, T const &t, open_mode om,
		...
		: basic_nt_family_io_observer<family, ch_type>{
			  ::ufio::win32::nt::details::nt_create_file_at_impl<family == nt_family::zw, true>(ent.handle, t,
																								   {om, pm})}
	{
	}
	...
	void close()
	{
		...
		{
			auto status{::ufio::win32::nt::nt_close<family == nt_family::zw>(this->handle)};
	...
	basic_nt_family_file(basic_nt_family_file const &other)
		: basic_nt_family_io_observer<family, ch_type>(
			  ::ufio::win32::nt::details::nt_dup_impl<family == nt_family::zw>(other.handle))
	{
	}
	basic_nt_family_file &operator=(basic_nt_family_file const &other)
	{
		this->handle = ::ufio::win32::nt::details::nt_dup2_impl<family == nt_family::zw>(other.handle, this->handle);
		return *this;
	}
...
inline void nt_create_pipe(void **hReadPipe, void **hWritePipe)
{
	...
	void *namedpipedir;
	auto status = ::ufio::win32::nt::nt_create_file<zw>(
	...
	::ufio::basic_nt_family_file<zw ? nt_family::zw : nt_family::nt, char> file{namedpipedir};

	::std::int_least64_t DefaultTimeout{-1200000000};

	void *ReadPipeHandle;
	::ufio::win32::nt::unicode_string us2{};
	::ufio::win32::nt::object_attributes obj2{.Length = sizeof(::ufio::win32::nt::object_attributes),
	...
	status = ::ufio::win32::nt::nt_create_named_pipe_file<zw>(__builtin_addressof(ReadPipeHandle),
	...
	if (status)
	{
		::ufio::throw_nt_error(status);
	}

	obj2.RootDirectory = ReadPipeHandle;

	void *WritePipeHandle;
	status = ::ufio::win32::nt::nt_create_file<zw>(
...
inline void *nt_get_stdhandle() noexcept
{
	using prtl_user_process_parameters
		...
		[[__gnu__::__may_alias__]]
#endif
		= ::ufio::win32::nt::rtl_user_process_parameters *;
	auto pparam{
		reinterpret_cast<prtl_user_process_parameters>(::ufio::win32::nt::nt_get_current_peb()->ProcessParameters)};
	if constexpr (fd == 0)
	{
...
{
	return {::ufio::details::nt_get_stdhandle<0>()};
}

template <::std::integral char_type = char>
inline basic_nt_io_observer<char_type> nt_stdout() noexcept
{
	return {::ufio::details::nt_get_stdhandle<1>()};
}

template <::std::integral char_type = char>
inline basic_nt_io_observer<char_type> nt_stderr() noexcept
{
	return {::ufio::details::nt_get_stdhandle<2>()};
}
