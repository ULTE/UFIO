...
register ::ufio::win32::nt::teb *ufio_nt_current_teb __asm__("x18");
#endif
...
inline peb *nt_get_current_peb() noexcept
{
	...
	return ::ufio::win32::nt::ufio_nt_current_teb->ProcessEnvironmentBlock;
	...
	{
		return ::ufio::win32::nt::RtlGetCurrentPeb();
	}
#else
	...
	return reinterpret_cast<::ufio::win32::nt::peb *>(::ufio::intrinsics::msvc::arm::__getReg(18))->ProcessEnvironmentBlock;
#elif defined(_M_AMD64)
	return reinterpret_cast<::ufio::win32::nt::peb *>(::ufio::intrinsics::msvc::x86::__readgsqword(0x60));
#elif defined(_M_IX86)
	return reinterpret_cast<::ufio::win32::nt::peb *>(::ufio::intrinsics::msvc::x86::__readfsdword(0x30));
#else
	return reinterpret_cast<::ufio::win32::nt::teb *>(::ufio::intrinsics::msvc::arm::_MoveFromCoprocessor(15, 0, 13, 0, 2))->ProcessEnvironmentBlock;
#endif
#else
	return ::ufio::win32::nt::RtlGetCurrentPeb();
#endif
...
inline teb *nt_current_teb() noexcept
{
#if (defined(__GNUC__) || defined(__clang__))
#if defined(__aarch64__) || defined(__arm64ec__)
	return ::ufio::win32::nt::ufio_nt_current_teb;
#elif defined(__i386__) || defined(__x86_64__)
	if constexpr (sizeof(::std::size_t) == sizeof(::std::uint_least64_t))
	{
		teb *pteb;
	...
	{
		::ufio::fast_terminate(); // Unsupported architecture
	}
#else
	if constexpr (sizeof(::std::size_t) == sizeof(::std::uint_least32_t))
	{
...
#elif defined(_MSC_VER)
#if defined(_M_ARM64) || defined(_M_ARM64EC)
	return reinterpret_cast<::ufio::win32::nt::teb *>(::ufio::intrinsics::msvc::arm::__getReg(18));
#elif defined(_M_AMD64)
	return reinterpret_cast<::ufio::win32::nt::teb *>(::ufio::intrinsics::msvc::x86::__readgsqword(0x30));
#elif defined(_M_IX86)
	return reinterpret_cast<::ufio::win32::nt::teb *>(::ufio::intrinsics::msvc::x86::__readfsdword(0x18));
#else
	return reinterpret_cast<::ufio::win32::nt::teb *>(::ufio::intrinsics::msvc::arm::_MoveFromCoprocessor(15, 0, 13, 0, 2));
#endif
#else
	::ufio::fast_terminate(); // Unsupported compiler
#endif
}
...
{
	return ::ufio::win32::nt::nt_get_current_peb()->ProcessHeap;
}
