...
inline ::std::size_t print_reserve_define_win32_error_9xa_impl(char *ptr, ::std::uint_least32_t ec) noexcept
{
	...
	return ::ufio::win32::FormatMessageA(0x00000200 | 0x00001000, nullptr, ec, (1 << 10), ptr, char8_buffer_size,
											nullptr);
}
...
inline ::std::size_t print_reserve_define_win32_error_ntw_impl(char16_t *ptr, ::std::uint_least32_t ec) noexcept
{
	...
	return ::ufio::win32::FormatMessageW(0x00000200 | 0x00001000, nullptr, ec, (1 << 10), ptr, char16_buffer_size,
											nullptr);
}
...
inline constexpr char_type *print_reserve_define_win32_error_ptr_impl(char_type *ptr, ::std::uint_least32_t ec) noexcept
{
	if constexpr (family == win32_family::wide_nt)
	{
		...
		{
			::ufio::freestanding::array<char16_t, 32768> buffer;
			using char_type_may_alias_ptr
#if __has_cpp_attribute(__gnu__::__may_alias__)
				[[__gnu__::__may_alias__]]
#endif
			...
			return ::ufio::details::codecvt::general_code_cvt_full(buffer.data(), buffer.data() + sz, ptr);
		}
	}
	else
	{
		...
		{
			::ufio::freestanding::array<char8_t, 65535> buffer;
...
inline constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, win32_code>) noexcept
{
	if constexpr (win32_family::native == win32_family::wide_nt)
	{
		...
		{
			constexpr ::std::size_t sz{::ufio::details::cal_decorated_reserve_size<2, sizeof(char_type)>(32768)};
			return sz;
		}
	}
	else
	{
		...
		{
			constexpr ::std::size_t sz{::ufio::details::cal_decorated_reserve_size<1, sizeof(char_type)>(65535)};
			return sz;
		}
	}
}
...
[[noreturn]] inline void throw_win32_error()
{
	...
	fast_terminate();
#else
	throw ::ufio::error{win32_domain_value, static_cast<::std::size_t>(win32::GetLastError())};
#endif
#else
	fast_terminate();
#endif
...
[[noreturn]] inline void throw_win32_error([[maybe_unused]] ::std::uint_least32_t err)
{
	...
	fast_terminate();
#else
	throw ::ufio::error{win32_domain_value, static_cast<::std::size_t>(err)};
#endif
#else
	fast_terminate();
#endif
