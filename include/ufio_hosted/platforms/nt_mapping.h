...
inline void *create_file_mapping_impl(void *handle, file_map_attribute attr)
{
	...
	void *h_section{};
	auto status{::ufio::win32::nt::nt_create_section < family == ::ufio::nt_family::zw > (__builtin_addressof(h_section), static_cast<::std::uint_least32_t>(to_nt_file_map_attribute(attr)),
...
public:
							  ...
							  ::std::uintmax_t start_address = 0)
	{
		...
		auto status{::ufio::win32::nt::nt_map_view_of_section < family == ::ufio::nt_family::zw > (mapping_file.handle, current_process_handle, __builtin_addressof(base_ptr), 0, 0,
																										 reinterpret_cast<::ufio::win32::nt::large_integer const *>(__builtin_addressof(start_address)),
																										 __builtin_addressof(bytes), ::ufio::win32::nt::section_inherit::ViewShare, 0,
	...
	void close()
	{
		...
		{
			void *current_process_handle{reinterpret_cast<void *>(static_cast<::std::ptrdiff_t>(-1))};
			auto ret{::ufio::win32::nt::nt_unmap_view_of_section < family == ::ufio::nt_family::zw > (current_process_handle, this->address_begin)};
