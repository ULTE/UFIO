...
inline ::std::int_least64_t win32_query_performance_frequency()
{
	...
	if (!::ufio::win32::QueryPerformanceFrequency(__builtin_addressof(val)))
	{
		throw_win32_error();
	}
	if (val <= 0)
	...
	posix_clock_getres([[maybe_unused]] posix_clock_id pclk_id)
{
	...
	case posix_clock_id::monotonic_raw:
	case posix_clock_id::boottime:
		return ::ufio::details::win32_query_performance_frequency_to_unix_timestamp();
		break;
	default:
		throw_win32_error(0x00000057);
	}
	...
	case posix_clock_id::thread_cputime_id:
	{
		constexpr ::std::uint_least64_t mul_factor{uint_least64_subseconds_per_second / ::ufio::posix::libc_uclocks_per_sec};
		return {0, mul_factor};
	}
	default:
		throw_posix_error(EINVAL);
	...
	struct timespec res;
	// vdso
	if (::ufio::posix::libc_clock_getres(clk, __builtin_addressof(res)) < 0)
	{
		throw_posix_error();
	}
...
inline unix_timestamp win32_posix_clock_gettime_tai_impl() noexcept
{
	...
	::ufio::win32::GetSystemTimePreciseAsFileTime(__builtin_addressof(ftm));
#else
...
inline unix_timestamp win32_posix_clock_gettime_uptime_impl()
{
	...
	if (!::ufio::win32::QueryUnbiasedInterruptTime(__builtin_addressof(ftm)))
	{
		throw_win32_error();
	}
	constexpr ::std::uint_least64_t mul_factor{uint_least64_subseconds_per_second / 10000000u};
...
{
	::ufio::win32::filetime creation_time, exit_time, kernel_time, user_time;
	if constexpr (is_thread)
	{
		auto hthread{reinterpret_cast<void *>(static_cast<::std::ptrdiff_t>(-2))};
		if (!::ufio::win32::GetThreadTimes(hthread, __builtin_addressof(creation_time),
	...
	else
	{
		...
		if (!::ufio::win32::GetProcessTimes(hprocess, __builtin_addressof(creation_time),
											   __builtin_addressof(exit_time), __builtin_addressof(kernel_time),
											   __builtin_addressof(user_time)))
		{
			throw_win32_error();
	...
	::std::uint_least64_t ftm{::ufio::win32::filetime_to_uint_least64_t(kernel_time) +
							  ::ufio::win32::filetime_to_uint_least64_t(user_time)};
	::std::uint_least64_t seconds{ftm / 10000000ULL};
	::std::uint_least64_t subseconds{ftm % 10000000ULL};
	constexpr ::std::uint_least64_t mul_factor{uint_least64_subseconds_per_second / 10000000u};
	return {static_cast<::std::int_least64_t>(seconds), static_cast<::std::uint_least64_t>(subseconds * mul_factor)};
...
inline unix_timestamp win32_posix_clock_gettime_boottime_impl()
{
	::std::uint_least64_t freq{
		static_cast<::std::uint_least64_t>(::ufio::details::win32_query_performance_frequency())};
	::std::int_least64_t counter;
	if (!::ufio::win32::QueryPerformanceCounter(__builtin_addressof(counter)))
	{
		throw_win32_error();
	}
	if (counter < 0)
...
{
	return static_cast<unix_timestamp>(::ufio::win32::to_win32_timestamp_ftu64(
		static_cast<::std::uint_least64_t>(::ufio::win32::nt::RtlGetSystemTimePrecise())));
}
...
inline unix_timestamp nt_posix_clock_gettime_boottime_impl() noexcept
{
	...
	auto status{::ufio::win32::nt::nt_query_performance_counter<zw>(__builtin_addressof(counter), __builtin_addressof(freq))};
	...
	::std::uint_least64_t ucounter{static_cast<::std::uint_least64_t>(counter)};
	::std::uint_least64_t val{::ufio::uint_least64_subseconds_per_second / freq};
	::std::uint_least64_t dv{ucounter / freq};
	::std::uint_least64_t md{ucounter % freq};
	return unix_timestamp{static_cast<::std::int_least64_t>(dv),
						  static_cast<::std::uint_least64_t>(md * static_cast<::std::uint_least64_t>(val))};
...
inline unix_timestamp nt_posix_clock_gettime_process_or_thread_time_impl()
{
	...
	{
		auto hthread{reinterpret_cast<void *>(static_cast<::std::ptrdiff_t>(-2))};
		::ufio::win32::nt::kernel_user_times kut;

		auto status{
			::ufio::win32::nt::nt_query_information_thread<zw>(
				hthread,
				::ufio::win32::nt::thread_information_class::ThreadTimes,
	...
	else
	{
		...
		auto status{
			::ufio::win32::nt::nt_query_information_process<zw>(
				hprocess,
				::ufio::win32::nt::process_information_class::ProcessTimes,
				__builtin_addressof(kut),
				static_cast<::std::uint_least32_t>(sizeof(kut)),
				nullptr)};
...
inline ::std::uint_least64_t nt10x_get_auxiliary_counter_frequency()
{
	...
	auto status{::ufio::win32::nt::nt_query_auxiliary_counter_frequency<zw>(__builtin_addressof(feq))};
	if (status) [[unlikely]]
	{
		throw_nt_error(status);
	}
...
inline unix_timestamp posix_clock_gettime([[maybe_unused]] posix_clock_id pclk_id)
{
	...
	case posix_clock_id::thread_cputime_id:
	{
		::std::uint_least64_t u{static_cast<::std::uint_least64_t>(::ufio::posix::libc_dos_uclock())};
		::std::uint_least64_t seconds{u / ::ufio::posix::libc_uclocks_per_sec};
		::std::uint_least64_t subseconds{u % ::ufio::posix::libc_uclocks_per_sec};
		constexpr ::std::uint_least64_t mul_factor{uint_least64_subseconds_per_second / ::ufio::posix::libc_uclocks_per_sec};
	...
	auto clk{details::posix_clock_id_to_native_value(pclk_id)};
	// vdso
	if (::ufio::posix::libc_clock_gettime(clk, __builtin_addressof(res)) < 0)
	{
		throw_posix_error();
	}
	constexpr ::std::uint_least64_t mul_factor{uint_least64_subseconds_per_second / 1000000000u};
...
inline struct tm unix_timestamp_to_tm_impl(::std::int_least64_t seconds)
{
	...
	{
		if (::ufio::noexcept_call(localtime64_r, __builtin_addressof(val), __builtin_addressof(t)) == 0)
		{
			throw_posix_error();
		}
	}
	...
	{
		if (::ufio::noexcept_call(gmtime64_r, __builtin_addressof(val), __builtin_addressof(t)) == 0)
		{
			throw_posix_error();
		}
	}
	...
	if constexpr (local_tm)
	{
		if (::ufio::posix::libc_localtime_r(__builtin_addressof(val), __builtin_addressof(t)) == 0)
		{
			throw_posix_error();
		}
	}
	...
	{
		if (::ufio::posix::libc_gmtime_r(__builtin_addressof(val), __builtin_addressof(t)) == 0)
		{
			throw_posix_error();
		}
	}
											   ...
											   [[maybe_unused]] bool dstadj)
{
	...
	{
		auto errn{::ufio::noexcept_call(_get_timezone, __builtin_addressof(tm_gmtoff))};
		if (errn)
		{
			throw_posix_error(static_cast<int>(errn));
		}
	...
	(defined(_M_IX86) || defined(_M_X64) || defined(__i386__) || defined(__x86_64__))
	{
		auto errn{::ufio::noexcept_call(_get_dstbias, __builtin_addressof(seconds))};
		if (errn)
		{
			throw_posix_error(static_cast<int>(errn));
		}
...
{
	int hours;
	if (::ufio::noexcept_call(_get_daylight, __builtin_addressof(hours)))
	{
		return false;
	}
	return hours != 0;
...
inline win32_timezone_t timezone_name(bool is_dst = posix_daylight())
{
	...
	auto errn{::ufio::noexcept_call(_get_tzname, __builtin_addressof(tzt.tz_name_len), nullptr, zero, is_dst)};
	if (errn)
	{
		throw_posix_error(static_cast<int>(errn));
	}
...
{
	auto errn{::ufio::noexcept_call(_get_tzname, __builtin_addressof(tzt.tz_name_len), first, tzt.tz_name_len,
									   tzt.is_dst)};
	if (errn)
	{
		throw_posix_error(static_cast<int>(errn));
...
inline void posix_clock_settime([[maybe_unused]] posix_clock_id pclk_id, [[maybe_unused]] unix_timestamp timestamp)
{
	...
	case posix_clock_id::tai:
	{
		...
		if(::ufio::noexcept_call(::settimeofday,__builtin_addressof(tv), nullptr)<0)
			throw_posix_error();
#else
...
#else
	if (::ufio::posix::libc_clock_settime(clk, __builtin_addressof(res)) < 0)
	{
		throw_posix_error();
	}
#endif
...
inline [[nodiscard]] bool posix_clock_sleep_abstime(posix_clock_id pclk_id,unix_timestamp timestamp)
{
	...
	auto ret{::ufio::noexcept_call(::clock_nanosleep,pclk_id,TIMER_ABSTIME,__builtin_addressof(timestamp_spec),ptr,nullptr)};
	if(ret<0)
	{
		auto ern{errno};
		if(ern!=EINTR)
...
inline void posix_clock_sleep_abstime_complete(posix_clock_id pclk_id,unix_timestamp timestamp)
{
	...
	for(;;)
	{
		auto ret{::ufio::noexcept_call(::clock_nanosleep,pclk_id,TIMER_ABSTIME,__builtin_addressof(timestamp_spec),nullptr)};
		if(ret==0)[[likely]]
			return;
		auto ern{errno};
		if(ern!=EINTR)
