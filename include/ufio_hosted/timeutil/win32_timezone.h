...
{
	::ufio::basic_io_scatter_t<T> scatter{str, len};
	::ufio::basic_io_scatter_t<T> const *first;
	::ufio::basic_io_scatter_t<T> const *last;
	...
	auto it{::ufio::freestanding::lower_bound(
		first, last, scatter, [](::ufio::basic_io_scatter_t<T> const &a, ::ufio::basic_io_scatter_t<T> const &b) { return ::ufio::freestanding::lexicographical_compare(a.base, a.base + a.len, b.base, b.base + b.len); })};
	if (it == last) [[unlikely]]
	{
		return {};
	}
	if (!::ufio::freestanding::equal(it->base, it->base + it->len, str, str + len)) [[unlikely]]
	{
		return {};
	}
...
inline win32_timezone_name win32_localtimezone_impl() noexcept
{
	...
	if constexpr (tzfamily == win32_timezone_family::gettimezoneinformation)
	{
		...
		::ufio::win32::time_zone_information tzi{};
		::std::uint_least32_t retval{::ufio::win32::GetTimeZoneInformation(__builtin_addressof(tzi))};
		if (retval == UINT_LEAST32_MAX) [[unlikely]]
		{
			throw_win32_error();
		}
		::std::size_t const standardnamesize{::ufio::cstr_nlen(tzi.StandardName, sizeof(tzi.StandardName))};
		return ::ufio::win32::details::find_win32_regtz_position_impl(tzi.StandardName, standardnamesize);
	}
	else
	{
		::std::size_t k;
		...
		{
			win32retcode = ::ufio::win32::RegOpenKeyA(0x80000002 /*HKEY_LOCAL_MACHINE*/,
														 u8"SYSTEM\\CurrentControlSet\\Control\\TimeZoneInformation",
														 __builtin_addressof(k));
		}
		else
		{
			win32retcode = ::ufio::win32::RegOpenKeyW(0x80000002 /*HKEY_LOCAL_MACHINE*/,
		...
		{
			::ufio::win32::details::win32_registry_guard guard(k);
			if constexpr (family == win32_family::ansi_9x)
			{
				win32retcode = ::ufio::win32::RegQueryValueExA(k, u8"TimeZoneKeyName", nullptr, nullptr, buffer,
																  __builtin_addressof(cbdata));
			}
			else
			{
				win32retcode = ::ufio::win32::RegQueryValueExW(k, u"TimeZoneKeyName", nullptr, nullptr, buffer,
																  __builtin_addressof(cbdata));
			}
			if (win32retcode)
			{
				...
				if constexpr (family == win32_family::ansi_9x)
				{
					win32retcode = ::ufio::win32::RegQueryValueExA(k, u8"StandardName", nullptr, nullptr, buffer,
																	  __builtin_addressof(cbdata));
				}
				else
				{
					win32retcode = ::ufio::win32::RegQueryValueExW(k, u"StandardName", nullptr, nullptr, buffer,
																	  __builtin_addressof(cbdata));
				}
				if (win32retcode) [[unlikely]]
				{
		...
		return ::ufio::win32::details::find_win32_regtz_position_impl(buffer, stringlen);
	}
}
...
struct basic_win32_family_local_timezone
{
	...
	{
		return ::ufio::win32::details::win32_localtimezone_impl<tzfamily, family>();
	}
};

template <win32_family family>
using basic_win32_local_timezone = basic_win32_family_local_timezone<win32_timezone_family::native, family>;
using win32_local_timezone_9xa = basic_win32_local_timezone<::ufio::win32_family::ansi_9x>;
using win32_local_timezone_ntw = basic_win32_local_timezone<::ufio::win32_family::wide_nt>;
using win32_local_timezone = basic_win32_local_timezone<::ufio::win32_family::native>;
																	   ...
																	   win32_timezone_name tzn) noexcept
{
	...
	{
		return ::ufio::win32::details::iana_db_timezone[tzn.position];
	}
	else if constexpr (::std::same_as<char_type, wchar_t>)
	{
		return ::ufio::win32::details::wiana_db_timezone[tzn.position];
	}
	else if constexpr (::std::same_as<char_type, char16_t>)
	{
		return ::ufio::win32::details::u16iana_db_timezone[tzn.position];
	}
	else if constexpr (::std::same_as<char_type, char32_t>)
	{
		return ::ufio::win32::details::u32iana_db_timezone[tzn.position];
	}
	else
	{
		return ::ufio::win32::details::u8iana_db_timezone[tzn.position];
	}
}
