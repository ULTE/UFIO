...
inline void cstr_concat_writev_impl(io_scatter_t const *first, ::std::size_t n, callback func)
{
	...
	{
		total_len = ::ufio::details::intrinsics::add_or_overflow_die(total_len, i->len);
	}
...
{
	::ufio::details::android_logger_write_impl(b.meta, ::std::to_address(first),
...
{
	::ufio::details::android_logger_writev_impl(b.meta, scatters.base, scatters.len);
}
...
{
	return ::ufio::details::android_dbg_impl<char>(priority, tg, loc);
}
inline constexpr auto wdbg(::std::int_least32_t priority = 4, char const *tg = "",
						   ::std::source_location loc = ::std::source_location::current()) noexcept
{
	return ::ufio::details::android_dbg_impl<wchar_t>(priority, tg, loc);
}
inline constexpr auto u8dbg(::std::int_least32_t priority = 4, char const *tg = "",
							::std::source_location loc = ::std::source_location::current()) noexcept
{
	return ::ufio::details::android_dbg_impl<char8_t>(priority, tg, loc);
}
inline constexpr auto u16dbg(::std::int_least32_t priority = 4, char const *tg = "",
							 ::std::source_location loc = ::std::source_location::current()) noexcept
{
	return ::ufio::details::android_dbg_impl<char16_t>(priority, tg, loc);
}
inline constexpr auto u32dbg(::std::int_least32_t priority = 4, char const *tg = "",
							 ::std::source_location loc = ::std::source_location::current()) noexcept
{
	return ::ufio::details::android_dbg_impl<char32_t>(priority, tg, loc);
}
