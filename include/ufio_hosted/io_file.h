...
{
public:
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_read_some_underflow_def(::ufio::basic_io_scatter_t<inchar_type> const *, ::std::size_t) = 0;
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_pread_some_underflow_def(::ufio::basic_io_scatter_t<inchar_type> const *, ::std::size_t,
									 ::ufio::intfpos_t) = 0;
	virtual constexpr ::ufio::intfpos_t input_stream_seek_def(::ufio::intfpos_t, ::ufio::seekdir) = 0;

	virtual constexpr ::ufio::io_scatter_status_t
	scatter_write_some_overflow_def(::ufio::basic_io_scatter_t<outchar_type> const *, ::std::size_t) = 0;
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_pwrite_some_overflow_def(::ufio::basic_io_scatter_t<outchar_type> const *, ::std::size_t,
									 ::ufio::intfpos_t) = 0;
	virtual constexpr ::ufio::intfpos_t output_stream_seek_def(::ufio::intfpos_t, ::ufio::seekdir) = 0;
...
public:
	...
	constexpr basic_io_io_derived(io_cookie_t, Args &&...args)
		: value(::ufio::freestanding::forward<Args>(args)...)
	{
	}
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_read_some_underflow_def(::ufio::basic_io_scatter_t<inchar_type> const *base, ::std::size_t n) override
	{
		if constexpr (::ufio::operations::defines::has_input_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::input_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::input_char_type, inchar_type> &&
						  ::ufio::operations::decay::defines::readable<decaytype>)
			{
				return ::ufio::operations::decay::scatter_read_some_decay(
					::ufio::operations::input_stream_ref(value), base, n);
			}
			else
			{
	...
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_pread_some_underflow_def(::ufio::basic_io_scatter_t<inchar_type> const *base, ::std::size_t n,
									 ::ufio::intfpos_t off) override
	{
		if constexpr (::ufio::operations::defines::has_input_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::input_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::input_char_type, inchar_type> &&
						  ::ufio::operations::decay::defines::preadable<decaytype>)
			{
				return ::ufio::operations::decay::scatter_pread_some_decay(
					::ufio::operations::input_stream_ref(value), base, n, off);
			}
			else
			{
				throw_posix_error(EINVAL);
	...
	virtual constexpr ::ufio::intfpos_t input_stream_seek_def(::ufio::intfpos_t off,
																 ::ufio::seekdir sdir) override
	{
		if constexpr (::ufio::operations::defines::has_input_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::input_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::input_char_type, inchar_type> &&
						  ::ufio::operations::decay::defines::has_input_stream_seek_define<decaytype>)
			{
				return ::ufio::operations::decay::input_stream_seek_decay(
					::ufio::operations::input_stream_ref(value), off, sdir);
			}
			else
			{
				throw_posix_error(EINVAL);
	...
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_write_some_overflow_def(::ufio::basic_io_scatter_t<outchar_type> const *base, ::std::size_t n) override
	{
		if constexpr (::ufio::operations::defines::has_output_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::output_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::output_char_type, outchar_type> &&
						  ::ufio::operations::decay::defines::writable<decaytype>)
			{
				return ::ufio::operations::decay::scatter_write_some_decay(
					::ufio::operations::input_stream_ref(value), base, n);
			}
			else
			{
	...
	virtual constexpr ::ufio::io_scatter_status_t
	scatter_pwrite_some_overflow_def(::ufio::basic_io_scatter_t<outchar_type> const *base, ::std::size_t n,
									 ::ufio::intfpos_t off) override
	{
		if constexpr (::ufio::operations::defines::has_output_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::output_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::output_char_type, outchar_type> &&
						  ::ufio::operations::decay::defines::pwritable<decaytype>)
			{
				return ::ufio::operations::decay::scatter_pwrite_some_decay(
					::ufio::operations::input_stream_ref(value), base, n, off);
			}
			else
			{
	...
	virtual constexpr ::ufio::intfpos_t output_stream_seek_def(::ufio::intfpos_t off,
																  ::ufio::seekdir sdir) override
	{
		if constexpr (::ufio::operations::defines::has_output_or_io_stream_ref_define<T>)
		{
			using decaytype = decltype(::ufio::operations::output_stream_ref(value));
			if constexpr (::std::same_as<typename decaytype::output_char_type, outchar_type> &&
						  ::ufio::operations::decay::defines::has_output_stream_seek_define<decaytype>)
			{
				return ::ufio::operations::decay::output_stream_seek_decay(
					::ufio::operations::output_stream_ref(value), off, sdir);
			}
			else
			{
				throw_posix_error(EINVAL);
...
template <::std::integral inchar_type, ::std::integral outchar_type>
inline constexpr ::ufio::io_scatter_status_t
scatter_read_some_underflow_define(basic_general_io_io_observer<inchar_type, outchar_type> biob,
								   ::ufio::basic_io_scatter_t<inchar_type> const *pst, ::std::size_t n)
{
...
template <::std::integral inchar_type, ::std::integral outchar_type>
inline constexpr ::ufio::intfpos_t
input_stream_seek_define(basic_general_io_io_observer<inchar_type, outchar_type> biob, ::ufio::intfpos_t off,
						 ::ufio::seekdir sdir)
{
...
template <::std::integral inchar_type, ::std::integral outchar_type>
inline constexpr ::ufio::intfpos_t
output_stream_seek_define(basic_general_io_io_observer<inchar_type, outchar_type> biob, ::ufio::intfpos_t off,
						  ::ufio::seekdir sdir)
{
...
inline constexpr ::ufio::basic_io_io_base<inchartype, outchartype> *create_io_file_handle_impl(Args &&...args)
{
	...
	::ufio::details::biobd_allocate_guard<allocatortype, type> g(ptr);
	::new (ptr) type(::ufio::io_cookie, ::ufio::freestanding::forward<Args>(args)...);
	g.ptr = nullptr;
	return ptr;
}
...
public:
	...
	explicit constexpr basic_general_io_file(io_cookie_type_t<T>, Args &&...args)
		: basic_general_io_io_observer<inchar_type, outchar_type>{
			  ::ufio::details::create_io_file_handle_impl<inchar_type, outchar_type, allocatortype, T>(
	...
	constexpr basic_general_io_file(io_cookie_t, P &&p)
		: basic_general_io_io_observer<inchar_type, outchar_type>{
			  ::ufio::details::create_io_file_handle_impl<inchar_type, outchar_type, allocatortype,
															 ::std::remove_reference_t<P>>(
				  ::ufio::freestanding::forward<P>(p))}
	{
	}
	...
	basic_general_io_file_ref<basic_general_io_file<inchar_type, outchar_type, allocatortype>> rf, dectref &&deco)
{
	*rf.giofptr = basic_general_io_file<inchar_type, outchar_type, allocatortype>(
		...
		::ufio::freestanding::forward<dectref>(deco), ::ufio::freestanding::move(*rf.giofptr));
}
...
template <::std::integral char_type, typename allocatortype = ::ufio::native_thread_local_allocator>
