...
struct deque_controller
{
	...
	::ufio::containers::details::deque_control_block<T> front_block;
	::ufio::containers::details::deque_control_block<T> back_block;
	::ufio::containers::details::deque_controller_block<T> controller_block;
};
	...
	deque_controller_common
{
	...
	::ufio::containers::details::deque_control_block_common front_block;
	::ufio::containers::details::deque_control_block_common back_block;
	::ufio::containers::details::deque_controller_block_common controller_block;
};
...
struct deque_iterator
{
	...
	constexpr deque_iterator &operator++() noexcept
	{
		...
		{
			constexpr size_type blocksize{::ufio::containers::details::deque_block_size<sizeof(value_type)>};
...
template <typename T, bool isconst>
inline constexpr ::ufio::containers::details::deque_iterator<T, isconst> operator+(::ufio::containers::details::deque_iterator<T, isconst> a, ::std::ptrdiff_t pos) noexcept
{
	return (a += pos);
}

template <typename T, bool isconst>
inline constexpr ::ufio::containers::details::deque_iterator<T, isconst> operator+(::std::ptrdiff_t pos, ::ufio::containers::details::deque_iterator<T, isconst> a) noexcept
{
	return (a += pos);
}
...
template <typename T>
inline constexpr ::std::ptrdiff_t deque_iter_difference_common(::ufio::containers::details::deque_control_block<T> const &a, ::ufio::containers::details::deque_control_block<T> const &b) noexcept
{
	::std::ptrdiff_t controllerdiff{a.controller_ptr - b.controller_ptr};
	constexpr ::std::ptrdiff_t blocksizedf{static_cast<::std::ptrdiff_t>(::ufio::containers::details::deque_block_size<sizeof(T)>)};
...
inline constexpr ::std::ptrdiff_t operator-(::ufio::containers::details::deque_iterator<T, isconst1> const &a, ::ufio::containers::details::deque_iterator<T, isconst2> const &b) noexcept
{
	return ::ufio::containers::details::deque_iter_difference_common(a.itercontent, b.itercontent);
}

template <typename T, bool isconst1, bool isconst2>
inline constexpr bool operator==(::ufio::containers::details::deque_iterator<T, isconst1> const &a, ::ufio::containers::details::deque_iterator<T, isconst2> const &b) noexcept
{
	return a.itercontent.curr_ptr == b.itercontent.curr_ptr;
}

template <typename T, bool isconst1, bool isconst2>
inline constexpr auto operator<=>(::ufio::containers::details::deque_iterator<T, isconst1> const &a, ::ufio::containers::details::deque_iterator<T, isconst2> const &b) noexcept
{
...
{
	constexpr ::std::size_t totalsz{sz * ::ufio::containers::details::deque_block_size<sz>};
	if constexpr (align <= allocator::default_alignment)
	{
		::ufio::containers::details::deque_destroy_trivial_common_no_align<allocator, controllerblocktype>(controllerptr, totalsz);
	}
	else
	{
		::ufio::containers::details::deque_destroy_trivial_common_align<allocator, controllerblocktype>(controllerptr, align, totalsz);
	}
}
...
#endif
	{
		::ufio::containers::details::deque_destroy_trivial_common_impl<allocator, align, sz, controllerblocktype>(__builtin_addressof(controller));
	}
	else
	{
		::ufio::containers::details::deque_destroy_trivial_common_impl<allocator, align, sz, ::ufio::containers::details::deque_controller_block_common>(
			reinterpret_cast<::ufio::containers::details::deque_controller_block_common *>(__builtin_addressof(controller)));
	}
}
...
{
	::ufio::containers::details::deque_init_grow_common_controllerallocate_impl<allocator>(controller, total_block_size, mid, static_cast<typename dequecontroltype::replacetype *>(allocator::allocate_zero(total_block_size)));
}
...
{
	::ufio::containers::details::deque_init_grow_common_controllerallocate_impl<allocator>(controller, total_block_size, mid, static_cast<typename dequecontroltype::replacetype *>(allocator::allocate_zero_aligned(align, total_block_size)));
}
...
inline constexpr void deque_init_grow_common(dequecontroltype &controller) noexcept
{
	if constexpr (align <= allocator::default_alignment)
	{
		::ufio::containers::details::deque_init_grow_common_noalign_impl<allocator>(controller, block_size, mid);
	}
	else
	{
		::ufio::containers::details::deque_init_grow_common_align_impl<allocator>(controller, align, block_size, mid);
	}
}
...
constexpr void deque_make_reserved_blocks_balance_common_impl(dequecontroltype &controller) noexcept
{
	...
	controller.front_block.controller_ptr =
		::ufio::containers::details::make_blocks_balance(
...
constexpr void deque_grow_front_common_impl(dequecontroltype &controller) noexcept
{
	if (controller.controller_block.controller_start_ptr == nullptr) [[unlikely]]
	{
		...
		::ufio::containers::details::deque_init_grow_common<allocator, align, block_size, mid>(controller);
	...
	if (controller.front_block.controller_ptr == controller.controller_block.controller_start_reserved_ptr)
	{
		...
		if (controller.controller_block.controller_after_reserved_ptr - controller.back_block.controller_ptr < 2u)
		{
			...
			if (controller.controller_block.controller_start_ptr == controller.controller_block.controller_start_reserved_ptr)
			{
				...
				{
					::ufio::containers::details::deque_reallocate_controller_block_common_impl<allocator>(controller);
				}

				if (controller.controller_block.controller_start_ptr == controller.controller_block.controller_start_reserved_ptr)
				{
					::ufio::containers::details::deque_make_unreserved_blocks_balance_common_impl(controller);
				}
			}
		...
		{
			::ufio::containers::details::deque_make_reserved_blocks_balance_common_impl(controller);
		}
	}
...
{
	::ufio::containers::details::deque_grow_front_common_impl<allocator, align, sz, block_size>(controller);
}

template <typename allocator, ::std::size_t align, ::std::size_t sz, ::std::size_t block_size, typename dequecontroltype>
inline constexpr void deque_grow_back_common(dequecontroltype &controller) noexcept
{
	::ufio::containers::details::deque_grow_back_common_impl<allocator, align, sz, block_size>(controller);
}
...
public:
	...
	using size_type = ::std::size_t;
	using difference_type = ::std::ptrdiff_t;
	using iterator = ::ufio::containers::details::deque_iterator<T, false>;
	using const_iterator = ::ufio::containers::details::deque_iterator<T, true>;
	using reverse_iterator = ::std::reverse_iterator<iterator>;
	using const_reverse_iterator = ::std::reverse_iterator<const_iterator>;

	::ufio::containers::details::deque_controller<T> controller;
	static inline constexpr size_type block_size{::ufio::containers::details::deque_block_size<sizeof(value_type)>};
...
private:
	...
	constexpr void destroy() noexcept
	{
		...
		::ufio::containers::details::deque_destroy_trivial_common<allocator, alignof(value_type), sizeof(value_type)>(controller.controller_block);
	}
...
#endif
		{
			::ufio::containers::details::deque_init_grow_common<allocator, alignof(value_type), block_size, mid>(controller);
		}
		else
		{
			::ufio::containers::details::deque_init_grow_common<allocator, alignof(value_type), sizeof(value_type) * block_size, sizeof(value_type) * mid>(*reinterpret_cast<::ufio::containers::details::deque_controller_common *>(__builtin_addressof(controller)));
		}
	}
...
#endif
		{
			::ufio::containers::details::deque_grow_front_common<allocator, alignof(value_type), sizeof(value_type), block_size>(controller);
		}
		else
		{
			::ufio::containers::details::deque_grow_front_common<allocator, alignof(value_type), sizeof(value_type), sizeof(value_type) * block_size>(*reinterpret_cast<::ufio::containers::details::deque_controller_common *>(__builtin_addressof(controller)));
		}
	}
...
#endif
		{
			::ufio::containers::details::deque_grow_back_common<allocator, alignof(value_type), sizeof(value_type), block_size>(controller);
		}
		else
		{
			::ufio::containers::details::deque_grow_back_common<allocator, alignof(value_type), sizeof(value_type), sizeof(value_type) * block_size>(*reinterpret_cast<::ufio::containers::details::deque_controller_common *>(__builtin_addressof(controller)));
		}
	}
...
private:
	constexpr ::ufio::containers::details::deque_control_block<value_type> end_common() noexcept
	{
		::ufio::containers::details::deque_control_block<value_type> backblock{this->controller.back_block};
	...
	constexpr ::ufio::containers::details::deque_control_block<value_type> end_common() const noexcept
	{
		::ufio::containers::details::deque_control_block<value_type> backblock{this->controller.back_block};
		if (backblock.curr_ptr == backblock.end_ptr) [[unlikely]]
		{
...
template <typename T, typename allocator>
struct is_trivially_relocatable<::ufio::containers::deque<T, allocator>>
{
	inline static constexpr bool value = true;
};

template <typename T, typename allocator>
struct is_zero_default_constructible<::ufio::containers::deque<T, allocator>>
{
	inline static constexpr bool value = true;
};
