...
public:
	...
	template <::std::ranges::contiguous_range R>
		requires(::std::same_as<value_type, ::std::ranges::range_value_t<R>> && !::std::same_as<::std::remove_cvref_t<R>, ::ufio::containers::span<element_type>>)
	...
	[[msvc::forceinline]]
#endif
	inline constexpr span subspan(size_type pos, size_type count = ::ufio::containers::npos) const noexcept
	{
	...
	[[msvc::forceinline]]
#endif
	inline constexpr span subspan_unchecked(size_type pos, size_type count = ::ufio::containers::npos) const noexcept
	{
		size_type const val{this->n - pos};
...
template <typename T>
inline constexpr ::ufio::containers::span<::std::byte const> as_bytes(::ufio::containers::span<T> sp) noexcept
{
	return ::ufio::containers::span<::std::byte const>(static_cast<::std::byte const *>(static_cast<void const *>(sp.ptr)), sp.n * sizeof(T));
}

template <typename T>
	requires(!::std::is_const_v<T>)
inline constexpr ::ufio::containers::span<::std::byte> as_writable_bytes(::ufio::containers::span<T> sp) noexcept
{
	return ::ufio::containers::span<::std::byte>(static_cast<::std::byte *>(static_cast<void *>(sp.ptr)), sp.n * sizeof(T));
}
...
constexpr bool operator==(::ufio::containers::span<T> a, ::ufio::containers::span<T> b)
{
...
constexpr auto operator<=>(::ufio::containers::span<T> a, ::ufio::containers::span<T> b)
{
