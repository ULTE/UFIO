...
using ::ufio::containers::npos;

} // namespace ufio

namespace ufio::containers::details
{
template <typename handle>
concept is_trivally_stored_allocator_handle = ::ufio::freestanding::is_zero_default_constructible_v<handle> &&
											  ::ufio::freestanding::is_trivially_relocatable_v<handle> &&
...
struct handle_holder
{
	...
	{
		value = ::ufio::typed_generic_allocator_adapter<handle, handle>::handle_allocate(large_object, 1);
