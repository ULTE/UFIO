...
public:
	...
	explicit constexpr stack(::ufio::freestanding::from_range_t, R &&rg)
	...
	constexpr void swap(::ufio::containers::stack<Container> &b) noexcept
	{
...
template <typename Container>
constexpr bool operator==(::ufio::containers::stack<Container> const &a, ::ufio::containers::stack<Container> const &b) noexcept
{
	return a.container == b.container;
}

template <typename Container>
constexpr auto operator<=>(::ufio::containers::stack<Container> const &a, ::ufio::containers::stack<Container> const &b) noexcept
{
	return a.container <=> b.container;
}

template <typename Container>
constexpr void swap(::ufio::containers::stack<Container> &a, ::ufio::containers::stack<Container> &b) noexcept
{
	a.swap(b);
}
