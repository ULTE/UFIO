...
public:
	...
	explicit constexpr queue(::ufio::freestanding::from_range_t, R &&rg)
		: container(::ufio::freestanding::from_range, ::std::forward<R>(rg))
	{}
	...
	constexpr void swap(::ufio::containers::queue<Container> &b) noexcept
	{
...
template <typename Container>
constexpr bool operator==(::ufio::containers::queue<Container> const &a, ::ufio::containers::queue<Container> const &b) noexcept
{
	return a.container == b.container;
}

template <typename Container>
constexpr auto operator<=>(::ufio::containers::queue<Container> const &a, ::ufio::containers::queue<Container> const &b) noexcept
{
	return a.container <=> b.container;
}

template <typename Container>
constexpr void swap(::ufio::containers::queue<Container> &a, ::ufio::containers::queue<Container> &b) noexcept
{
	a.swap(b);
}
