...
inline void forward_list_trivially_destroy_sa(void *first, void *last)
{
	...
	{
		::ufio::containers::details::forward_list_trivially_destroy<allocator>(first, last, sz);
	}
	else
	{
		::ufio::containers::details::forward_list_trivially_destroy_aligned<allocator>(first, last, align, sz);
	}
}

inline constexpr void forward_list_main_insert_after_ptr_common(void *newnodevp, void *iter) noexcept
{
	auto newnode(static_cast<::ufio::containers::details::forward_list_node_common *>(newnodevp));
	auto node = static_cast<::ufio::containers::details::forward_list_node_common *>(iter);
...
{
	auto node = static_cast<::ufio::containers::details::forward_list_node_common *>(iter);
	auto next = static_cast<::ufio::containers::details::forward_list_node_common *>(node);
	node->next = next->next;
}
...
inline constexpr void *forward_list_trivially_allocate_insert_after_sa(void *iter) noexcept
{
	if constexpr (align <= allocator::default_alignment)
	{
		return ::ufio::containers::details::forward_list_trivially_allocate_insert_after<allocator>(iter, sz);
	}
	else
	{
		return ::ufio::containers::details::forward_list_trivially_allocate_insert_after_aligned<allocator>(iter, align, sz);
	}
}

inline constexpr void forward_list_splice_before_after_iter(void *posptr, void *beforefirstptr) noexcept
{
	auto pos = static_cast<::ufio::containers::details::forward_list_node_common *>(posptr);
	auto beforefirst = static_cast<::ufio::containers::details::forward_list_node_common *>(beforefirstptr);
	auto posnext = static_cast<::ufio::containers::details::forward_list_node_common *>(pos->next);
	auto first = static_cast<::ufio::containers::details::forward_list_node_common *>(beforefirst->next);
	auto firstnext = static_cast<::ufio::containers::details::forward_list_node_common *>(first->next);
	pos->next = firstnext;
...
inline constexpr void forward_list_splice_before_after_range_common(void *posptr, void *beforefirstptr, void *beforelastptr) noexcept
{
	...
	auto pos = static_cast<::ufio::containers::details::forward_list_node_common *>(posptr);
	auto beforefirst = static_cast<::ufio::containers::details::forward_list_node_common *>(beforefirstptr);
	auto beforelast = static_cast<::ufio::containers::details::forward_list_node_common *>(beforelastptr);
	auto posnext = static_cast<::ufio::containers::details::forward_list_node_common *>(pos->next);
	auto first = static_cast<::ufio::containers::details::forward_list_node_common *>(beforefirst->next);
	auto last = static_cast<::ufio::containers::details::forward_list_node_common *>(beforelast->next);
...
inline constexpr void *forward_list_trivially_allocate_push_front_sa(void *imp) noexcept
{
	if constexpr (align <= allocator::default_alignment)
	{
		return ::ufio::containers::details::forward_list_trivially_allocate_push_front<allocator>(imp, sz);
	}
	else
	{
		return ::ufio::containers::details::forward_list_trivially_allocate_push_front_aligned<allocator>(imp, align, sz);
	}
}
...
inline constexpr void forward_list_reverse_common(void *firstptr, void *lastptr) noexcept
{
	...
	{
		auto first{static_cast<::ufio::containers::details::forward_list_node_common *>(firstptr)};
...
{
	auto node(static_cast<::ufio::containers::details::forward_list_node_common *>(nodeptr));
	auto first(static_cast<::ufio::containers::details::forward_list_node_common *>(firstptr));
	auto last(static_cast<::ufio::containers::details::forward_list_node_common *>(lastptr));
	auto nodeprev{static_cast<::ufio::containers::details::forward_list_node_common *>(node->prev)};

	auto firstprev(static_cast<::ufio::containers::details::forward_list_node_common *>(first->prev));
	auto lastprev(static_cast<::ufio::containers::details::forward_list_node_common *>(last->prev));
...
{
	auto node(static_cast<::ufio::containers::details::forward_list_node_common *>(nodeptr));
	auto iter(static_cast<::ufio::containers::details::forward_list_node_common *>(iterptr));
	auto iternext(static_cast<::ufio::containers::details::forward_list_node_common *>(iter->next));
	auto iterprev(static_cast<::ufio::containers::details::forward_list_node_common *>(iter->prev));
	auto nodeprev(static_cast<::ufio::containers::details::forward_list_node_common *>(node->prev));
...
{
	::std::size_t n{};
	for (; firstptr != lastptr; firstptr = static_cast<::ufio::containers::details::forward_list_node_common *>(firstptr)->next)
	{
		++n;
	}
	return n;
...
inline constexpr void *forward_list_ptr_advance(void *firstptr, ::std::size_t n) noexcept
{
	for (; n; --n)
	{
		firstptr = static_cast<::ufio::containers::details::forward_list_node_common *>(firstptr)->next;
	}
	return firstptr;
}
...
inline constexpr void forward_list_merge_common(void *leftfirstptr, void *leftlastptr, void *rightfirstptr, void *rightlastptr, Cmp cmp)
{
	...
	{
		auto rightfirst{static_cast<::ufio::containers::details::forward_list_node_common *>(rightfirstptr)};
		...
		for (; rightcurrptr != rightlastptr && cmp(static_cast<forward_list_node<T> *>(rightcurrptr)->element, leftfirstele);
			 rightcurrptr = static_cast<::ufio::containers::details::forward_list_node_common *>(rightcurrptr)->next)
		{
		}

		auto leftfirst{static_cast<::ufio::containers::details::forward_list_node_common *>(leftfirstptr)};
		auto leftfirstnext{static_cast<::ufio::containers::details::forward_list_node_common *>(leftfirst->next)};
		::ufio::containers::details::forward_list_splice_range_common(leftfirst, rightfirst, rightcurrptr);
		rightfirstptr = rightcurrptr;
		leftfirstptr = leftfirstnext;
	}
	::ufio::containers::details::forward_list_splice_range_common(leftlastptr, rightfirstptr, rightlastptr);
}
...
inline constexpr void forward_list_sort_n_common(void *firstptr, void *lastptr, ::std::size_t n, Cmp cmp)
{
	...
	case 2:
	{
		...
		{
			auto firstprev{static_cast<::ufio::containers::details::forward_list_node_common *>(first->prev)};
			auto firstnext{static_cast<::ufio::containers::details::forward_list_node_common *>(firstnextptr)};
	...
	default:
	{
		...
		auto first{static_cast<::ufio::containers::details::forward_list_node_common *>(firstptr)};
		auto firstprev{static_cast<::ufio::containers::details::forward_list_node_common *>(first->prev)};
		auto middle{static_cast<::ufio::containers::details::forward_list_node_common *>(middleptr)};
		auto middleprev{static_cast<::ufio::containers::details::forward_list_node_common *>(middle->prev)};

		::ufio::containers::details::forward_list_node_common leftdetacher{middleprev, first};
		first->prev = middleprev->next = __builtin_addressof(leftdetacher);

		auto last{static_cast<::ufio::containers::details::forward_list_node_common *>(lastptr)};
		auto lastprev{static_cast<::ufio::containers::details::forward_list_node_common *>(last->prev)};
		::ufio::containers::details::forward_list_node_common rightdetacher{lastprev, middle};
		...
		auto leftdetacherprev{static_cast<::ufio::containers::details::forward_list_node_common *>(leftdetacher.prev)};
		leftdetacherprev->next = last;
		last->prev = leftdetacherprev;
		auto leftdetachernext{static_cast<::ufio::containers::details::forward_list_node_common *>(leftdetacher.next)};
...
inline constexpr void forward_list_reverse_after_common(void *beforefirstptr, void *lastptr) noexcept
{
	...
	while (it != last)
	{
		auto nextit{static_cast<::ufio::containers::details::forward_list_node_common *>(it->next)};
		it->next = beforeit;
		beforeit = it;
		it = nextit;
	}
...
{
	return ::ufio::containers::details::forward_list_reverse_after_common(beforefirstptr, nullptr);
}
...
inline constexpr void *forward_list_ptr_advance(void *iter, ::std::size_t n) noexcept
{
	for (; n; --n)
	{
		iter = static_cast<::ufio::containers::details::forward_list_node_common *>(iter)->next;
	}
	return iter;
}
...
{
	auto beforefirst{static_cast<::ufio::containers::details::forward_list_node<T> *>(beforefirstptr)};
	switch (n)
	{
	case 2:
		auto it1{static_cast<::ufio::containers::details::forward_list_node<T> *>(beforefirst->next)};
		auto it2{static_cast<::ufio::containers::details::forward_list_node<T> *>(it1->next)};
	...
	default:
		...
		auto beforemiddle{static_cast<::ufio::containers::details::forward_list_node<T> *>(forward_list_ptr_advance(beforefirstptr, halfn))};
		auto beforelast{static_cast<::ufio::containers::details::forward_list_node<T> *>(beforelastptr)};
...
private:
	using node_type = ::ufio::containers::details::forward_list_node<value_type>;
	...
	using handle_holder_type = ::ufio::containers::details::handle_holder<handle_type>;
	...
	{
		::ufio::containers::details::forward_list_node<value_type> *ptr;
#ifndef __INTELLISENSE__
#if __has_cpp_attribute(msvc::no_unique_address)
		[[msvc::no_unique_address]]
#elif __has_cpp_attribute(no_unique_address)
		...
		explicit constexpr new_handle_guard(::ufio::containers::details::forward_list_node<value_type> *p,
	...
	constexpr void destroy_impl(void *first, void *last) noexcept
	{
...
#endif
		{
			...
			{
				::ufio::containers::details::forward_list_trivially_destroy_sa<allocator_type,
...
public:
	...
	using iterator = ::ufio::containers::details::forward_list_iterator<T, false>;
	using const_iterator = ::ufio::containers::details::forward_list_iterator<T, true>;
...
public:
	...
	explicit constexpr forward_list(::ufio::freestanding::from_range_t, Rg &&rg)
	{
	...
	explicit constexpr forward_list(::std::initializer_list<value_type> ilist)
		: forward_list(::ufio::freestanding::from_range, ilist)
	{
	}
...
private:
	...
	{
		auto node = static_cast<::ufio::containers::details::forward_list_node_common *>(first);
		auto next = static_cast<::ufio::containers::details::forward_list_node_common *>(node)->next;
		node->next = last;
		this->destroy_impl(next, last);
	}
	constexpr void erase_after_impl(void *ptr) noexcept
	{
		auto node = static_cast<::ufio::containers::details::forward_list_node_common *>(ptr);
		auto next = static_cast<::ufio::containers::details::forward_list_node_common *>(node)->next;
		auto nextnext = static_cast<::ufio::containers::details::forward_list_node_common *>(next)->next;
		node->next = nextnext;
...
private:
	...
	constexpr node_type *emplace_after_impl(void *ptr, Args &&...args) noexcept(::std::is_nothrow_constructible_v<value_type, Args...>)
	{
		if constexpr (::std::is_nothrow_constructible_v<value_type, Args...>)
		{
			auto newnode = static_cast<node_type *>(::ufio::containers::details::forward_list_trivially_allocate_insert_after_sa<allocator_type, alignof(node_type), sizeof(node_type)>(ptr));
			::std::construct_at(
				__builtin_addressof(newnode->element),
				::std::forward<Args>(args)...);
			return newnode;
		...
		else
		{
			...
			::ufio::containers::details::forward_list_main_insert_after_ptr_common(newnodecons, ptr);
			return newnodecons;
		}
	}
...
public:
	...
	{
		::ufio::containers::details::forward_list_splice_before_after_iter(pos.iter, beforeit.iter);
	}
	constexpr void splice_before_after(const_iterator pos, const_iterator beforefirst, const_iterator beforelast) noexcept
	{
		::ufio::containers::details::forward_list_splice_before_after_range_common(pos.iter, beforefirst.iter, beforelast.iter);
	}
	constexpr void reverse_after(const_iterator beforefirst, const_iterator last) noexcept
	{
		::ufio::containers::details::forward_list_reverse_after_common(beforefirst.iter, last.iter);
	}
	constexpr void reverse() noexcept
	{
		::ufio::containers::details::forward_list_reverse_common(__builtin_addressof(this->imp));
	}
};

template <typename T, typename allocator1, typename allocator2>
	requires ::std::equality_comparable<T>
constexpr bool operator==(::ufio::containers::forward_list<T, allocator1> const &lhs, ::ufio::containers::forward_list<T, allocator2> const &rhs) noexcept
{
...
constexpr auto operator<=>(::ufio::containers::forward_list<T, allocator1> const &lhs, ::ufio::containers::forward_list<T, allocator2> const &rhs) noexcept
{
