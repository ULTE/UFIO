...
template <typename T, ::std::size_t N>
constexpr void swap(::ufio::containers::array<T, N> &a, ::ufio::containers::array<T, N> &b) noexcept(noexcept(a.swap(b)))
{
	a.swap(b);
}
...
constexpr bool operator==(::ufio::containers::array<T, N1> const &a, ::ufio::containers::array<T, N2> const &b)
{
	if constexpr (N1 == N2)
	{
		if constexpr (N1 == 0)
...
constexpr auto operator<=>(::ufio::containers::array<T, N1> const &a, ::ufio::containers::array<T, N2> const &b)
{
...
constexpr ::ufio::containers::array<std::remove_cv_t<T>, N>
...
constexpr ::ufio::containers::array<::std::remove_cv_t<T>, N> to_array(T (&a)[N]) noexcept(::std::is_nothrow_copy_constructible_v<T>)
{
	return ::ufio::containers::details::to_array_lvalueref_impl(a, ::std::make_index_sequence<N>{});
}

template <typename T, ::std::size_t N>
	requires(!::std::is_array_v<T>)
constexpr ::ufio::containers::array<::std::remove_cv_t<T>, N> to_array(T (&&a)[N]) noexcept(::std::is_nothrow_move_constructible_v<T>)
{
	return ::ufio::containers::details::to_array_rvalueref_impl(::std::move(a), ::std::make_index_sequence<N>{});
}
