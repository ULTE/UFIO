...
public:
	...
	explicit constexpr priority_queue(::ufio::freestanding::from_range_t, R &&rg)
...
template <typename Cmp, typename Container>
constexpr void swap(::ufio::containers::priority_queue<Cmp, Container> &a, ::ufio::containers::priority_queue<Cmp, Container> &b) noexcept
{
	a.swap(b);
}
