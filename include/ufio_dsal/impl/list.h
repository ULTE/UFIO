...
inline void list_trivially_destroy(void *first, void *last, ::std::size_t sz)
{
	...
	{
		auto next{static_cast<::ufio::containers::details::list_node_common *>(it)->next};
...
inline void list_trivially_destroy_sa(void *first, void *last)
{
	...
	{
		::ufio::containers::details::list_trivially_destroy<allocator>(first, last, sz);
	}
	else
	{
		::ufio::containers::details::list_trivially_destroy_aligned<allocator>(first, last, align, sz);
	}
}

inline constexpr void list_main_insert_ptr_common(void *newnodevp, void *iter) noexcept
{
	auto newnode(static_cast<::ufio::containers::details::list_node_common *>(newnodevp));
	auto node = static_cast<::ufio::containers::details::list_node_common *>(iter);
	auto prev = static_cast<::ufio::containers::details::list_node_common *>(node->prev);
	newnode->next = node;
	newnode->prev = prev;
	node->prev = newnode;
	prev->next = newnode;
...
{
	auto newnode(static_cast<::ufio::containers::details::list_node_common *>(newnodevp));
	auto prev = static_cast<::ufio::containers::details::list_node_common *>(imp);
	auto node = static_cast<::ufio::containers::details::list_node_common *>(prev->next);
	newnode->next = node;
	newnode->prev = prev;
	node->prev = newnode;
	prev->next = newnode;
...
inline constexpr void list_main_erase_ptr_common(void *iter) noexcept
{
	auto node = static_cast<::ufio::containers::details::list_node_common *>(iter);
	auto prev = static_cast<::ufio::containers::details::list_node_common *>(node->prev);
	auto next = static_cast<::ufio::containers::details::list_node_common *>(node->next);
	prev->next = next;
	next->prev = prev;
}
...
inline constexpr void *list_trivially_allocate_insert_sa(void *iter) noexcept
{
	if constexpr (align <= allocator::default_alignment)
	{
		return ::ufio::containers::details::list_trivially_allocate_insert<allocator>(iter, sz);
	}
	else
	{
		return ::ufio::containers::details::list_trivially_allocate_insert_aligned<allocator>(iter, align, sz);
	}
}
...
inline constexpr void *list_trivially_allocate_push_front_sa(void *imp) noexcept
{
	if constexpr (align <= allocator::default_alignment)
	{
		return ::ufio::containers::details::list_trivially_allocate_push_front<allocator>(imp, sz);
	}
	else
	{
		return ::ufio::containers::details::list_trivially_allocate_push_front_aligned<allocator>(imp, align, sz);
	}
}
...
inline constexpr void list_reverse_common(void *firstptr, void *lastptr) noexcept
{
	...
	{
		auto first{static_cast<::ufio::containers::details::list_node_common *>(firstptr)};
...
{
	auto node(static_cast<::ufio::containers::details::list_node_common *>(nodeptr));
	auto first(static_cast<::ufio::containers::details::list_node_common *>(firstptr));
	auto last(static_cast<::ufio::containers::details::list_node_common *>(lastptr));
	auto nodeprev{static_cast<::ufio::containers::details::list_node_common *>(node->prev)};

	auto firstprev(static_cast<::ufio::containers::details::list_node_common *>(first->prev));
	auto lastprev(static_cast<::ufio::containers::details::list_node_common *>(last->prev));
...
{
	auto node(static_cast<::ufio::containers::details::list_node_common *>(nodeptr));
	auto iter(static_cast<::ufio::containers::details::list_node_common *>(iterptr));
	auto iternext(static_cast<::ufio::containers::details::list_node_common *>(iter->next));
	auto iterprev(static_cast<::ufio::containers::details::list_node_common *>(iter->prev));
	auto nodeprev(static_cast<::ufio::containers::details::list_node_common *>(node->prev));
...
{
	::std::size_t n{};
	for (; firstptr != lastptr; firstptr = static_cast<::ufio::containers::details::list_node_common *>(firstptr)->next)
	{
		++n;
	}
	return n;
...
inline constexpr void *list_ptr_advance(void *firstptr, ::std::size_t n) noexcept
{
	for (; n; --n)
	{
		firstptr = static_cast<::ufio::containers::details::list_node_common *>(firstptr)->next;
	}
	return firstptr;
}
...
inline constexpr void list_merge_common(void *leftfirstptr, void *leftlastptr, void *rightfirstptr, void *rightlastptr, Cmp cmp)
{
	...
	{
		auto rightfirst{static_cast<::ufio::containers::details::list_node_common *>(rightfirstptr)};
		...
		for (; rightcurrptr != rightlastptr && cmp(static_cast<list_node<T> *>(rightcurrptr)->element, leftfirstele);
			 rightcurrptr = static_cast<::ufio::containers::details::list_node_common *>(rightcurrptr)->next)
		{
		}

		auto leftfirst{static_cast<::ufio::containers::details::list_node_common *>(leftfirstptr)};
		auto leftfirstnext{static_cast<::ufio::containers::details::list_node_common *>(leftfirst->next)};
		::ufio::containers::details::list_splice_range_common(leftfirst, rightfirst, rightcurrptr);
		rightfirstptr = rightcurrptr;
		leftfirstptr = leftfirstnext;
	}
	::ufio::containers::details::list_splice_range_common(leftlastptr, rightfirstptr, rightlastptr);
}
...
inline constexpr void list_sort_n_common(void *firstptr, void *lastptr, ::std::size_t n, Cmp cmp)
{
	...
	case 2:
	{
		...
		{
			auto firstprev{static_cast<::ufio::containers::details::list_node_common *>(first->prev)};
			auto firstnext{static_cast<::ufio::containers::details::list_node_common *>(firstnextptr)};
	...
	default:
	{
		...
		auto first{static_cast<::ufio::containers::details::list_node_common *>(firstptr)};
		auto firstprev{static_cast<::ufio::containers::details::list_node_common *>(first->prev)};
		auto middle{static_cast<::ufio::containers::details::list_node_common *>(middleptr)};
		auto middleprev{static_cast<::ufio::containers::details::list_node_common *>(middle->prev)};

		::ufio::containers::details::list_node_common leftdetacher{middleprev, first};
		first->prev = middleprev->next = __builtin_addressof(leftdetacher);

		auto last{static_cast<::ufio::containers::details::list_node_common *>(lastptr)};
		auto lastprev{static_cast<::ufio::containers::details::list_node_common *>(last->prev)};
		::ufio::containers::details::list_node_common rightdetacher{lastprev, middle};
		...
		auto leftdetacherprev{static_cast<::ufio::containers::details::list_node_common *>(leftdetacher.prev)};
		leftdetacherprev->next = last;
		last->prev = leftdetacherprev;
		auto leftdetachernext{static_cast<::ufio::containers::details::list_node_common *>(leftdetacher.next)};
...
private:
	using node_type = ::ufio::containers::details::list_node<value_type>;
	...
	{
		::ufio::containers::details::list_node<value_type> *ptr;
#ifndef __INTELLISENSE__
#if __has_cpp_attribute(msvc::no_unique_address)
		[[msvc::no_unique_address]]
#elif __has_cpp_attribute(no_unique_address)
		...
		explicit constexpr new_handle_guard(::ufio::containers::details::list_node<value_type> *p,
											list<T, allocator> *va)
		{
			ptr = p;
			if constexpr (alloc_with_status)
...
public:
	...
	using iterator = ::ufio::containers::details::list_iterator<T, false>;
	using const_iterator = ::ufio::containers::details::list_iterator<T, true>;

	using reverse_iterator = ::std::reverse_iterator<iterator>;
	using const_reverse_iterator = ::std::reverse_iterator<const_iterator>;

	::ufio::containers::details::list_node_common imp;
...
public:
	...
	explicit constexpr list(::ufio::freestanding::from_range_t, R &&rg)
		: imp{__builtin_addressof(imp), __builtin_addressof(imp)}
	{
...
public:
	...
	constexpr reference emplace_back(Args &&...args) noexcept(::std::is_nothrow_constructible_v<value_type, Args...>)
	{
		...
		else
		{
			...
			::ufio::containers::details::list_main_insert_ptr_common(newnodecons, __builtin_addressof(imp));
	...
	constexpr reference emplace_front(Args &&...args) noexcept(::std::is_nothrow_constructible_v<value_type, Args...>)
	{
		...
		{
			auto newnodecons = allocate_construct_new_node(::std::forward<Args>(args)...);
			::ufio::containers::details::list_main_push_front_ptr_common(newnodecons, __builtin_addressof(imp));
			return newnodecons->element;
		}
	}
	...
	constexpr reference emplace(const_iterator iter, Args &&...args) noexcept(::std::is_nothrow_constructible_v<value_type, Args...>)
	{
		if constexpr (::std::is_nothrow_constructible_v<value_type, Args...>)
		{
			auto newnode = static_cast<node_type *>(::ufio::containers::details::list_trivially_allocate_insert_sa<allocator_type, alignof(node_type), sizeof(node_type)>(iter.iter));
			::std::construct_at(
				__builtin_addressof(newnode->element),
				::std::forward<Args>(args)...);
			return newnode->element;
		...
		{
			auto newnodecons = allocate_construct_new_node(::std::forward<Args>(args)...);
			::ufio::containers::details::list_main_insert_ptr_common(newnodecons, iter.iter);
			return newnodecons->element;
		}
	}
...
public:
	...
	{
		auto node = static_cast<::ufio::containers::details::list_node_common *>(imp.prev);
	...
	{
		auto node = static_cast<::ufio::containers::details::list_node_common *>(imp.next);
		if (node == __builtin_addressof(imp))
		{
			::ufio::fast_terminate();
		}
	...
	[[nodiscard]] constexpr const_reference front() const noexcept
	{
		...
		return static_cast<::ufio::containers::details::list_node<T> *>(nodeptr)->element;
	}
	...
	{
		auto node = static_cast<::ufio::containers::details::list_node_common *>(iter.iter);
		::ufio::containers::details::list_main_erase_ptr_common(node);
		destroy_node(node);
	}
	...
	constexpr list(list &&other) noexcept
		: imp(other.imp)
	{
		auto prev = static_cast<::ufio::containers::details::list_node_common *>(imp.prev);
		auto next = static_cast<::ufio::containers::details::list_node_common *>(imp.next);
...
private:
	constexpr void destroy() noexcept
	{
...
#endif
		{
			...
			{
				::ufio::containers::details::list_trivially_destroy_sa<allocator_type,
...
public:
	...
	{
		::ufio::containers::details::list_splice_range_common(pos.iter, first.iter, last.iter);
	}

	constexpr void splice(const_iterator pos, const_iterator it) noexcept
	{
		::ufio::containers::details::list_splice_single_common(pos.iter, it.iter);
	}

	constexpr void splice(const_iterator pos, list &&other) noexcept
	{
		::ufio::containers::details::list_splice_range_common(pos.iter, other.imp.next, __builtin_addressof(other.imp));
	}

	constexpr void reverse() noexcept
	{
		::ufio::containers::details::list_reverse_common(imp.next, __builtin_addressof(imp));
	...
	constexpr void merge(list &&other, Cmp cmp) noexcept
	{
		...
		::ufio::containers::details::list_merge_common<value_type, Cmp>(imp.next, __builtin_addressof(imp),
	...
	{
		::ufio::containers::details::list_sort_common<value_type, Cmp>(imp.next, __builtin_addressof(imp), cmp);
	}
	...
	{
		::ufio::containers::details::list_sort_common<value_type, Cmp>(first.iter, last.iter, cmp);
	}
