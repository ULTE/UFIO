...
class basic_cstring_view : private ::ufio::containers::basic_string_view<char_type>
{
public:
	...
	constexpr basic_cstring_view() noexcept
		: string_view_type(__builtin_addressof(::ufio::char_literal_v<0, char_type>), 0)
	{}
	constexpr void clear() noexcept
	{
		this->ptr = __builtin_addressof(::ufio::char_literal_v<0, char_type>);
		this->n = 0;
	}
	constexpr basic_cstring_view(::std::nullptr_t) = delete;

	explicit constexpr basic_cstring_view(::ufio::containers::null_terminated_t, const_pointer p, size_type s) noexcept
	...
	explicit constexpr basic_cstring_view(::ufio::containers::null_terminated_t, string_view_type stvw) noexcept
	...
	explicit constexpr basic_cstring_view(::ufio::containers::null_terminated_t, ::ufio::freestanding::from_range_t, rg const &&r) noexcept
		: string_view_type(::std::forward<rg>(r))
	{
	}

	constexpr basic_cstring_view(::ufio::manipulators::basic_os_c_str<char_type> osstr) noexcept
		: string_view_type(osstr)
	{}
	constexpr basic_cstring_view(::ufio::manipulators::basic_os_c_str_with_known_size<char_type> osstr) noexcept
		: string_view_type(osstr)
	{}
...
template <::std::integral char_type>
constexpr void swap(::ufio::containers::basic_cstring_view<char_type> &a, basic_cstring_view<char_type> &b) noexcept
{
	a.swap(b);
}
template <::std::integral char_type>
inline constexpr ::ufio::basic_io_scatter_t<char_type> print_alias_define(::ufio::io_alias_t, ::ufio::containers::basic_cstring_view<char_type> str) noexcept
{
	return {str.ptr, str.n};
}

template <::std::integral char_type>
constexpr bool operator==(::ufio::containers::basic_cstring_view<char_type> a, ::ufio::containers::basic_cstring_view<char_type> b) noexcept
{
	return ::std::equal(a.ptr, a.ptr + a.n, b.ptr, b.ptr + b.n);
}

template <::std::integral char_type, ::std::size_t n>
constexpr bool operator==(::ufio::containers::basic_cstring_view<char_type> a, char_type const (&buffer)[n]) noexcept
{
...
template <::std::integral char_type, ::std::size_t n>
constexpr bool operator==(char_type const (&buffer)[n], ::ufio::containers::basic_cstring_view<char_type> a) noexcept
{
	constexpr ::std::size_t nm1{n - 1u};
...
template <::std::integral char_type>
constexpr bool operator==(::ufio::containers::basic_cstring_view<char_type> a, ::ufio::containers::basic_string_view<char_type> b) noexcept
{
	return ::std::equal(a.ptr, a.ptr + a.n, b.ptr, b.ptr + b.n);
}

template <::std::integral char_type>
constexpr bool operator==(::ufio::containers::basic_string_view<char_type> a, ::ufio::containers::basic_cstring_view<char_type> b) noexcept
{
	return b == a;
}
...
template <::std::integral char_type>
constexpr auto operator<=>(::ufio::containers::basic_cstring_view<char_type> a, ::ufio::containers::basic_cstring_view<char_type> b) noexcept
{
	return ::std::lexicographical_compare_three_way(a.ptr, a.ptr + a.n, b.ptr, b.ptr + b.n, ::std::compare_three_way{});
}

template <::std::integral char_type, ::std::size_t n>
constexpr auto operator<=>(::ufio::containers::basic_cstring_view<char_type> a, char_type const (&buffer)[n]) noexcept
{
	constexpr ::std::size_t nm1{n - 1u};
...
template <::std::integral char_type, ::std::size_t n>
constexpr auto operator<=>(char_type const (&buffer)[n], ::ufio::containers::basic_cstring_view<char_type> a) noexcept
{
	constexpr ::std::size_t nm1{n - 1u};
...
template <::std::integral char_type>
constexpr auto operator<=>(::ufio::containers::basic_cstring_view<char_type> a, ::ufio::containers::basic_string_view<char_type> b) noexcept
{
	return ::std::lexicographical_compare_three_way(a.ptr, a.ptr + a.n, b.ptr, b.ptr + b.n, ::std::compare_three_way{});
}

template <::std::integral char_type>
constexpr auto operator<=>(::ufio::containers::basic_string_view<char_type> a, ::ufio::containers::basic_cstring_view<char_type> b) noexcept
{
	return ::std::lexicographical_compare_three_way(a.ptr, a.ptr + a.n, b.ptr, b.ptr + b.n, ::std::compare_three_way{});
}
