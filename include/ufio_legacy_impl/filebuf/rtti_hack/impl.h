...
{
	return ::ufio::details::symbol_cmp_equal_commom(sym.ptr, strp, len, N);
}

template <::std::size_t N>
inline constexpr bool symbol_cmp_equal(::ufio::freestanding::array<char8_t, N> const &sym, char const *strp, ::std::size_t len) noexcept
{
	return ::ufio::details::symbol_cmp_equal_commom(sym.data(), strp, len, N);
}
