...
template <typename T>
inline bool ibuffer_underflow(::ufio::basic_general_streambuf_io_observer<T> biob)
{
	...
	using model = ::ufio::details::streambuf_hack::basic_streambuf_hack_model<char_type, traits_type>;
...
template <typename T>
inline void obuffer_overflow(::ufio::basic_general_streambuf_io_observer<T> biob, typename T::char_type ch)
{
	using char_type = typename ::ufio::basic_general_streambuf_io_observer<T>::char_type;
	using traits_type = typename ::ufio::basic_general_streambuf_io_observer<T>::traits_type;
	using model = ::ufio::details::streambuf_hack::basic_streambuf_hack_model<char_type, traits_type>;
