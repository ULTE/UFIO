		...
		if (fb) [[likely]]
		{
						  ...
						  ::std::same_as<char_type, char32_t>)
			{
				...
				if (my_type)
				{
					...
					if (::ufio::details::symbol_cmp_equal(::ufio::details::libstdcxx_streambufname<0, char_type>, my_type, mytypelen))
					{
...
[[nodiscard]]
#endif
inline ::std::basic_filebuf<CharT, Traits> *open_hacked_basic_filebuf(FILE *fp, ::ufio::open_mode)
{
