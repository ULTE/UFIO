...
{
	constexpr bool type_error{(::ufio::details::printable_to_cxx_ostringstream<char, Args> && ...)};
...
{
	constexpr bool type_error{(::ufio::details::printable_to_cxx_ostringstream<wchar_t, Args> && ...)};
	if constexpr (type_error)
	{
