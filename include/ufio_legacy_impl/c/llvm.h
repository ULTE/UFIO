...
{
	return reinterpret_cast<char_type *>(::ufio::details::llvmlibc_hack::llvm_libc_buffer_begin(ciob.fp));
}
...
{
	return reinterpret_cast<char_type *>(::ufio::details::llvmlibc_hack::llvm_libc_buffer_curr(ciob.fp));
}
...
{
	return reinterpret_cast<char_type *>(::ufio::details::llvmlibc_hack::llvm_libc_ibuffer_end(ciob.fp));
}
...
{
	return reinterpret_cast<char_type *>(::ufio::details::llvmlibc_hack::llvm_libc_obuffer_end(ciob.fp));
}
...
{
	::ufio::details::llvmlibc_hack::llvm_libc_set_buffer_curr(ciob.fp, ptr);
}
...
{
	return ::ufio::details::llvmlibc_hack::llvm_libc_underflow(ciob.fp);
}
...
{
	::ufio::details::llvmlibc_hack::llvm_libc_overflow(ciob.fp, static_cast<char>(ch));
}
