...
inline constexpr auto hexfloat(::std::complex<scalar_type> t) noexcept
{
	...
	)
	{
		...
		{
			return scalar_manip_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, false>,
...
inline constexpr auto hexfloat(::std::complex<scalar_type> t, ::std::size_t n) noexcept
{
	...
	)
	{
		...
		if constexpr (sizeof(scalar_type) > sizeof(double))
		{
			return scalar_manip_precision_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, false>,
											::std::complex<__float128>>{
...
inline constexpr auto comma_hexfloat(::std::complex<scalar_type> t) noexcept
{
	...
	)
	{
		...
		if constexpr (sizeof(scalar_type) > sizeof(double))
		{
			return scalar_manip_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, true>,
								  ::std::complex<__float128>>{
				{static_cast<__float128>(::std::real(t)), static_cast<__float128>(::std::imag(t))}};
		}
		else
...
inline constexpr auto comma_hexfloat(::std::complex<scalar_type> t, ::std::size_t n) noexcept
{
	...
	)
	{
		...
		if constexpr (sizeof(scalar_type) > sizeof(double))
		{
			return scalar_manip_precision_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, true>,
											::std::complex<__float128>>{
				{static_cast<__float128>(::std::real(t)), static_cast<__float128>(::std::imag(t))}, n};
		}
		else
...
inline constexpr auto scientific(::std::complex<scalar_type> t) noexcept
{
	...
	)
	{
		...
		if constexpr (sizeof(scalar_type) > sizeof(double))
		{
			return scalar_manip_t<::ufio::details::dcmfloat_mani_flags_cache<
...
inline constexpr auto scientific(::std::complex<scalar_type> t, ::std::size_t n) noexcept
{
	...
	)
	{
		...
		if constexpr (sizeof(scalar_type) > sizeof(double))
		{
			return scalar_manip_precision_t<::ufio::details::dcmfloat_mani_flags_cache<
												uppercase, false, manipulators::floating_format::scientific>,
											::std::complex<__float128>>{
				{static_cast<__float128>(::std::real(t)), static_cast<__float128>(::std::imag(t))}, n};
		}
...
{
	return ::ufio::mnp::general<false>(t);
}

namespace details
{
template <::ufio::manipulators::scalar_flags flags, typename T, ::std::integral char_type>
inline constexpr char_type *print_reserve_complex_impl(char_type *iter, T real, T imag) noexcept
{
	*iter = char_literal_v<u8'(', char_type>;
	++iter;
	iter = print_reserve_define(io_reserve_type<char_type, ::ufio::manipulators::scalar_manip_t<flags, T>>, iter,
								::ufio::manipulators::scalar_manip_t<flags, T>{real});
	*iter = char_literal_v<(flags.comma ? u8'.' : u8','), char_type>;
	++iter;
	iter = print_reserve_define(io_reserve_type<char_type, ::ufio::manipulators::scalar_manip_t<flags, T>>, iter,
								::ufio::manipulators::scalar_manip_t<flags, T>{imag});
	*iter = char_literal_v<u8')', char_type>;
	++iter;
	return iter;
}
...
{
	return ::ufio::details::print_reserve_complex_impl<flags>(iter, ::std::real(f.reference),
