										 ...
										 ::std::uint_least64_t pow10_high, ::std::int_least32_t beta_minus_1) noexcept
{
	...
	::std::uint_least64_t const p10{::ufio::intrinsics::umulh(two_f, pow10_low)};
...
dragonbox_main(typename iec559_traits<flt>::mantissa_type m2, ::std::int_least32_t e2) noexcept
{
	...
	if constexpr (sizeof(flt) == sizeof(::std::uint_least64_t))
	{
		...
		::std::uint_least64_t const zi{::ufio::intrinsics::umulh(two_fr << beta_minus_1, ::ufio::intrinsics::pack_ul64(pow10_lo, pow10_hi))};
	...
	else if constexpr (sizeof(flt) == sizeof(::std::uint_least32_t))
	{
		...
		::std::uint_least32_t const zi{::ufio::intrinsics::umulh(two_fr << beta_minus_1, pow10)};
...
dragonbox_impl(typename iec559_traits<flt>::mantissa_type m2, ::std::int_least32_t e2) noexcept
{
	...
	// m10 should not ==0
	auto [v, n] = ::ufio::bitops::rtz_iec559(m10);
...
{
	auto itp1{iter + 1};
	::ufio::details::jeaiii::jeaiii_main_len<true>(itp1, m10, m10len);
	*iter = *itp1;
...
{
	::ufio::details::jeaiii::jeaiii_main_len<true>(iter, m10, static_cast<::std::uint_least32_t>(olength));
	iter += olength;
							  ...
							  ::std::int_least32_t olength, ::std::int_least32_t real_exp) noexcept
{
	...
	{
		auto tmp{iter};
		::ufio::details::jeaiii::jeaiii_main_len<true>(iter + 1, m10, static_cast<::std::uint_least32_t>(olength));
		iter += olength + 1;
...
template <typename flt, bool comma, bool uppercase_e, ::ufio::manipulators::floating_format mt,
													   ...
													   ::std::int_least32_t e10) noexcept
{
	if constexpr (mt == ::ufio::manipulators::floating_format::general)
	{
		...
		return print_rsv_fp_decision_impl<flt, comma, uppercase_e,
										  ::ufio::manipulators::floating_format::scientific>(iter, m10, e10);
	}
	else if constexpr (mt == ::ufio::manipulators::floating_format::scientific)
	{
		...
		else
		{
			auto iterp1{iter};
			++iterp1;
			auto new_iter{::ufio::details::jeaiii::jeaiii_main<false>(iterp1, m10)};
...
template <bool showpos, bool uppercase, bool uppercase_e, bool comma, ::ufio::manipulators::floating_format mt,
...
template <typename flt, ::ufio::manipulators::floating_format mf>
...
template <typename flt, ::ufio::manipulators::floating_format mt>
