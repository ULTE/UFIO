...
template <::std::integral char_type, bool showpos, bool uppercase, bool uppercase_e, bool comma,
		  ::ufio::manipulators::floating_format mt, typename flt>
											...
											char_type *iter, ::std::size_t precision) noexcept
{
	...
	else if constexpr (mt == ::ufio::manipulators::floating_format::generic)
	{
	}
	else if constexpr (mt == ::ufio::manipulators::floating_format::fixed)
	{
	}
	return iter;
}
...
template <::std::integral char_type, bool showpos = false, bool uppercase = false, bool uppercase_e = false,
		  bool comma = false,
		  ::ufio::manipulators::floating_format mt = ::ufio::manipulators::floating_format::general,
