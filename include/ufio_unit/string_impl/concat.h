...
[[deprecated("use ::ufio::concat_std instead"), nodiscard]] inline
	...
	concat(Args &&...args)
{
	constexpr bool type_error{
		::ufio::operations::defines::print_freestanding_okay<::ufio::details::dummy_buffer_output_stream<char>,
																Args...>};
...
template <typename... Args>
[[deprecated("use ::ufio::wconcat_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
...
{
	constexpr bool type_error{
		::ufio::operations::defines::print_freestanding_okay<::ufio::details::dummy_buffer_output_stream<wchar_t>,
																Args...>};
	if constexpr (type_error)
	{
...
template <typename... Args>
[[deprecated("use ::ufio::u8concat_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u8string
...
{
	constexpr bool type_error{
		::ufio::operations::defines::print_freestanding_okay<::ufio::details::dummy_buffer_output_stream<char8_t>,
																Args...>};
	if constexpr (type_error)
	{
...
template <typename... Args>
[[deprecated("use ::ufio::u16concat_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u16string
	u16concat(Args &&...args)
{
	constexpr bool type_error{::ufio::operations::defines::print_freestanding_okay<
		::ufio::details::dummy_buffer_output_stream<char16_t>, Args...>};
	if constexpr (type_error)
	{
...
template <typename... Args>
[[deprecated("use ::ufio::u32concat_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u32string
...
{
	constexpr bool type_error{::ufio::operations::defines::print_freestanding_okay<
		::ufio::details::dummy_buffer_output_stream<char32_t>, Args...>};
	if constexpr (type_error)
	{
...
template <typename... Args>
[[deprecated("use ::ufio::concatln_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
...
template <typename... Args>
[[deprecated("use ::ufio::wconcatln_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::basic_string<wchar_t>
...
template <typename... Args>
[[deprecated("use ::ufio::u8concatln_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u8string
...
template <typename... Args>
[[deprecated("use ::ufio::u16concatln_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u16string
...
template <typename... Args>
[[deprecated("use ::ufio::u32concatln_std instead"), nodiscard]] inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
	::std::u32string
