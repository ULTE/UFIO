				 ...
				 ::std::basic_string<char_type, traits_type, allocator_type> &str, char_type *p)
{
...
#endif
	{
		...
		str.resize_and_overwrite(
			sz, ::ufio::details::empty_string_set_ptr<
		...
		else if (curr_ptr < p)
		{
			...
			::ufio::details::local_operator_new_array_ptr<char_type> buffer(diff);
...
#endif
	{
		::ufio::details::string_hack::set_end_ptr(str, p);
...
{
	return ::ufio::details::string_hack::local_capacity<
