...
inline constexpr T lc_concat_decay_impl(basic_lc_all<typename T::value_type> const *all, Args... args)
{
	...
	if constexpr (((!(lc_dynamic_reserve_printable<ch_type, Args> || lc_scatter_printable<ch_type, Args> ||
				   ...
				   ...))
	{
		return ::ufio::details::decay::basic_general_concat_phase1_decay_impl<line, ch_type, T>(args...);
	}
						...
						...))
	{
		...
		{
			::std::size_t total_size{::ufio::details::intrinsics::add_or_overflow_die(
...
concept l10ntypes_impl = requires(T &loc) {
	{ loc.loc } -> ::std::same_as<::ufio::lc_locale>;
};
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, T>(
		all, io_print_forward<typename T::value_type>(io_print_alias(args))...);
}
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::basic_string<ch_type>>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ch_type>(
		all, io_print_forward<ch_type>(io_print_alias(args))...);
}

template <::ufio::details::decay::l10ntypes_impl T, typename... Args>
inline
#if __cpp_lib_constexpr_string >= 201907L
	constexpr
#endif
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::string>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ::std::string>(
		loc.loc.all, io_print_forward<char>(io_print_alias(args))...);
}
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::basic_string<wchar_t>>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ::std::basic_string<wchar_t>>(
		loc.loc.wall, io_print_forward<wchar_t>(io_print_alias(args))...);
}
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::u8string>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ::std::u8string>(
		loc.loc.u8all, io_print_forward<char8_t>(io_print_alias(args))...);
}
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::u16string>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ::std::u16string>(
		loc.loc.u16all, io_print_forward<char16_t>(io_print_alias(args))...);
}
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<false, ::std::u32string>(
...
{
	return ::ufio::details::decay::lc_concat_decay_impl<true, ::std::u32string>(
		loc.loc.u32all, io_print_forward<char32_t>(io_print_alias(args))...);
}
