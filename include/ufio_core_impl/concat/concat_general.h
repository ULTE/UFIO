...
inline constexpr T basic_general_concat_decay_impl(Args... args)
{
	...
	{
		T str;
		auto oref{io_strlike_ref(ufio::io_alias, str)};
		::ufio::operations::decay::print_freestanding_decay<line>(oref, args...);
		return str;
	}
}
...
{
	return ::ufio::details::decay::basic_general_concat_phase1_decay_impl<line, char_type, T>(
