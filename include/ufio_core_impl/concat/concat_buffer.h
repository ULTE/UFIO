...
strlike_begin(::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>,
			  ::ufio::details::basic_concat_buffer<char_type> &str) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *
strlike_curr(::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>,
			 ::ufio::details::basic_concat_buffer<char_type> &str) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *
strlike_end(::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>,
			::ufio::details::basic_concat_buffer<char_type> &str) noexcept
{
...
strlike_set_curr(::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>,
				 ::ufio::details::basic_concat_buffer<char_type> &str, char_type *p) noexcept
{
	str.buffer_curr = p;
}
...
#endif
inline constexpr void
basic_concat_buffer_strlike_reserve_cold_impl(::ufio::details::basic_concat_buffer<char_type> &str, ::std::size_t n,
...
template <::std::integral char_type>
inline constexpr void basic_concat_buffer_strlike_reserve_impl(::ufio::details::basic_concat_buffer<char_type> &str,
...
template <::std::integral char_type>
inline constexpr void
strlike_reserve(::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>,
				::ufio::details::basic_concat_buffer<char_type> &str, ::std::size_t n) noexcept
{
...
inline constexpr ::std::size_t strlike_sso_size(
	::ufio::io_strlike_type_t<char_type, ::ufio::details::basic_concat_buffer<char_type>>) noexcept
{
	return ::ufio::details::basic_concat_buffer<char_type>::buffer_size;
}

template <::std::integral char_type>
inline constexpr io_strlike_reference_wrapper<char_type, ::ufio::details::basic_concat_buffer<char_type>>
io_strlike_ref(io_alias_t, ::ufio::details::basic_concat_buffer<char_type> &str) noexcept
{
