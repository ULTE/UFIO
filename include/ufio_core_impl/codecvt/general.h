...
template <encoding_scheme src_scheme = encoding_scheme::execution_charset,
	...
	requires(::ufio::details::codecvt::print_alias_test_codecvt_impl<T>())
...
{
	return ::ufio::manipulators::code_cvt<src_scheme, dst_scheme>(::ufio::manipulators::os_c_str(cstr));
}
...
{
	return ::ufio::manipulators::code_cvt<src_scheme, dst_scheme>(::ufio::mnp::os_c_str(cstr, n));
}
