...
/// @param    ::ufio::io_reserve_type_t<char_type, T>    tag-invoke
...
/// @return   ::ufio::parse_result<char_type const*>     a pointer to the next after scanning,
...
/// @tparam   <auto-inferred>
/// @param    ::ufio::io_reserve_type_t<char_type, T>    tag-invoke
/// @return   ::ufio::io_type_t<your_context_type>       the type of the context object
...
/// @param    your_context_type&                            the context object
/// @param    T                                             the object to be scanned, can be any passing style
/// @return   ::ufio::parse_code                         a parse code indicating parsing state
template <typename char_type, typename T>
...
/// @tparam   <auto-inferred>
/// @param    ::ufio::io_reserve_type_t<char_type, ::std::remove_cvref_t<T>> tag-invoke
...
/// @return     ::ufio::context_print_result<char_type*> a pointer to the next after printing
...
/// @details    Defines the behaviour when printed with ::ufio::mnp::width<::ufio::mnp::scalar_placement::internal>
...
/// @tparam     <auto-inferred>
/// @param      ::ufio::io_reserve_type_t<char_type, ::std::remove_cvref_t<T>> tag-invoke
/// @return     ::ufio::reserve_scatters_size_result     the count of the scatters and the size of an extra buffer
///                                                         which can later be pointed in the scatters.
/// @fn         print_reserve_scatters_define
/// @brief      Prints the object to several scatters.
/// @tparam     <auto-inferred>
/// @param      ::ufio::io_reserve_type_t<char_type, ::std::remove_cvref_t<T>> tag-invoke
/// @param      ::ufio::basic_io_scatter_t<char_type>*   a pointer to the beginning of the scatters
/// @param      char_type*                                  a pointer to the beginning of the buffer
/// @param      T                                           the object to be printed
/// @return     ::ufio::basic_reserve_scatters_define_result<char_type>
...
concept reserve_scatters_printable =
	::std::integral<char_type> && requires(T t, ::ufio::basic_io_scatter_t<char_type> *scatters, char_type *ptr) {
		{
		...
		} -> ::std::same_as<::ufio::basic_reserve_scatters_define_result<char_type>>;
	};
...
/// @return     void
template <typename char_type, typename T>
concept printable = requires(::ufio::details::dummy_buffer_output_stream<char_type> out, T t) {
...
/// @tparam     <auto-inferred>
/// @param      ::ufio::io_alias_t                       tag-invoke
...
template <typename T>
concept alias_printable = requires(T &&t) { print_alias_define(io_alias, ::ufio::freestanding::forward<T>(t)); };
...
concept status_io_print_forwardable = ::std::integral<char_type> && requires(T &&t) {
	status_io_print_forward(io_alias_type<char_type>, ::ufio::freestanding::forward<T>(t));
};
