...
inline constexpr ::std::byte *pread_some_bytes_underflow_define(basic_black_hole<ch_type>, ::std::byte *first,
																::std::byte *, ::ufio::intfpos_t) noexcept
{
	return first;
}
...
inline constexpr void pwrite_all_bytes_overflow_define(basic_black_hole<ch_type>, ::std::byte const *,
													   ::std::byte const *, ::ufio::intfpos_t) noexcept
{
}
...
#if 0
template<::std::integral ch_type>
inline constexpr ::ufio::intfpos_t io_stream_seek_define(basic_black_hole<ch_type> fb, ::ufio::intfpos_t off, ::ufio::seekdir sdir) noexcept {
	return {};
}

template<::std::integral ch_type>
inline constexpr ::ufio::intfpos_t io_stream_seek_bytes_define(basic_black_hole<ch_type> fb, ::ufio::intfpos_t off, ::ufio::seekdir sdir) noexcept {
	return {};
}
#endif
