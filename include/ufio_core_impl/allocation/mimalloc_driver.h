...
public:
	...
	allocate(::std::size_t n) noexcept
	{
		...
		void *p = ::ufio::mimalloc::mi_malloc(n);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	reallocate(void *p, ::std::size_t n) noexcept
	{
		...
		p = ::ufio::mimalloc::mi_realloc(p, n);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	allocate_zero(::std::size_t n) noexcept
	{
		...
		void *p = ::ufio::mimalloc::mi_calloc(1, n);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	allocate_aligned(::std::size_t alignment, ::std::size_t n) noexcept
	{
		...
		void *p = ::ufio::mimalloc::mi_malloc_aligned(n, alignment);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	reallocate_aligned(void *p, ::std::size_t alignment, ::std::size_t n) noexcept
	{
		...
		p = ::ufio::mimalloc::mi_ralloc_aligned(p, n, alignment);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	allocate_zero_aligned(::std::size_t n, ::std::size_t alignment) noexcept
	{
		...
		void *p = ::ufio::mimalloc::mi_calloc_aligned(1, n, alignment);
		if (p == nullptr)
		{
			::ufio::fast_terminate();
		}
	...
	inline static void deallocate_aligned(void *p, ::std::size_t alignment) noexcept
	{
		...
		::ufio::mimalloc::mi_free_aligned(p, alignment);
	}
};
