...
template <typename, bool>
inline constexpr ::ufio::allocation_least_result allocator_pointer_aligned_at_least_impl(::std::size_t, ::std::size_t) noexcept;
...
template <typename alloc, bool>
inline constexpr ::ufio::allocation_least_result status_allocator_pointer_aligned_at_least_impl(typename alloc::handle_type, ::std::size_t, ::std::size_t) noexcept;
...
public:
	...
	static inline constexpr bool has_status{::ufio::details::has_non_empty_handle_type<allocator_type>};
	...
	static inline constexpr ::std::size_t default_alignment{::ufio::details::calculate_default_alignment<allocator_type>()};
	static inline constexpr bool has_native_allocate{
		!has_status && (::ufio::details::has_allocate_at_least_impl<alloc> ||
						::ufio::details::has_allocate_aligned_at_least_impl<alloc> ||
						::ufio::details::has_allocate_zero_at_least_impl<alloc> ||
						::ufio::details::has_allocate_aligned_zero_at_least_impl<alloc> ||
						::ufio::details::has_allocate_impl<alloc> ||
						::ufio::details::has_allocate_aligned_impl<alloc> ||
						::ufio::details::has_allocate_zero_impl<alloc> ||
						::ufio::details::has_allocate_aligned_zero_impl<alloc>)};
	static inline
...
#endif
		{
			if constexpr (::ufio::details::has_allocate_impl<alloc>)
			{
				return allocator_type::allocate(n);
			}
			else if constexpr (::ufio::details::has_allocate_aligned_at_least_impl<alloc>)
			{
				return allocator_type::allocate_at_least(n).ptr;
			}
			else if constexpr (::ufio::details::has_allocate_aligned_impl<alloc>)
			{
				return allocator_type::allocate_aligned(default_alignment, n);
			}
			else if constexpr (::ufio::details::has_allocate_zero_impl<alloc>)
			{
			...
			else if constexpr (::ufio::details::has_allocate_aligned_zero_impl<alloc>)
			{
	...
	static inline void *allocate_zero(::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_allocate_zero_impl<alloc>)
		{
			return allocator_type::allocate_zero(n);
		}
		else if constexpr (::ufio::details::has_allocate_zero_at_least_impl<alloc>)
		{
			return allocator_type::allocate_zero_at_least(n).ptr;
		}
		else if constexpr (::ufio::details::has_allocate_aligned_zero_impl<alloc>)
		...
		else if constexpr (::ufio::details::has_allocate_aligned_zero_at_least_impl<alloc>)
		{
		...
		else
		{
			...
			::ufio::freestanding::bytes_clear_n(reinterpret_cast<::std::byte *>(p), n);
			return p;
		}
	}

	static inline constexpr bool has_reallocate = (::ufio::details::has_reallocate_impl<alloc> ||
												   ::ufio::details::has_reallocate_at_least_impl<alloc> ||
												   ::ufio::details::has_reallocate_aligned_impl<alloc> ||
												   ::ufio::details::has_reallocate_aligned_at_least_impl<alloc> ||
												   ::ufio::details::has_reallocate_zero_impl<alloc> ||
												   ::ufio::details::has_reallocate_zero_at_least_impl<alloc> ||
												   ::ufio::details::has_reallocate_aligned_zero_impl<alloc> ||
												   ::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>);
	static inline void *reallocate(void *p, ::std::size_t n) noexcept
		requires(!has_status && has_reallocate)
	{
		if constexpr (::ufio::details::has_reallocate_impl<alloc>)
		{
			return allocator_type::reallocate(p, n);
		}
		else if constexpr (::ufio::details::has_reallocate_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_at_least(p, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_impl<alloc>)
		{
			return allocator_type::reallocate_aligned(p, default_alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_at_least(p, default_alignment, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_zero_impl<alloc>)
		{
			return allocator_type::reallocate_zero(p, n);
		}
		else if constexpr (::ufio::details::has_reallocate_zero_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_zero_at_least(p, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero(p, default_alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_at_least(p, default_alignment, n).ptr;
		}
	}
	static inline constexpr bool has_reallocate_zero = (::ufio::details::has_reallocate_zero_impl<alloc> ||
														::ufio::details::has_reallocate_zero_at_least_impl<alloc> ||
														::ufio::details::has_reallocate_aligned_zero_impl<alloc> ||
														::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>);
	...
	{
		if constexpr (::ufio::details::has_reallocate_zero_impl<alloc>)
		{
			return allocator_type::reallocate_zero(p, n);
		}
		else if constexpr (::ufio::details::has_reallocate_zero_at_least_impl<alloc>)
	...
	static inline void *reallocate_n(void *p, ::std::size_t oldn, ::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_n_impl<alloc>)
		{
			return allocator_type::reallocate_n(p, oldn, n);
		}
		else if constexpr (::ufio::details::has_reallocate_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_n_at_least(p, oldn, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_n_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_n(p, oldn, default_alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_n_at_least(p, oldn, default_alignment, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_zero_n_impl<alloc>)
		{
			return allocator_type::reallocate_zero_n(p, oldn, n);
		}
		else if constexpr (::ufio::details::has_reallocate_zero_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_zero_n_at_least(p, oldn, default_alignment, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_n_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_n(p, oldn, default_alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_n_at_least(p, oldn, default_alignment, n).ptr;
		}
		else if constexpr (::ufio::details::has_reallocate_impl<alloc>)
		{
			return allocator_type::reallocate(p, n);
		}
		else if constexpr (::ufio::details::has_reallocate_at_least_impl<alloc>)
		...
		else
		{
			...
			if (p != nullptr && n)
			{
				...
				::ufio::freestanding::nonoverlapped_bytes_copy_n(reinterpret_cast<::std::byte const *>(p), n, reinterpret_cast<::std::byte *>(newptr));
	...
	static inline void *reallocate_zero_n(void *p, ::std::size_t oldn, ::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_zero_n_impl<alloc>)
		{
			return allocator_type::reallocate_zero_n(p, oldn, n);
		}
		else if constexpr (::ufio::details::has_reallocate_zero_n_at_least_impl<alloc>)
		...
		else
		{
			...
			if (oldn < n)
			{
				...
				::ufio::freestanding::bytes_clear_n(reinterpret_cast<::std::byte *>(newptr) + oldn, to_zero_bytes);
			}
			return newptr;
		}
	}

	static inline constexpr bool has_deallocate = (::ufio::details::has_deallocate_impl<alloc> ||
												   ::ufio::details::has_deallocate_aligned_impl<alloc>);
...
#endif
		{
			if constexpr (::ufio::details::has_deallocate_impl<alloc>)
			{
				allocator_type::deallocate(p);
			}
			else if constexpr (::ufio::details::has_deallocate_aligned_impl<alloc>)
			{
...
#endif
		{
			if constexpr (::ufio::details::has_deallocate_n_impl<alloc>)
			{
				allocator_type::deallocate_n(p, n);
			}
			else if constexpr (::ufio::details::has_deallocate_aligned_n_impl<alloc>)
			{
				allocator_type::deallocate_aligned_n(p, default_alignment, n);
			}
			else if constexpr (::ufio::details::has_deallocate_impl<alloc>)
			{
				allocator_type::deallocate(p);
			}
			else if constexpr (::ufio::details::has_deallocate_aligned_impl<alloc>)
...
#endif
		{
			return ::ufio::details::allocator_pointer_aligned_impl<alloc, false>(alignment, n);
		}
	}
	static inline
...
#endif
		{
			return ::ufio::details::allocator_pointer_aligned_impl<alloc, true>(alignment, n);
		}
	}
...
#endif
		{
			if constexpr (::ufio::details::has_allocate_at_least_impl<alloc>)
			{
...
#endif
		{
			if constexpr (::ufio::details::has_allocate_zero_at_least_impl<alloc>)
			{
				return allocator_type::allocate_zero_at_least(n);
			}
			else if constexpr (::ufio::details::has_allocate_aligned_zero_at_least_impl<alloc>)
			...
			else if constexpr (::ufio::details::has_allocate_at_least_impl<alloc> ||
							   ::ufio::details::has_allocate_aligned_at_least_impl<alloc>)
			{
				auto temp{generic_allocator_adapter::allocate_at_least(n)};
				auto ptr{temp.ptr};
				auto sz{temp.count};
				::ufio::freestanding::bytes_clear_n(reinterpret_cast<::std::byte *>(ptr), sz);
				return temp;
			}
			else
			{
...
#endif
		{
			if constexpr (::ufio::details::has_allocate_aligned_at_least_impl<alloc>)
			{
			...
			else if constexpr (::ufio::details::has_allocate_aligned_zero_at_least_impl<alloc>)
			{
				return allocator_type::allocate_aligned_zero_at_least(alignment, n);
							   ...
							   ::ufio::details::has_allocate_zero_at_least_impl<alloc>)
			{
				return ::ufio::details::allocator_pointer_aligned_at_least_impl<alloc, false>(alignment, n);
			}
			else
			{
...
#endif
		{
			if constexpr (::ufio::details::has_allocate_aligned_zero_at_least_impl<alloc>)
			{
				return allocator_type::allocate_aligned_zero_at_least(alignment, n);
			}
			else if constexpr (::ufio::details::has_allocate_aligned_at_least_impl<alloc>)
			{
				...
				::ufio::freestanding::bytes_clear_n(reinterpret_cast<::std::byte *>(temp.ptr), temp.count);
				return temp;
			}
			else if constexpr (::ufio::details::has_allocate_at_least_impl<alloc> ||
							   ::ufio::details::has_allocate_zero_at_least_impl<alloc>)
			{
				return ::ufio::details::allocator_pointer_aligned_at_least_impl<alloc, true>(alignment, n);
			}
			else
			{
				return {generic_allocator_adapter::allocate_aligned(alignment, n), n};
	...
	static inline constexpr bool has_reallocate_aligned = (::ufio::details::has_reallocate_aligned_impl<alloc> ||
														   ::ufio::details::has_reallocate_aligned_at_least_impl<alloc> ||
														   ::ufio::details::has_reallocate_aligned_zero_impl<alloc> ||
														   ::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>);
	static inline
	...
	{
		if constexpr (::ufio::details::has_reallocate_aligned_impl<alloc>)
		{
	...
	static inline constexpr bool has_reallocate_aligned_zero = (::ufio::details::has_reallocate_aligned_zero_impl<alloc> ||
																::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>);
	static inline
	...
	{
		if constexpr (::ufio::details::has_reallocate_aligned_zero_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero(p, alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>)
	...
	static inline
		...
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_n_impl<alloc>)
		{
		...
		{
			if constexpr (::ufio::details::has_reallocate_n_impl<alloc> ||
						  ::ufio::details::has_reallocate_zero_n_impl<alloc> ||
						  ::ufio::details::has_reallocate_impl<alloc> ||
						  ::ufio::details::has_reallocate_zero_impl<alloc>)
			{
			...
			auto newptr{::ufio::details::allocator_pointer_aligned_impl<alloc, false>(alignment, n)};
			if (p != nullptr && n)
			{
				if (oldn < n)
				{
	...
	static inline
		...
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_zero_n_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_n(p, oldn, alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_n_at_least_impl<alloc>)
	...
	static inline
		...
		::ufio::allocation_least_result
		reallocate_at_least(void *p, ::std::size_t n) noexcept
		requires(!has_status && has_reallocate)
	{
		if constexpr (::ufio::details::has_reallocate_at_least_impl<alloc>)
		{
	...
	static inline
		...
		requires(!has_status && has_reallocate)
	{
		if constexpr (::ufio::details::has_reallocate_zero_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_zero_at_least(p, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>)
	...
	static inline
		...
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_n_at_least_impl<alloc>)
		{
		...
		else if constexpr (::ufio::details::has_reallocate_n_impl<alloc>)
		{
	...
	static inline
		...
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_zero_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_zero_n_at_least(p, oldn, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_n_at_least_impl<alloc>)
	...
	static inline ::ufio::allocation_least_result
	reallocate_aligned_at_least(void *p, ::std::size_t alignment, ::std::size_t n) noexcept
		requires(!has_status && has_reallocate_aligned_zero)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_at_least_impl<alloc>)
		{
	...
	reallocate_aligned_zero_at_least(void *p, ::std::size_t alignment, ::std::size_t n) noexcept
		requires(!has_status && has_reallocate_aligned_zero)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_at_least(p, alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_impl<alloc>)
	...
	static inline constexpr bool has_native_reallocate_aligned_n_at_least = (has_reallocate_aligned &&
																			 (::ufio::details::has_reallocate_aligned_n_at_least_impl<alloc> ||
																			  ::ufio::details::has_reallocate_aligned_zero_n_at_least_impl<alloc>));
	static inline ::ufio::allocation_least_result
	reallocate_aligned_n_at_least(void *p, ::std::size_t oldn, ::std::size_t alignment, ::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_n_at_least_impl<alloc>)
		{
		...
		else
		{
			if constexpr (
				::ufio::details::has_reallocate_at_least_impl<alloc> ||
				::ufio::details::has_reallocate_zero_at_least_impl<alloc> ||
				::ufio::details::has_reallocate_n_at_least_impl<alloc> ||
				::ufio::details::has_reallocate_zero_n_at_least_impl<alloc>)
			{
				if (alignment <= default_alignment)
				{
			...
			auto newres{::ufio::details::allocator_pointer_aligned_at_least_impl<alloc, false>(alignment, n)};
			auto newptr{newres.ptr};
			if (p != nullptr && n)
			{
				if (oldn < n)
	...
	static inline constexpr bool has_native_reallocate_aligned_zero_n_at_least = (has_reallocate_aligned_zero && ::ufio::details::has_reallocate_aligned_zero_at_least_impl<alloc>);

	static inline ::ufio::allocation_least_result reallocate_aligned_zero_n_at_least(void *p, ::std::size_t oldn, ::std::size_t alignment, ::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_reallocate_aligned_zero_n_at_least_impl<alloc>)
		{
			return allocator_type::reallocate_aligned_zero_n_at_least(p, alignment, n);
		}
		else if constexpr (::ufio::details::has_reallocate_aligned_zero_n_impl<alloc>)
	...
	static inline constexpr bool has_deallocate_aligned = (::ufio::details::has_deallocate_aligned_impl<alloc> ||
														   ::ufio::details::has_deallocate_impl<alloc>);
	static inline void deallocate_aligned(void *p, ::std::size_t alignment) noexcept
		requires(!has_status && has_deallocate_aligned)
	{
		if constexpr (::ufio::details::has_deallocate_aligned_impl<alloc>)
		{
	...
	static inline void deallocate_aligned_n(void *p, ::std::size_t alignment, ::std::size_t n) noexcept
		requires(!has_status)
	{
		if constexpr (::ufio::details::has_deallocate_aligned_n_impl<alloc>)
		{
...
public:
...
#endif
		{
			return ::ufio::freestanding::allocator<T>{}.allocate(n);
		}
#endif
...
#endif
		{
			return {::ufio::freestanding::allocator<T>{}.allocate(n), n};
		}
#endif
		constexpr ::std::size_t mxn{::std::numeric_limits<::std::size_t>::max() / sizeof(T)};
		if (n > mxn)
	...
	__cpp_constexpr_dynamic_alloc >= 201907L
...
#endif
		{
			if (ptr)
			{
				return ::ufio::freestanding::allocator<T>{}.deallocate(ptr, 1);
			}
			else
			{
				return;
	...
	__cpp_constexpr_dynamic_alloc >= 201907L
...
#endif
		{
			if (ptr)
			{
				return ::ufio::freestanding::allocator<T>{}.deallocate(ptr, n);
			}
			else
			{
				return;
...
{
	if constexpr (!::ufio::generic_allocator_adapter<alloc>::has_native_allocate)
	{
		::ufio::fast_terminate();
	}
	else
	{
		constexpr ::std::size_t defaultalignment{::ufio::details::calculate_default_alignment<alloc>()};
		bool const alignedadjustment{defaultalignment < alignment};
		if (alignedadjustment)
		{
			n = ::ufio::details::allocator_compute_aligned_total_size_impl(alignment, n);
		}
		void *p;
		if constexpr (zero)
		{
			p = ::ufio::generic_allocator_adapter<alloc>::allocate_zero(n);
		}
		else
		{
			p = ::ufio::generic_allocator_adapter<alloc>::allocate(n);
		}
		if (alignedadjustment)
		{
			p = ::ufio::details::allocator_adjust_ptr_to_aligned_impl(p, alignment);
		}
		return p;
	}
}
...
template <typename alloc, bool zero>
inline constexpr ::ufio::allocation_least_result allocator_pointer_aligned_at_least_impl(::std::size_t alignment, ::std::size_t n) noexcept
{
	if constexpr (!::ufio::generic_allocator_adapter<alloc>::has_native_allocate)
	{
		::ufio::fast_terminate();
	...
	else
	{
		...
		::ufio::allocation_least_result res;
		if constexpr (zero)
		{
			res = ::ufio::generic_allocator_adapter<alloc>::allocate_zero_at_least(n);
		}
		else
		{
			res = ::ufio::generic_allocator_adapter<alloc>::allocate_at_least(n);
		}
		if (alignedadjustment)
		{
			auto resptr{res.ptr};
			auto aligned_ptr = ::ufio::details::allocator_adjust_ptr_to_aligned_impl(resptr, alignment);
...
{
	if constexpr (!::ufio::generic_allocator_adapter<alloc>::has_native_handle_allocate)
	{
		::ufio::fast_terminate();
	}
	else
	{
		...
		if constexpr (zero)
		{
			p = ::ufio::generic_allocator_adapter<alloc>::handle_allocate_zero(handle, n);
		}
		else
		{
			p = ::ufio::generic_allocator_adapter<alloc>::handle_allocate(handle, n);
		}
		if (alignedadjustment)
		{
			p = ::ufio::details::allocator_adjust_ptr_to_aligned_impl(p,alignment);
...
template <typename alloc, bool zero>
inline constexpr ::ufio::allocation_least_result status_allocator_pointer_aligned_impl(typename alloc::handle_type handle, ::std::size_t alignment, ::std::size_t n) noexcept
{
	if constexpr (!::ufio::generic_allocator_adapter<alloc>::has_native_handle_allocate)
	{
		::ufio::fast_terminate();
	...
	else
	{
		...
		if constexpr (zero)
		{
			res = ::ufio::generic_allocator_adapter<alloc>::handle_allocate_zero_at_least(handle, n);
		}
		else
		{
			res = ::ufio::generic_allocator_adapter<alloc>::handle_allocate_at_least(handle, n);
		}
		if (alignedadjustment)
		{
			auto resptr{res.ptr};
