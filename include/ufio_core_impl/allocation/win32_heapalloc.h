...
inline void *win32_heapalloc_handle_common_impl(void *heaphandle, ::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	...
	auto p{::ufio::win32::HeapAlloc(heaphandle, flag, n)};
	if (p == nullptr)
	{
		::ufio::fast_terminate();
	}
...
inline void *win32_heaprealloc_handle_common_impl(void *heaphandle, void *addr, ::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	...
	auto p{::ufio::win32::HeapReAlloc(heaphandle, flag, addr, n)};
	if (p == nullptr)
	{
		::ufio::fast_terminate();
	}
...
inline void *win32_get_process_heap() noexcept
{
	...
	{
		return ::ufio::win32::nt::rtl_get_process_heap();
	}
	else
	{
		return ::ufio::win32::GetProcessHeap();
	}
}
...
{
	return ::ufio::details::win32_heapalloc_handle_common_impl(::ufio::details::win32_get_process_heap(), n, flag);
}
...
{
	return ::ufio::details::win32_heaprealloc_handle_common_impl(::ufio::details::win32_get_process_heap(), addr, n, flag);
}

inline ::ufio::allocation_least_result win32_heapalloc_least_common_impl(::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	auto processheap{::ufio::details::win32_get_process_heap()};
	auto ptr{::ufio::details::win32_heapalloc_handle_common_impl(processheap, n, flag)};
	return {ptr, ::ufio::win32::HeapSize(processheap, 0, ptr)};
}

inline ::ufio::allocation_least_result win32_heaprealloc_least_common_impl(void *addr, ::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	auto processheap{::ufio::details::win32_get_process_heap()};
	auto ptr{::ufio::details::win32_heaprealloc_handle_common_impl(processheap, addr, n, flag)};
	return {ptr, ::ufio::win32::HeapSize(processheap, 0, ptr)};
}
...
public:
	...
	{
		return ::ufio::details::win32_heapalloc_common_impl(n, 0u);
	}
	...
	{
		return ::ufio::details::win32_heapalloc_common_impl(n, 0x00000008u);
	}
	static inline void *reallocate(void *addr, ::std::size_t n) noexcept
	{
		return ::ufio::details::win32_heaprealloc_common_impl(addr, n, 0u);
	}
	static inline void *reallocate_zero(void *addr, ::std::size_t n) noexcept
	{
		return ::ufio::details::win32_heaprealloc_common_impl(addr, n, 0x00000008u);
	}
