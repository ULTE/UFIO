...
template <bool throweh = true, ::ufio::input_stream input>
...
template<::ufio::input_stream input,::std::forward_iterator Iter>
inline constexpr void read_all_impl_none_contiguous(input in,Iter first,Iter last)
{
	...
	if constexpr(::ufio::buffer_input_stream<input>)
	{
...
#endif
template <::ufio::input_stream input>
...
template <::ufio::input_stream input, ::std::input_or_output_iterator Iter>
...
{
	::ufio::details::read_all_impl(io_ref(in), first, last);
}

template <typename input, ::std::ranges::forward_range rg>
inline constexpr void read_all(input &&in, rg &&r)
{
	::ufio::details::read_all_impl(io_ref(in), ::std::ranges::begin(r), ::std::ranges::end(r));
}
