...
vector_mask_countr_common_no_intrinsics_impl(::ufio::intrinsics::simd_vector<T, n> const &vec) noexcept
{
	constexpr ::std::size_t N{sizeof(::ufio::intrinsics::simd_vector<T, n>) / sizeof(::std::uint_least64_t)};
	unsigned d{vector_mask_countr_recursive_impl<ctzero, 0>(
		static_cast<::ufio::intrinsics::simd_vector<::std::uint_least64_t, N>>(vec))};
...
inline constexpr bool calculate_can_intrinsics_accelerate_mask_countr(::std::size_t sizeofsimdvector) noexcept
{
	if ((sizeofsimdvector == 16 &&
		 (::ufio::details::cpu_flags::sse2_supported || ::ufio::details::cpu_flags::wasmsimd128_supported)) ||
		(sizeofsimdvector == 32 && (::ufio::details::cpu_flags::avx2_supported)))
	{
		return ::ufio::details::calculate_can_simd_vector_run_with_cpu_instruction(sizeofsimdvector);
	}
	return false;
}
...
#endif
	unsigned
	vector_mask_countr_common_intrinsics_impl(::ufio::intrinsics::simd_vector<T, n> const &vec) noexcept
{
#if __cpp_if_consteval >= 202106L || __cpp_lib_is_constant_evaluated >= 201811L
...
#endif
	unsigned d{};
	if constexpr (sizeof(::ufio::intrinsics::simd_vector<T, n>) == 16)
	{
		...
		if constexpr (::ufio::details::cpu_flags::sse2_supported)
		{
	...
	else if constexpr (sizeof(::ufio::intrinsics::simd_vector<T, n>) == 32)
	{
#if defined(__has_builtin) && __has_cpp_attribute(__gnu__::__vector_size__)
...
template <bool ctzero, ::std::integral T, ::std::size_t n>
inline constexpr unsigned vector_mask_countr_common_impl(::ufio::intrinsics::simd_vector<T, n> const &vec) noexcept
{
...
template <::std::size_t sizeofsimdvector>
inline constexpr bool can_intrinsics_accelerate_mask_countr{
	::ufio::details::can_intrinsics_accelerate_mask_countr<sizeofsimdvector>};

inline constexpr ::std::size_t optimal_simd_vector_run_with_cpu_instruction_size_with_mask_countr{
	::ufio::intrinsics::can_intrinsics_accelerate_mask_countr<64>
		? 64
		: (::ufio::intrinsics::can_intrinsics_accelerate_mask_countr<32>
			   ? 32
			   : (::ufio::intrinsics::can_intrinsics_accelerate_mask_countr<16> ? 16 : 0))};

template <typename T, ::std::size_t n>
inline constexpr auto vector_mask_countr_one(simd_vector<T, n> const &vec) noexcept
{
	return ::ufio::details::vector_mask_countr_common_impl<false>(vec);
}

template <typename T, ::std::size_t n>
inline constexpr auto vector_mask_countr_zero(simd_vector<T, n> const &vec) noexcept
{
	return ::ufio::details::vector_mask_countr_common_impl<true>(vec);
}
