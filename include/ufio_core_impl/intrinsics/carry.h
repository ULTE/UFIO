...
inline constexpr T addc(T a, T b, bool carryin, bool &carryout) noexcept
{
...
#endif
	{
		...
		{
			char unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_addcarry_u8(
		...
		{
			short unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_addcarry_u16(
				static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
			return res;
		}
		...
		{
			unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_addcarry_u32(
				static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
			return res;
		}
		else if constexpr (sizeof(T) == 8)
		{
			if constexpr (sizeof(::std::uint_least64_t) <= sizeof(::std::size_t))
			{
				...
				carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_addcarry_u64(
					static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
				return res;
			}
			else
			{
				...
				bool carrytemp{static_cast<bool>(::ufio::intrinsics::msvc::x86::_addcarry_u32(
					static_cast<char unsigned>(carryin), alow, blow, __builtin_addressof(reslow)))};
				carryout = ::ufio::intrinsics::msvc::x86::_addcarry_u32(carrytemp, ahigh, bhigh,
...
inline constexpr T subc(T a, T b, bool carryin, bool &carryout) noexcept
{
...
#endif
	{
		...
		{
			char unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u8(
				static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
			return res;
		}
		else if constexpr (sizeof(T) == 2)
		{
			short unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u16(
				static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
			return res;
		}
		else if constexpr (sizeof(T) == 4)
		{
			unsigned res;
			carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u32(
				static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
			return res;
		}
		else if constexpr (sizeof(T) == 8)
		{
			...
			{
				long long unsigned res;
				carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u64(
					static_cast<char unsigned>(carryin), a, b, __builtin_addressof(res)));
				return res;
			}
			else
			{
				...
				unsigned bhigh = static_cast<unsigned>(b >> 32u);
				unsigned reslow, reshigh;
				bool carrytemp{static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u32(
					static_cast<char unsigned>(carryin), alow, blow, __builtin_addressof(reslow)))};
				carryout = static_cast<bool>(::ufio::intrinsics::msvc::x86::_subborrow_u32(
