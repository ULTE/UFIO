...
inline constexpr ::ufio::bitops::rtz_result<T> rtz_impl(T n) noexcept
{
	if constexpr (::std::numeric_limits<T>::digits == 64)
	{
		if constexpr (!::std::same_as<T, ::std::uint_least64_t>)
		{
			...
			return __builtin_bit_cast(::ufio::bitops::rtz_result<T>,
									  ::ufio::bitops::details::rtz_impl<iec559>(static_cast<::std::uint_least64_t>(n)));
#else
			auto [v, s] = ::ufio::bitops::details::rtz_impl<iec559>(static_cast<::std::uint_least64_t>(n));
			return {v, s};
#endif
		}
		else
...
#ifdef __cpp_lib_bit_cast
			return __builtin_bit_cast(::ufio::bitops::rtz_result<T>,
									  ::ufio::bitops::details::rtz_impl<iec559>(static_cast<::std::uint_least32_t>(n)));
#else
			auto [v, s] = ::ufio::bitops::details::rtz_impl<iec559>(static_cast<::std::uint_least32_t>(n));
			return {v, s};
#endif
		}
		else
	...
	else if constexpr (::std::numeric_limits<T>::digits == 16)
	{
		if constexpr (!::std::same_as<T, ::std::uint_least16_t>)
		{
			...
			return __builtin_bit_cast(::ufio::bitops::rtz_result<T>,
									  ::ufio::bitops::details::rtz_impl<iec559>(static_cast<::std::uint_least32_t>(n)));
#else
			auto [v, s] = ::ufio::bitops::details::rtz_impl<false>(static_cast<::std::uint_least32_t>(n));
			return {v, s};
#endif
		}
		else
	...
	{
		auto [v, s] = ::ufio::bitops::details::rtz_impl<true>(static_cast<::std::uint_least32_t>(n));
...
template <typename T>
inline constexpr ::ufio::bitops::rtz_result<T> rtz_iec559(T n) noexcept
{
	return ::ufio::bitops::details::rtz_impl<true>(n);
}

template <typename T>
inline constexpr ::ufio::bitops::rtz_result<T> rtz(T n) noexcept
{
	return ::ufio::bitops::details::rtz_impl<false>(n);
}
