...
template <typename T>
	requires(::ufio::operations::decay::defines::has_output_or_io_stream_mutex_ref_define<T>)
...
{
	if constexpr (::ufio::operations::decay::defines::has_output_stream_mutex_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::decay::defines::has_input_or_io_stream_mutex_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
{
	if constexpr (::ufio::operations::decay::defines::has_input_stream_mutex_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::decay::defines::has_output_or_io_stream_unlocked_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
{
	if constexpr (::ufio::operations::decay::defines::has_output_stream_unlocked_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::decay::defines::has_input_or_io_stream_unlocked_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
{
	if constexpr (::ufio::operations::decay::defines::has_input_stream_unlocked_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::decay::defines::has_io_stream_unlocked_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
