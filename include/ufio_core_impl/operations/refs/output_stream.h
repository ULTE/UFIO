...
concept has_scatter_write_some_bytes_overflow_define =
	requires(T instm, ::ufio::io_scatter_t const *scatter, ::std::size_t len) {
...
concept has_scatter_write_some_overflow_define =
	requires(T instm, ::ufio::basic_io_scatter_t<typename decltype(instm)::output_char_type> const *pscatter,
...
concept has_scatter_pwrite_some_overflow_define =
	requires(T instm, ::ufio::basic_io_scatter_t<typename decltype(instm)::output_char_type> const *scatter,
...
concept has_any_of_write_bytes_operations =
	::ufio::operations::decay::defines::has_write_some_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_write_all_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_write_some_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_write_all_bytes_overflow_define<stmtype>;

template <typename stmtype>
concept has_any_of_write_operations =
	::ufio::operations::decay::defines::has_write_some_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_write_all_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_write_some_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_write_all_overflow_define<stmtype>;

template <typename stmtype>
concept has_any_of_pwrite_bytes_operations =
	::ufio::operations::decay::defines::has_pwrite_some_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_pwrite_all_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_pwrite_some_bytes_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_pwrite_all_bytes_overflow_define<stmtype>;

template <typename stmtype>
concept has_any_of_pwrite_operations =
	::ufio::operations::decay::defines::has_pwrite_some_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_pwrite_all_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_pwrite_some_overflow_define<stmtype> ||
	::ufio::operations::decay::defines::has_scatter_pwrite_all_overflow_define<stmtype>;

template <typename stmtype>
concept has_any_of_write_or_seek_pwrite_bytes_operations =
	::ufio::operations::decay::defines::has_any_of_write_bytes_operations<stmtype> ||
	(::ufio::operations::decay::defines::has_output_stream_seek_bytes_define<stmtype> &&
	 ::ufio::operations::decay::defines::has_any_of_pwrite_bytes_operations<stmtype>);
...
concept has_any_of_write_or_seek_pwrite_operations =
	::ufio::operations::decay::defines::has_any_of_write_operations<stmtype> ||
	(::ufio::operations::decay::defines::has_output_stream_seek_define<stmtype> &&
	 ::ufio::operations::decay::defines::has_any_of_pwrite_operations<stmtype>);
...
concept has_obuffer_minimum_size_operations = requires(T outstm) {
	{
		obuffer_minimum_size_define(::ufio::io_reserve_type<typename T::output_char_type, T>)
