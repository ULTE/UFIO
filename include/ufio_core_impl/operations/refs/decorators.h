...
template <typename T>
	requires ::ufio::operations::defines::has_input_or_io_decorators_ref_define<T>
inline constexpr decltype(auto) input_decorators_ref(T &&t)
{
	if constexpr (::ufio::operations::defines::has_input_decorators_ref_define<T>)
	{
...
template <typename T>
	requires ::ufio::operations::defines::has_output_or_io_decorators_ref_define<T>
inline constexpr decltype(auto) output_decorators_ref(T &&t)
{
	if constexpr (::ufio::operations::defines::has_output_decorators_ref_define<T>)
	{
...
template <typename T>
	requires ::ufio::operations::defines::has_io_decorators_ref_define<T>
