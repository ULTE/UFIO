					  ...
					  typename outstmtype::output_char_type const *last, ::ufio::intfpos_t off)
{
	...
	if constexpr (::ufio::operations::decay::defines::has_pwrite_some_overflow_define<outstmtype>)
	{
	...
	else if constexpr (::ufio::operations::decay::defines::has_scatter_pwrite_all_overflow_define<outstmtype>)
	{
		...
		return ::ufio::scatter_status_one_size(
			   ...
			   first;
					   ...
					   ::ufio::operations::decay::defines::has_scatter_pwrite_some_bytes_overflow_define<outstmtype>)
	{
						...
						::ufio::operations::decay::defines::has_scatter_write_some_overflow_define<outstmtype>))
	{
		...
		auto ret{::ufio::details::write_some_impl(outsm, first, last)};
...
{
	using char_type = typename outstmtype::output_char_type;
	if constexpr (::ufio::operations::decay::defines::has_pwrite_some_bytes_overflow_define<outstmtype>)
	{
	...
	else if constexpr (::ufio::operations::decay::defines::has_scatter_pwrite_all_bytes_overflow_define<outstmtype>)
	{
							...
							outstmtype>))
	{
		auto oldoff{::ufio::operations::decay::output_stream_seek_bytes_decay(outsm, 0, ::ufio::seekdir::cur)};
		::ufio::operations::decay::output_stream_seek_bytes_decay(outsm, off, ::ufio::seekdir::beg);
		auto ret{::ufio::details::write_some_bytes_impl(outsm, first, last)};
		::ufio::operations::decay::output_stream_seek_bytes_decay(outsm, oldoff, ::ufio::seekdir::beg);
		return ret;
	}
	else if constexpr (sizeof(char_type) == 1 &&
...
{
	using char_type = typename outstmtype::output_char_type;
	if constexpr (::ufio::operations::decay::defines::has_pwrite_all_overflow_define<outstmtype>)
	{
		pwrite_all_overflow_define(outsm, first, last, off);
	}
	else if constexpr (::ufio::operations::decay::defines::has_scatter_pwrite_all_overflow_define<outstmtype>)
												 ...
												 ::ufio::intfpos_t off)
{
						...
						::ufio::operations::decay::defines::has_scatter_pwrite_all_overflow_define<outstmtype>))
	{
		...
		::ufio::details::pwrite_all_cold_impl(outsm, firstcptr, lastcptr, off);
	}
	else if constexpr (::ufio::operations::decay::defines::has_output_or_io_stream_seek_bytes_define<outstmtype> &&
					   (::ufio::operations::decay::defines::has_write_all_bytes_overflow_define<outstmtype> ||
						::ufio::operations::decay::defines::has_scatter_write_all_bytes_overflow_define<
				 ...
				 typename outstmtype::output_char_type const *last, ::ufio::intfpos_t off)
{
	if constexpr (::ufio::operations::decay::defines::has_output_or_io_stream_mutex_ref_define<outstmtype>)
	{
		...
		return ::ufio::details::pwrite_some_impl(
			::ufio::operations::decay::output_stream_unlocked_ref_decay(outsm), first, last, off);
	}
	else
	{
		...
		return ::ufio::details::pwrite_some_cold_impl(outsm, first, last, off);
	}
}
									  ...
									  typename outstmtype::output_char_type const *last, ::ufio::intfpos_t off)
{
	if constexpr (::ufio::operations::decay::defines::has_output_or_io_stream_mutex_ref_define<outstmtype>)
	{
		::ufio::operations::decay::stream_ref_decay_lock_guard lg{
			::ufio::operations::decay::output_stream_mutex_ref_decay(outsm)};
		return ::ufio::details::pwrite_all_impl(
			::ufio::operations::decay::output_stream_unlocked_ref_decay(outsm), first, last, off);
	}
	else
	{
		...
		::ufio::details::pwrite_all_cold_impl(outsm, first, last, off);
	}
}
														   ...
														   ::std::byte const *last, ::ufio::intfpos_t off)
{
	if constexpr (::ufio::operations::decay::defines::has_output_or_io_stream_mutex_ref_define<outstmtype>)
	{
		::ufio::operations::decay::stream_ref_decay_lock_guard lg{
			::ufio::operations::decay::output_stream_mutex_ref_decay(outsm)};
		return ::ufio::details::pwrite_some_bytes_impl(
			::ufio::operations::decay::output_stream_unlocked_ref_decay(outsm), first, last, off);
	}
	else
	{
		...
		return ::ufio::details::pwrite_some_bytes_cold_impl(outsm, first, last, off);
	}
}
											...
											::ufio::intfpos_t off)
{
	if constexpr (::ufio::operations::decay::defines::has_output_or_io_stream_mutex_ref_define<outstmtype>)
	{
		::ufio::operations::decay::stream_ref_decay_lock_guard lg{
			::ufio::operations::decay::output_stream_mutex_ref_decay(outsm)};
		return ::ufio::details::pwrite_all_bytes_impl(
			::ufio::operations::decay::output_stream_unlocked_ref_decay(outsm), first, last, off);
	}
	else
	{
		...
		::ufio::details::pwrite_all_bytes_cold_impl(outsm, first, last, off);
	}
}
