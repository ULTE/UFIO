...
} || (::std::same_as<::std::remove_cvref_t<P>, ::ufio::decorators::no_op_decorators>);
...
template <typename T, typename P>
	requires(::ufio::operations::decay::defines::has_output_stream_add_deco_filter_define<T, P>)
inline constexpr void output_stream_add_deco_filter_decay(T t, P p)
{
	if constexpr (!::std::same_as<::std::remove_cvref_t<P>, ::ufio::decorators::no_op_decorators>)
	{
		if constexpr (::ufio::operations::decay::defines::has_output_stream_add_deco_filter_define<T, P>)
		{
			output_stream_add_deco_filter_define(t, p);
		}
		else
...
template <typename T, typename P>
	requires(::ufio::operations::decay::defines::has_input_stream_add_deco_filter_define<T, P>)
inline constexpr void input_stream_add_deco_filter_decay(T t, P p)
{
	if constexpr (!::std::same_as<::std::remove_cvref_t<P>, ::ufio::decorators::no_op_decorators>)
	{
		if constexpr (::ufio::operations::decay::defines::has_input_stream_add_deco_filter_define<T, P>)
		{
			input_stream_add_deco_filter_define(t, p);
		}
		else
...
template <typename T, typename P>
	requires(::ufio::operations::decay::defines::has_io_stream_add_deco_filter_define<T, P>)
...
template <typename T, typename... Args>
	requires(::ufio::operations::decay::defines::has_output_stream_add_deco_filter_define<T, Args> && ...)
...
template <typename T, typename... Args>
	requires(::ufio::operations::decay::defines::has_input_stream_add_deco_filter_define<T, Args> && ...)
...
template <typename T, typename... Args>
	requires(::ufio::operations::decay::defines::has_io_stream_add_deco_filter_define<T, Args> && ...)
...
template <typename T>
	requires(::ufio::operations::defines::has_input_or_io_stream_deco_filter_ref_define<T>)
...
{
	if constexpr (::ufio::operations::defines::has_input_or_io_stream_deco_filter_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::defines::has_output_or_io_stream_deco_filter_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
{
	if constexpr (::ufio::operations::defines::has_output_or_io_stream_deco_filter_ref_define<T>)
	{
...
template <typename T>
	requires(::ufio::operations::defines::has_io_stream_deco_filter_ref_define<T>)
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
{
	::ufio::operations::decay::add_output_decos_decay(::ufio::operations::output_stream_deco_filter_ref(t),
														 args...);
}
...
{
	::ufio::operations::decay::add_input_decos_decay(::ufio::operations::input_stream_deco_filter_ref(t),
														args...);
}
...
{
	::ufio::operations::decay::add_io_decos_decay(::ufio::operations::io_stream_deco_filter_ref(t), args...);
}
