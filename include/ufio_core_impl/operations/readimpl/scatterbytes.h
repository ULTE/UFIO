																	   ...
																	   ::std::size_t n)
{
	...
	if constexpr (::ufio::operations::decay::defines::has_scatter_read_some_bytes_underflow_define<instmtype>)
	{
	...
	else if constexpr (::ufio::operations::decay::defines::has_read_some_bytes_underflow_define<instmtype>)
	{
		for (::std::size_t i{}; i != n; ++i)
		{
			...
			auto ed{base + len};
			auto written{::ufio::details::read_some_bytes_impl(insm, base, ed)};
		...
		return {n, 0};
					   ...
					   ::ufio::operations::decay::defines::has_read_all_bytes_underflow_define<instmtype>)
	{
		::ufio::details::scatter_read_all_bytes_cold_impl(insm, pscatters, n);
		return {n, 0};
	}
					   ...
					   ::ufio::operations::decay::defines::has_any_of_read_operations<instmtype>)
	{
		...
		return ::ufio::details::scatter_read_some_cold_impl(insm, reinterpret_cast<scattermayalias_ptr>(const_cast<::ufio::io_scatter_t *>(pscatters)),
															   n);
	}
					   ...
					   (::ufio::operations::decay::defines::has_any_of_pread_bytes_operations<instmtype>))
	{
		...
		::ufio::operations::decay::input_stream_seek_bytes_decay(
			insm, ::ufio::fposoffadd_scatters(0, pscatters, ret), ::ufio::seekdir::cur);
		return ret;
	}
	else if constexpr (sizeof(char_type) == 1 &&
...
#endif
			= basic_io_scatter_t<char_type> *;
		auto ret{scatter_pread_some_cold_impl(insm, reinterpret_cast<scattermayalias_ptr>(const_cast<::ufio::io_scatter_t *>(pscatters)), n, 0)};
		::ufio::operations::decay::input_stream_seek_decay(insm, ::ufio::fposoffadd_scatters(0, pscatters, ret),
															  ::ufio::seekdir::cur);
		return ret;
	}
}
																  ...
																  ::std::size_t n)
{
	if constexpr (::ufio::operations::decay::defines::has_input_or_io_stream_mutex_ref_define<instmtype>)
	{
		...
		return ::ufio::details::scatter_read_some_bytes_impl(
...
#endif
					= char_type *;
				::ufio::details::non_overlapped_copy_n(curr, len, reinterpret_cast<char_type_ptr>(base));
				curr += len;
				buffptrdiff -= len;
			}
			else
...
#endif
		{
			auto ret{::ufio::details::scatter_read_some_bytes_cold_impl(insm, i, static_cast<::std::size_t>(e - i))};
	...
	{
		return ::ufio::details::scatter_read_some_bytes_cold_impl(insm, pscatters, n);
	}
}
...
{
	using char_type = typename instmtype::input_char_type;
	if constexpr (::ufio::operations::decay::defines::has_scatter_read_all_bytes_underflow_define<instmtype>)
	{
	...
	else if constexpr (::ufio::operations::decay::defines::has_read_all_bytes_underflow_define<instmtype>)
	{
		for (auto i{pscatters}, e{pscatters + n}; i != e; ++i)
		{
			...
			::ufio::details::read_all_bytes_impl(insm, base, base + len);
		}
	}
	else if constexpr (::ufio::operations::decay::defines::has_read_all_bytes_underflow_define<instmtype>)
	{
	...
	else if constexpr (::ufio::operations::decay::defines::has_scatter_read_some_bytes_underflow_define<instmtype>)
	{
		for (;;)
		{
			auto ret{::ufio::details::scatter_read_some_bytes_impl(insm, pscatters, n)};
			...
			if (pisc)
			{
				...
				::ufio::details::read_all_bytes_impl(insm, base + pisc, base + pi.len);
				++retpos;
			}
			pscatters += retpos;
			n -= retpos;
...
#endif
			= basic_io_scatter_t<char_type> *;
		::ufio::details::scatter_read_all_impl(insm, reinterpret_cast<scattermayalias_ptr>(const_cast<::ufio::io_scatter_t *>(pscatters)), n);
	}
	else if constexpr (::ufio::operations::decay::defines::has_input_or_io_stream_seek_bytes_define<instmtype> &&
					   (::ufio::operations::decay::defines::has_any_of_pread_bytes_operations<instmtype>))
	{
...
#endif
			= basic_io_scatter_t<char_type> *;
		scatter_pread_all_cold_impl(insm, reinterpret_cast<scattermayalias_ptr>(const_cast<::ufio::io_scatter_t *>(pscatters)), n, 0);
...
inline constexpr void scatter_read_all_bytes_impl(instmtype insm, io_scatter_t const *pscatters, ::std::size_t n)
{
	if constexpr (::ufio::operations::decay::defines::has_input_or_io_stream_mutex_ref_define<instmtype>)
	{
		::ufio::operations::decay::stream_ref_decay_lock_guard lg{
			::ufio::operations::decay::input_stream_mutex_ref_decay(insm)};
		return ::ufio::details::scatter_read_all_bytes_impl(
			::ufio::operations::decay::input_stream_unlocked_ref_decay(insm), pscatters, n);
	}
	else if constexpr (::ufio::operations::decay::defines::has_ibuffer_basic_operations<instmtype>)
	{
...
#endif
		{
			return ::ufio::details::scatter_read_all_bytes_cold_impl(insm, i, static_cast<::std::size_t>(e - i));
		}
	}
	else
	{
		return ::ufio::details::scatter_read_all_bytes_cold_impl(insm, pscatters, n);
	}
}
