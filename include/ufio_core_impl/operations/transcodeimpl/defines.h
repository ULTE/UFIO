...
{
	if constexpr (::ufio::operations::defines::has_transcode_ref_define<T>)
	{
...
concept has_transcode_bytes_decay_define = requires(T t, ::std::byte const *ptr) {
	{ transcode_bytes_decay_define(t, ptr, ptr, ptr, ptr) } -> ::std::same_as<::ufio::transcode_bytes_result>;
};
...
concept has_transcode_bytes_min_tosize_decay_define = requires() {
	{ transcode_bytes_min_tosize_decay_define(::ufio::transcode_reserve<T>) } -> ::std::same_as<::std::size_t>;
};
...
concept has_transcode_decay_define = requires(T t, typename T::from_value_type const *fromit, typename T::to_value_type *toit) {
	{ transcode_decay_define(t, fromit, fromit, toit, toit) } -> ::std::same_as<::ufio::transcode_result<typename T::from_value_type, typename T::to_value_type>>;
};
...
concept has_transcode_min_tosize_decay_define = requires() {
	{ transcode_min_tosize_decay_define(::ufio::transcode_reserve<T>) } -> ::std::same_as<::std::size_t>;
};
...
concept has_transcode_bytes_define = requires(T &t, ::std::byte const *ptr) {
	{ transcode_bytes_decay(::ufio::transcode_ref(t), ptr, ptr, ptr, ptr) } -> ::std::same_as<::ufio::transcode_bytes_result>;
};

template <typename T>
concept has_transcode_bytes_max_tosize_define = requires(T &t, ::std::byte const *ptr) {
	{ transcode_bytes_max_tosize_decay(::ufio::transcode_ref(t), ptr, ptr) } -> ::std::same_as<::std::size_t>;
};

template <typename T>
concept has_transcode_bytes_min_tosize_define = requires(T &t) {
	{ transcode_bytes_min_tosize_decay(::ufio::transcode_reserve<decltype(::ufio::transcode_ref(t))>) } -> ::std::same_as<::std::size_t>;
};

template <typename T>
concept has_transcode_bytes_imaginary_define = requires(T &t, ::std::byte const *ptr, ::std::size_t mxsz) {
	{ transcode_bytes_imaginary_decay(::ufio::transcode_ref(t), ptr, ptr, mxsz) } -> ::std::same_as<::std::byte const *>;
};
} // namespace operations::defines
