...
{
template <typename char_type, typename allocator = ::ufio::native_thread_local_allocator>
...
template <bool nsecure_clear, typename allocator = ::ufio::native_thread_local_allocator>
...
template <bool nsecure_clear, typename char_type, typename allocator = ::ufio::native_thread_local_allocator>
