...
struct basic_timestamp
{
	...
	explicit constexpr operator flt_type() const noexcept
	{
		...
		constexpr flt_type precision{static_cast<flt_type>(::ufio::uint_least64_subseconds_per_second)};
...
{
	bool carry{};
	::std::uint_least64_t res{::ufio::intrinsics::addc(asubseconds, bsubseconds, carry, carry)};
	carry |= (::ufio::uint_least64_subseconds_per_second <= res);
	res -= carry ? ::ufio::uint_least64_subseconds_per_second : 0;
	::std::uint_least64_t secs{::ufio::intrinsics::addc(aseconds, bseconds, carry, carry)};
	return {secs, res};
}
...
{
	bool carry{};
	::std::uint_least64_t res{::ufio::intrinsics::subc(asubseconds, bsubseconds, carry, carry)};
	res += (static_cast<::std::uint_least64_t>(0u - static_cast<::std::uint_least64_t>(carry)) & ::ufio::uint_least64_subseconds_per_second);
	return {::ufio::intrinsics::subc(aseconds, bseconds, carry, carry), res};
}
											 ...
											 ::std::uint_least64_t d) noexcept
{
	...
	__uint128_t total_subseconds{static_cast<__uint128_t>(seconds) * ::ufio::uint_least64_subseconds_per_second + subseconds};
	...
	::std::uint_least64_t result_seconds{static_cast<::std::uint_least64_t>(q / ::ufio::uint_least64_subseconds_per_second)};
	::std::uint_least64_t result_subseconds{static_cast<::std::uint_least64_t>(q % ::ufio::uint_least64_subseconds_per_second)};
	if (minus)
	{
	...
	::std::uint_least64_t total_seconds_low{
		::ufio::intrinsics::umul(seconds, ::ufio::uint_least64_subseconds_per_second, total_seconds_high)};

	bool carry{};

	total_seconds_low = ::ufio::intrinsics::addc(total_seconds_low, subseconds, carry, carry);
	total_seconds_high = ::ufio::intrinsics::addc(total_seconds_high, zero, carry, carry);

	::std::uint_least64_t mid{d >> 1};
	auto [q_low, q_high, r, r_high] = ::ufio::intrinsics::udivmod(total_seconds_low, total_seconds_high, d, zero);
	if (mid < r || (mid == r && (q_low & 1) == 1))
	{
		carry = 0u;
		q_low = ::ufio::intrinsics::addc(q_low, one, carry, carry);
		q_high = ::ufio::intrinsics::addc(q_high, zero, carry, carry);
	}
	auto [result_seconds_low, result_seconds_high, result_subseconds_low, result_subseconds_high] =
		::ufio::intrinsics::udivmod(q_low, q_high, ::ufio::uint_least64_subseconds_per_second, zero);
	if (minus)
	{
													   ...
													   ::std::int_least64_t divisor_seconds, ::std::uint_least64_t divisor_subseconds) noexcept
{
	...
	::std::uint_least64_t dividend_total_seconds_low{
		::ufio::intrinsics::umul(udividend_seconds, ::ufio::uint_least64_subseconds_per_second, dividend_total_seconds_high)};

	bool carry{};

	dividend_total_seconds_low = ::ufio::intrinsics::addc(dividend_total_seconds_low, dividend_subseconds, carry, carry);
	dividend_total_seconds_high = ::ufio::intrinsics::addc(dividend_total_seconds_high, zero, carry, carry);

	::std::uint_least64_t divisor_total_seconds_high;
	::std::uint_least64_t divisor_total_seconds_low{
		::ufio::intrinsics::umul(udivisor_seconds, ::ufio::uint_least64_subseconds_per_second, divisor_total_seconds_high)};

	carry = 0;

	divisor_total_seconds_low = ::ufio::intrinsics::addc(divisor_total_seconds_low, divisor_subseconds, carry, carry);
	divisor_total_seconds_high = ::ufio::intrinsics::addc(divisor_total_seconds_high, zero, carry, carry);

	auto [q_low, q_high, r_low, r_high] = ::ufio::intrinsics::udivmod(dividend_total_seconds_low, dividend_total_seconds_high, divisor_total_seconds_low, divisor_total_seconds_high);

	auto divisor_total_seconds_div2_low{::ufio::intrinsics::shiftright(divisor_total_seconds_low, divisor_total_seconds_high, 1u)};
	auto divisor_total_seconds_div2_high{divisor_total_seconds_high >> 1u};

	carry = false;

	::ufio::intrinsics::subc(divisor_total_seconds_div2_low, r_low, carry, carry);
	::ufio::intrinsics::subc(divisor_total_seconds_div2_high, r_high, carry, carry);
	if ((!carry) && (((divisor_total_seconds_low & 1u) == 0u) && (r_low == divisor_total_seconds_div2_low || r_high == divisor_total_seconds_div2_high)))
	{
		// mid point case
		carry = ((q_low & 1u) != 0u);
	}
	q_low = ::ufio::intrinsics::addc(q_low, zero, carry, carry);
	q_high = ::ufio::intrinsics::addc(q_high, zero, carry, carry);
	if (carry)
	{
		::ufio::fast_terminate();
	}
	auto [seconds_low, seconds_high, subseconds_low, subseconds_high] = ::ufio::intrinsics::udivmod(q_low, q_high, ::ufio::uint_least64_subseconds_per_second, zero);
														 ...
														 basic_timestamp<off_to_epoch> b) noexcept
{
	if (a.seconds < 0)
	{
		...
		if (b.seconds < 0)
		{
			...
			b_abs = 0u - b_abs;
			auto res{::ufio::details::add_impl(a_abs, a.subseconds, b_abs, b.subseconds)};
		...
		else
		{
			...
			{
				auto res{::ufio::details::sub_impl(b_abs, b.subseconds, a_abs, a.subseconds)};
				return {static_cast<::std::int_least64_t>(res.seconds), res.subseconds};
			}
			else
			{
				auto res{::ufio::details::sub_impl(a_abs, a.subseconds, b_abs, b.subseconds)};
				res.seconds = 0u - res.seconds;
				return {static_cast<::std::int_least64_t>(res.seconds), res.subseconds};
			}
		}
														 ...
														 ::std::uint_least64_t b) noexcept
{
	...
	{
		return ::ufio::details::div_uint(a.seconds, a.subseconds, b);
	}
	else
	{
		auto [seconds, subseconds] = ::ufio::details::div_uint(a.seconds, a.subseconds, b);
														   ...
														   ::std::uint_least64_t b) noexcept
{
	if constexpr (off_to_epoch == 0)
	{
		return a = ::ufio::details::div_uint(a.seconds, a.subseconds, b);
	}
	else
	{
		auto [seconds, subseconds] = ::ufio::details::div_uint(a.seconds, a.subseconds, b);
														   ...
														   basic_timestamp<off_to_epoch> b) noexcept
{
	if constexpr (off_to_epoch == 0)
	{
		return a = ::ufio::details::div_unix_timestamp(a.seconds, a.subseconds, b.seconds, b.subseconds);
	}
	else
	{
		auto [seconds, subseconds] = ::ufio::details::div_unix_timestamp(a.seconds, a.subseconds, b.seconds, b.subseconds);
		a.seconds = seconds;
		a.subseconds = subseconds;
		return a;
	}
														 ...
														 basic_timestamp<off_to_epoch> b) noexcept
{
	if constexpr (off_to_epoch == 0)
	{
		return ::ufio::details::div_unix_timestamp(a.seconds, a.subseconds, b.seconds, b.subseconds);
	}
	else
	{
		auto [seconds, subseconds] = ::ufio::details::div_unix_timestamp(a.seconds, a.subseconds, b.seconds, b.subseconds);
												...
												::std::uint_least8_t day) noexcept
{
	...
	return ::ufio::details::c_weekday_impl(year, month, day);
}

inline constexpr ::std::uint_least8_t c_weekday(iso8601_timestamp const &timestamp) noexcept
{
	return ::ufio::c_weekday(timestamp.year, timestamp.month, timestamp.day);
}
											  ...
											  ::std::uint_least8_t day) noexcept
{
	...
	return ::ufio::details::weekday_impl(year, month, day);
}

inline constexpr ::std::uint_least8_t weekday(iso8601_timestamp const &timestamp) noexcept
{
	return ::ufio::weekday(timestamp.year, timestamp.month, timestamp.day);
}
...
inline constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, iso8601_timestamp>) noexcept
{
	...
	return print_reserve_size(io_reserve_type<char_type, ::std::int_least64_t>) + 16 +
		   ...
		   ::ufio::details::print_reserve_size_timezone_impl_v<char_type> + 3 + 2;
}
...
inline constexpr win32_timestamp to_win32_timestamp_ftu64(::std::uint_least64_t ftu64) noexcept
{
	...
	constexpr ::std::uint_least64_t mul_factor{::ufio::uint_least64_subseconds_per_second / 10000000u};
...
private:
	...
	static inline constexpr auto size_common{
		::ufio::details::print_integer_reserved_size_cache<10, false, ::ufio::details::my_signed_integral<T>, T>};
...
struct timestamp_scan_state_t : private timestamp_scan_context_buffer_max_size_t
{
	...
	::ufio::freestanding::array<char_type, max_size> buffer;
												  ...
												  char_type const *end, T &t) noexcept
{
	...
	if (itr != end)
	{
		...
		else
		{
			if (frag_length > digitsm1 - buffer_size)
			{
				...
				auto itr_end{
					::ufio::freestanding::non_overlapped_copy_n(begin, digitsm1 - buffer_size, buffer_begin)};
			...
			else
			{
				auto itr_begin{buffer_begin};
				auto itr_end{
					::ufio::freestanding::non_overlapped_copy_n(begin, frag_length, buffer_begin + buffer_size)};
				auto [_, ec] = chrono_scan_decimal_fraction_part_never_overflow_impl<false>(itr_begin, itr_end, t);
				if (ec != parse_code::ok) [[unlikely]]
				{
					return {itr, parse_code::invalid};
	...
	else if (frag_length > digitsm1 - buffer_size)
	{
		...
		else
		{
			...
			itr_end = ::ufio::freestanding::non_overlapped_copy_n(begin, digitsm1 - buffer_size,
								   ...
								   char_type const *end, unix_timestamp &t) noexcept
{
	...
	case scan_timestamp_context_phase::waiting_for_five:
	{
		for (; begin != end; ++begin)
		{
			if (!::ufio::char_category::is_c_digit(*begin))
			{
				if (t.subseconds % 2 == 1)
				{
					++t.subseconds;
...
scn_cnt_define_iso8601_impl(char_type const *begin, char_type const *end, iso8601_timestamp &t) noexcept
{
	...
	begin = ::ufio::find_none_c_space(begin, end);
									...
									char_type const *end, T &t) noexcept
{
	...
	case 0:
	{
		...
		{
			::ufio::freestanding::non_overlapped_copy_n(begin, 1, buffer_begin);
			state.size = 1;
			return {end, parse_code::partial};
		}
		break;
	...
	case 1:
	{
		::ufio::freestanding::non_overlapped_copy_n(begin, 1, buffer_begin + 1);
...
#define UFIO_SCAN_ISO8601_CONTEXT_TOKEN_PHASE(TOK)                    \
	{                                                                    \
		if (begin == end)                                                \
			return {begin, parse_code::partial};                         \
		else                                                             \
		...
		UFIO_SCAN_ISO8601_CONTEXT_TOKEN_PHASE(u8'-');
		[[fallthrough]];
	...
	case scan_timestamp_context_phase::after_day:
		UFIO_SCAN_ISO8601_CONTEXT_TOKEN_PHASE(u8'T');
		[[fallthrough]];
...
#endif
#endif
#undef UFIO_SCAN_ISO8601_CONTEXT_TOKEN_PHASE
}
...
template <::std::integral char_type, ::std::int_least64_t off_to_epoch>
inline constexpr parse_result<char_type const *>
scan_contiguous_define(io_reserve_type_t<char_type, ufio::parameter<basic_timestamp<off_to_epoch> &>>,
					   char_type const *begin, char_type const *end,
					   ufio::parameter<basic_timestamp<off_to_epoch> &> t) noexcept
{
	if constexpr (off_to_epoch == 0)
	{
...
scan_context_type(io_reserve_type_t<char_type, ufio::parameter<basic_timestamp<off_to_epoch> &>>) noexcept
{
	return {};
}
...
template <::std::integral char_type>
inline constexpr parse_result<char_type const *>
scan_contiguous_define(io_reserve_type_t<char_type, ufio::parameter<iso8601_timestamp &>>, char_type const *begin,
					   char_type const *end, ufio::parameter<iso8601_timestamp &> t) noexcept
{
...
template <::std::integral char_type>
inline constexpr io_type_t<timestamp_scan_state_t<char_type>>
scan_context_type(io_reserve_type_t<char_type, ufio::parameter<iso8601_timestamp &>>) noexcept
{
	return {};
}
...
scan_context_define(io_reserve_type_t<char_type, parameter<iso8601_timestamp &>>,
					timestamp_scan_state_t<char_type> &state, char_type const *begin, char_type const *end,
					ufio::parameter<iso8601_timestamp &> t) noexcept
{
...
template <::std::integral char_type>
inline constexpr parse_code
scan_context_eof_define(io_reserve_type_t<char_type, ufio::parameter<iso8601_timestamp &>>,
						timestamp_scan_state_t<char_type> &state, ufio::parameter<iso8601_timestamp &>) noexcept
{
...
{
	return ::ufio::manipulators::scalar_manip_precision_t<
		::ufio::details::dcmfloat_mani_flags_cache<false, false, ::ufio::manipulators::floating_format::fixed>,
		::ufio::unix_timestamp>{{t.seconds, t.subseconds}, n};
}
...
{
	return ::ufio::manipulators::scalar_manip_precision_t<
		::ufio::details::dcmfloat_mani_flags_cache<false, true, ::ufio::manipulators::floating_format::fixed>,
		::ufio::unix_timestamp>{{t.seconds, t.subseconds}, n};
}
} // namespace manipulators
...
inline constexpr char_type *prsv_fill_zero_impl(char_type *iter, ::std::size_t n) noexcept
{
	...
	for (; iter != ed; ++iter)
	{
		*iter = ::ufio::char_literal_v<u8'0', char_type>;
	}
	return ed;
}
...
{
	constexpr ::std::size_t mnsize{print_reserve_size(::ufio::io_reserve_type<char_type, ::std::int_least64_t>) + 3};
...
inline constexpr char_type *print_reserve_define_fixed_precision_unix_timestamp_impl(char_type *iter, ::std::int_least64_t seconds, ::std::uint_least64_t subseconds, ::std::size_t precision) noexcept
{
	...
	if (precision == 0)
	{
		constexpr auto vhalf{::ufio::uint_least64_subseconds_per_second >> 1};
	...
	{
		::std::uint_least64_t v{::ufio::details::d10_reverse_table<::std::uint_least64_t>[static_cast<::std::size_t>(precision - 1u)]};
		...
		{
			++quotient;
			if (quotient * v == ::ufio::uint_least64_subseconds_per_second)
			{
				++u64seconds;
				quotient = 0u;
			}
	...
	iter = print_reserve_define(::ufio::io_reserve_type<char_type, ::std::uint_least64_t>, iter, u64seconds);
	if (!precision)
	{
		return iter;
	}
	*iter = ::ufio::char_literal_v<(comma ? u8',' : u8'.'), char_type>;
	++iter;
	::ufio::details::print_reserve_integral_main_impl<10, false>(iter += subsecondslen, subseconds, subsecondslen);
	return ::ufio::details::prsv_fill_zero_impl(iter, precision - subsecondslen);
}

} // namespace details

template <::ufio::manipulators::scalar_flags flags, ::std::integral char_type>
inline constexpr ::std::size_t print_reserve_size(
	::ufio::io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_precision_t<flags, ::ufio::unix_timestamp>>,
	::ufio::manipulators::scalar_manip_precision_t<flags, ::ufio::unix_timestamp> const &e) noexcept
{
	static_assert(flags.base == 10 && flags.floating == ::ufio::manipulators::floating_format::fixed && !flags.full);
	return ::ufio::details::print_reserve_size_fixed_precision_unix_timestamp_impl<char_type>(e.precision);
}
...
{
	static_assert(flags.base == 10 && flags.floating == ::ufio::manipulators::floating_format::fixed && !flags.full);
	return ::ufio::details::print_reserve_define_fixed_precision_unix_timestamp_impl<flags.comma, flags.showpos>(iter, e.reference.seconds, e.reference.subseconds, e.precision);
}
