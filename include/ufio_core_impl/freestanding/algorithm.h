...
#endif
	{
		return ::ufio::freestanding::copy_n(first, count, result);
	}
	else
#endif
	{
...
#endif
	{
		return ::ufio::freestanding::copy(first, last, result);
	}
	else
#endif
	{
...
inline constexpr output_iter my_copy(input_iter first, input_iter second, output_iter result)
{
	...
	{
		return ::ufio::freestanding::copy(first, second, result);
	}
}
...
#endif
	{
		return ::ufio::freestanding::copy_backward(first, last, d_last);
	}
	else
#endif
	{
...
{
using ::ufio::freestanding::my_copy;
using ::ufio::freestanding::my_copy_backward;
using ::ufio::freestanding::my_copy_n;
using ::ufio::freestanding::my_memcpy;
using ::ufio::freestanding::my_memmove;
using ::ufio::freestanding::my_memset;
using ::ufio::freestanding::non_overlapped_copy;
using ::ufio::freestanding::non_overlapped_copy_n;
