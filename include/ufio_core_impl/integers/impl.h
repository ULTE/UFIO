...
inline constexpr ::std::size_t method_ptr_hold_size{::ufio::details::method_ptr_size % sizeof(::std::size_t) == 0
														? ::ufio::details::method_ptr_size / sizeof(::std::size_t)
														: ::ufio::details::method_ptr_size / sizeof(::std::size_t) +
															  1};
...
#if 0
	using scalar_manip_detail_tag = ::ufio::details::scalar_manip_detail_tag;
#endif
...
{
	using manip_tag = manip_tag_t;
	::ufio::freestanding::array<::std::size_t, ::ufio::details::method_ptr_hold_size> reference;
};
...
template <::std::size_t bs, bool upper, bool shbase, bool fll, bool showpos = false, bool comma = false,
		  ::ufio::manipulators::percentage_flag perflag = ::ufio::manipulators::percentage_flag::none>
inline constexpr ::ufio::manipulators::scalar_flags base_mani_flags_cache{
	.base = bs,
	.showbase = shbase,
	.showpos = showpos,
...
template <bool upper>
inline constexpr ::ufio::manipulators::scalar_flags boolalpha_mani_flags_cache{.alphabet = true, .uppercase = upper};

template <bool uppercase, bool comma>
inline constexpr ::ufio::manipulators::scalar_flags hexafloat_mani_flags_cache{
	.showbase = true,
	.uppercase_showbase = uppercase,
	.uppercase = uppercase,
	.uppercase_e = uppercase,
	.comma = comma,
	.floating = ::ufio::manipulators::floating_format::hexfloat};

template <bool uppercase, bool comma, ::ufio::manipulators::floating_format fm>
inline constexpr ::ufio::manipulators::scalar_flags dcmfloat_mani_flags_cache{
	.uppercase = uppercase, .uppercase_e = uppercase, .comma = comma, .floating = fm};

template <bool uppercase, bool shbase>
inline constexpr ::ufio::manipulators::scalar_flags cryptohash_mani_flags_cache{
...
inline constexpr ::ufio::manipulators::scalar_flags base_scan_mani_flags_cache{
	.base = bs, .showbase = shbase, .noskipws = noskipws, .full = skipzero};

template <bool shport>
inline constexpr ::ufio::manipulators::ip_flags base_ip_prefix_flags_cache{.showport = shport};
...
using uintptr_alias_type = ::ufio::details::integer_alias_type<::std::size_t>;
...
using uintptr_full_alias_type = ::ufio::details::integer_full_alias_type<::std::size_t>;
...
inline constexpr ::ufio::manipulators::scalar_flags
compute_bool_scalar_flags_cache(::ufio::manipulators::scalar_flags flags) noexcept
{
...
template <::ufio::manipulators::scalar_flags cache, typename scalar_type>
inline constexpr auto scalar_flags_int_cache(scalar_type t) noexcept
{
	...
	if constexpr (cache.full)
	{
		...
		{
			return ::ufio::manipulators::scalar_manip_t<cache, ::std::nullptr_t>{};
		}
		else if constexpr (::std::same_as<scalar_type_nocvref, bool>)
		{
			return ::ufio::manipulators::scalar_manip_t<compute_bool_scalar_flags_cache(cache), bool>{t};
		}
		else if constexpr (::std::same_as<scalar_type_nocvref, ::std::byte>)
		{
			using alias_type = integer_full_alias_type<char unsigned>;
			return ::ufio::manipulators::scalar_manip_t<cache, alias_type>{static_cast<alias_type>(t)};
		}
		else if constexpr (::ufio::details::my_integral<scalar_type_nocvref>)
		{
		...
		{
			return ::ufio::manipulators::scalar_manip_t<cache, uintptr_full_alias_type>{
				static_cast<uintptr_full_alias_type>(::std::bit_cast<::std::size_t>(t))};
		}
		else if constexpr (::std::same_as<::ufio::manipulators::member_function_pointer_holder_t,
										  scalar_type_nocvref>)
		{
			return ::ufio::manipulators::scalar_manip_t<cache,
														   ::ufio::manipulators::member_function_pointer_holder_t>{
				t};
		}
		else if constexpr (::ufio::details::has_scalar_manip_detail_tag<scalar_type>)
		{
			return ::ufio::manipulators::scalar_manip_t<cache, typename scalar_type_nocvref::value_type>{
				t.reference};
		}
		else
		{
	...
	else
	{
		...
		{
			return ::ufio::manipulators::scalar_manip_t<cache, uintptr_alias_type>{
...
template <typename scalar_type>
concept scalar_integrals = ::ufio::details::my_integral<scalar_type> ||
						   ...
						   ::ufio::details::has_scalar_manip_detail_tag<scalar_type>;
...
template <::std::size_t bs, bool shbase = false, bool full = false, typename scalar_type>
	requires((2 <= bs && bs <= 36) && (::ufio::details::scalar_integrals<scalar_type>))
inline constexpr auto base(scalar_type t) noexcept
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<bs, false, shbase, full>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<bs, true, shbase, full>>(t);
}

template <bool shbase = false, bool full = false, typename scalar_type>
	requires(::ufio::details::scalar_integrals<scalar_type>)
inline constexpr auto hex(scalar_type t) noexcept
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, false, shbase, full>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, true, shbase, full>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<::ufio::details::base_mani_flags_cache<16, false, true, full>>(
		t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<::ufio::details::base_mani_flags_cache<16, true, true, full>>(
		t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, false, shbase, true>>(
		static_cast<::ufio::details::my_make_unsigned_t<::std::remove_cvref_t<scalar_type>>>(t));
}
...
{
	if constexpr (::ufio::details::my_signed_integral<scalar_type>)
	{
		return ::ufio::details::scalar_flags_int_cache<
			::ufio::details::base_mani_flags_cache<16, uppercase, true, true, false>>(
			static_cast<::ufio::details::my_make_unsigned_t<::std::remove_cvref_t<scalar_type>>>(t));
	}
	else
	{
		return ::ufio::details::scalar_flags_int_cache<
			::ufio::details::base_mani_flags_cache<16, uppercase, true, true, false>>(t);
	}
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, uppercase, true, true, false>>(::std::bit_cast<::std::size_t>(t));
}
...
inline constexpr auto methodvw(scalar_type t) noexcept
{
	...
	else
	{
		return ::ufio::details::scalar_flags_int_cache<
			::ufio::details::base_mani_flags_cache<16, uppercase, true, true, false>>(
			::std::bit_cast<::ufio::manipulators::member_function_pointer_holder_t>(t));
	}
}
...
inline constexpr auto handlevw(scalar_type t) noexcept
{
	...
	{
		return ::ufio::details::scalar_flags_int_cache<
			::ufio::details::base_mani_flags_cache<10, false, false, false, false>>(t);
	}
	else
	{
		return ::ufio::details::scalar_flags_int_cache<
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, false, true, true, true>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<16, true, shbase, true>>(
		static_cast<::ufio::details::my_make_unsigned_t<::std::remove_cvref_t<scalar_type>>>(t));
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<10, false, shbase, full>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<8, false, shbase, full>>(t);
}
...
{
	return ::ufio::details::scalar_flags_int_cache<
		::ufio::details::base_mani_flags_cache<2, false, shbase, full>>(t);
}

template <scalar_flags flags, typename scalar_type>
	requires(((2 <= flags.base && flags.base <= 36 && (::ufio::details::scalar_integrals<scalar_type>)) ||
			  (flags.base == 10 && ::ufio::details::my_floating_point<scalar_type>)))
inline constexpr auto scalar_generic(scalar_type t) noexcept
{
	if constexpr (::ufio::details::my_floating_point<scalar_type>)
	{
		using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
		return scalar_manip_t<floating_point_default_scalar_flags, float_alias_type>{static_cast<float_alias_type>(t)};
	}
	else
	{
		return ::ufio::details::scalar_flags_int_cache<flags>(t);
	}
}

template <bool upper = false>
inline constexpr scalar_manip_t<::ufio::details::boolalpha_mani_flags_cache<upper>, bool> boolalpha(bool b) noexcept
{
	return {b};
}

template <bool uppercase = false, typename scalar_type>
	requires(::ufio::details::my_floating_point<scalar_type>)
inline constexpr auto hexfloat(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, false>, float_alias_type>{
...
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_precision_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, false>, float_alias_type>{
...
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, true>, float_alias_type>{
		static_cast<float_alias_type>(t)};
}
...
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_precision_t<::ufio::details::hexafloat_mani_flags_cache<uppercase, true>, float_alias_type>{
		static_cast<float_alias_type>(t), n};
}
...
inline constexpr auto decimal(scalar_type t) noexcept
{
	...
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, false, manipulators::floating_format::decimal>,
...
inline constexpr auto comma_decimal(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, true, manipulators::floating_format::decimal>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto general(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, false, manipulators::floating_format::general>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto comma_general(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, true, manipulators::floating_format::general>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto fixed(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, false, manipulators::floating_format::fixed>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto comma_fixed(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, true, manipulators::floating_format::fixed>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto scientific(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, false, manipulators::floating_format::scientific>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto comma_scientific(scalar_type t) noexcept
{
	using float_alias_type = ::ufio::details::float_alias_type<scalar_type>;
	return scalar_manip_t<
		::ufio::details::dcmfloat_mani_flags_cache<uppercase, true, manipulators::floating_format::scientific>,
		float_alias_type>{static_cast<float_alias_type>(t)};
}
...
inline constexpr auto generate_base_prefix_array() noexcept
{
	...
	{
		// 0[9]0000
		return ::ufio::freestanding::array<char_type, 4>{
			char_literal_v<u8'0', char_type>, char_literal_v<u8'[', char_type>,
			::ufio::char_literal_add<char_type>(base), char_literal_v<u8']', char_type>};
	}
	else
	{
		...
		return ::ufio::freestanding::array<char_type, 5>{
			char_literal_v<u8'0', char_type>, char_literal_v<u8'[', char_type>,
			::ufio::char_literal_add<char_type>(decade), ::ufio::char_literal_add<char_type>(unit),
...
constexpr void print_reserve_integral_main_impl(char_type *iter, T t, ::std::size_t len)
{
	...
	{
		constexpr ::std::size_t basetdigits{::ufio::details::cal_max_int_size<T, base>()};
		constexpr ::std::size_t sizetdigits{::ufio::details::cal_max_int_size<optimal_print_unsigned_type, base>()};
		...
		if constexpr (base == 2 || base == 4 || base == 16)
		{
			...
			optimal_print_unsigned_type low{
				::ufio::details::intrinsics::unpack_generic<T, optimal_print_unsigned_type>(t, high)};
			if (len > sizetdigits)
			{
			...
			if constexpr (!ryu_mode && remain_digits != 0)
			{
				...
				if constexpr (remain_digits == 1)
				{
					if (len == basetdigits)
					{
						...
						t = t % maxhighdigits;
						*(iter - basetdigits) = ::ufio::char_literal_add<char_type>(high);
						--len;
					}
				}
				else
				{
					...
					if (len > least_digits)
					{
						...
						if (len == basetdigits)
						{
							constexpr auto tb{::ufio::details::digits_table<char_type, base, uppercase>};
							non_overlapped_copy_n(tb + (rem << 1), 2, iter - basetdigits);
							len -= 2u;
						}
						else
						{
							*(iter + 1 - basetdigits) = ::ufio::char_literal_add<char_type>(high);
							--len;
						}
					}
				}
	...
	else
	{
		...
		else
		{
			...
			if ((len & 1))
			{
				if constexpr (base <= 10)
				{
					*--iter = ::ufio::char_literal_add<char_type>(t);
				}
				else
				{
...
constexpr char_type *print_reserve_integral_withfull_main_impl(char_type *first, T u)
{
	...
	else
	{
		if constexpr (full)
		{
			constexpr ::std::size_t sz{::ufio::details::cal_max_int_size<T, base>()};
		...
		else
		{
			if constexpr (base == 10 && (::std::numeric_limits<::std::uint_least32_t>::digits == 32u))
			{
				if constexpr (false)
				{
					return ::ufio::details::uprsv::uprsv_main<base, uppercase>(first, u);
				}
				else
				{
					return ::ufio::details::jeaiii::jeaiii_main(first, u);
				}
			}
			else
			{
...
constexpr char_type *print_reserve_integral_define(char_type *first, int_type t)
{
	...
	else
	{
		...
		{
			using unsigned_type = ::ufio::details::my_make_unsigned_t<int_type>;
			unsigned_type u{static_cast<unsigned_type>(t)};
			if constexpr (showpos)
			{
				if constexpr (::ufio::details::my_unsigned_integral<int_type>)
				{
					*first = char_literal_v<u8'+', char_type>;
				}
				else
			...
			{
				if constexpr (::ufio::details::my_signed_integral<int_type>)
				{
					if (t < 0)
					{
						*first = char_literal_v<u8'-', char_type>;
...
constexpr void print_reserve_integral_define_precise(char_type *start, ::std::size_t n, int_type t)
{
	...
	else
	{
		...
		else
		{
			...
			if constexpr (base == 10 && (::std::numeric_limits<::std::uint_least32_t>::digits == 32u))
			{
				return ::ufio::details::jeaiii::jeaiii_main_len(first, u, static_cast<::std::uint_least32_t>(n));
			}
			else
			{
				auto ed{start + n};
...
inline constexpr ::std::size_t print_reserve_scalar_size_impl()
{
	...
	{
		total_sum += ::ufio::details::print_showbase_length<base>;
	}
	...
	else
	{
		...
		total_sum += ::ufio::details::cal_max_int_size<T, base>();
	}
	return total_sum;
}
...
{
	::ufio::freestanding::array<char_type, print_integer_reserved_size_cache<base, showbase, showpos, ::std::size_t>>
		arr;
...
inline constexpr auto nullptr_print_optimization_call_impl() noexcept
{
	...
	::ufio::freestanding::array<char_type, sz> arr{};
	auto res{print_reserve_integral_define<base, showbase, uppercase_showbase, showpos, uppercase, full>(
		arr.data(), ::std::size_t{})};
	return arr;
}
...
inline constexpr char_type *print_reserve_method_impl(char_type *iter,
													  ::ufio::manipulators::member_function_pointer_holder_t mfph)
{
	if constexpr (base <= 10 && uppercase)
	{
	...
	else if constexpr (::ufio::details::method_ptr_hold_size == 0)
	{
		return iter;
	}
	else
	{
		...
		if constexpr (::ufio::details::method_ptr_hold_size == 2)
		{
		...
		else
		{
			...
			::std::size_t last{::ufio::details::method_ptr_hold_size};
...
template <typename scalar_type>
	requires(details::my_integral<scalar_type> || ::ufio::details::my_floating_point<scalar_type> ||
			 ::std::same_as<::std::nullptr_t, ::std::remove_cvref_t<scalar_type>>)
...
inline constexpr auto print_alias_define(io_alias_t, scalar_type t) noexcept
{
	...
	{
		using int_alias_type = ::ufio::details::integer_alias_type<scalar_type>;
...
template <::std::integral char_type, ::ufio::manipulators::scalar_flags flags, typename T>
	requires(details::my_integral<T> || ::std::same_as<::std::remove_cv_t<T>, ::std::byte> ||
			 ...
			 ::std::same_as<::std::remove_cv_t<T>, ::ufio::manipulators::member_function_pointer_holder_t>)
...
print_reserve_size(io_reserve_type_t<char_type, manipulators::scalar_manip_t<flags, T>>) noexcept
{
	...
	else if constexpr (::std::same_as<::std::remove_cv_t<T>, ::ufio::manipulators::member_function_pointer_holder_t>)
	{
		constexpr ::std::size_t method_size{
			(details::print_integer_reserved_size_cache<flags.base, flags.showbase, flags.showpos, ::std::size_t> + 1) *
				::ufio::details::method_ptr_hold_size -
			1};
		return method_size;
	}
...
#endif
constexpr char_type *
print_reserve_define(io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_t<flags, T>>, char_type *iter,
					 ::ufio::manipulators::scalar_manip_t<flags, T> t) noexcept
{
	static_assert(flags.percentage == ::ufio::manipulators::percentage_flag::none);
	if constexpr (flags.alphabet)
	{
		static_assert((::std::same_as<::std::remove_cvref_t<T>, bool> ||
					   ::std::same_as<::std::remove_cvref_t<T>, ::std::nullptr_t>),
	...
	{
		return ::ufio::details::print_reserve_method_impl<flags.base, flags.showbase, flags.uppercase_showbase,
