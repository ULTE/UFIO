...
inline constexpr void jeaiii_w(char_type *iter, ::std::uint_fast32_t u) noexcept
{
	...
	::ufio::details::intrinsics::typed_memcpy(iter, digitstb + (u << 1), tocopybytes);
}
...
inline constexpr ::std::uint_least64_t jeaiii_a(char_type *iter, ::std::uint_least32_t u) noexcept
{
	...
	constexpr ::std::uint_least64_t constant{
		(one << (32 + v)) / ::ufio::details::compile_pow10<::std::uint_least64_t, n> + 1 + n / 6 - n / 8};
...
inline constexpr void jeaiii_s(char_type *iter, ::std::uint_least64_t t) noexcept
{
	...
	iter[n] = ::ufio::char_literal_add<char_type>((ten * static_cast<::std::uint_least32_t>(t)) >> 32u);
}
...
inline constexpr void jeaiii_c(char_type *iter, ::std::uint_least32_t u) noexcept
{
	if constexpr (n == 0)
	{
		*iter = ::ufio::char_literal_add<char_type>(u);
	}
...
*/
	...
	{
		if(u<::ufio::details::compile_pow10<::std::uint_least32_t,2>)
		{
			if(u<::ufio::details::compile_pow10<::std::uint_least32_t,1>)
			{
				*iter=::ufio::char_literal_add<char_type>(u);
				return iter+1;
			}
		...
		else if(u<::ufio::details::compile_pow10<::std::uint_least32_t,6>)
		{
			if(u<::ufio::details::compile_pow10<::std::uint_least32_t,4>)
			{
				if(u<::ufio::details::compile_pow10<::std::uint_least32_t,3>)
				{
			...
			else if(u<::ufio::details::compile_pow10<::std::uint_least32_t,5>)
			{
		...
		else if(u<::ufio::details::compile_pow10<::std::uint_least32_t,8>)
		{
			if(u<::ufio::details::compile_pow10<::std::uint_least32_t,7>)
			{
		...
		{
			if(u<::ufio::details::compile_pow10<::std::uint_least32_t,9>)
			{
...
#endif
	{
		...
		{
			if (u < (::ufio::details::compile_pow10<::std::uint_least32_t, right>))
			{
		...
		{
			if (u < (::ufio::details::compile_pow10<::std::uint_least32_t, left + 1>))
			{
				return jeaiii_f<left>(iter, u);
			}
			else
		...
		else
		{
			...
			if (u < (::ufio::details::compile_pow10<::std::uint_least32_t, middle + 1>))
			{
...
template <bool ryu_mode = false, bool recursive = false, ::std::integral char_type,
		  ::ufio::details::my_unsigned_integral U>
