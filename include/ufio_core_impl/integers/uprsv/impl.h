...
/*
ufio's own uprsv (uint print reserve) algorithm
...
namespace ufio::details::uprsv
{

template <::std::size_t base, bool uppercase, ::std::integral char_type,
		  ::ufio::details::my_unsigned_integral uinttype>
...
inline constexpr char_type *uprsv_main(char_type *iter, uinttype value) noexcept
{
	...
	{
		using namespace ::ufio::details::uprsv::decbase;
	...
	{
		using namespace ::ufio::details::uprsv::hexbase;
		if constexpr (sizeof(uinttype) <= sizeof(::std::uint_least32_t))
		{
