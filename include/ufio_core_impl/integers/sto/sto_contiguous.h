...
inline constexpr bool char_digit_to_literal(my_make_unsigned_t<char_type> &ch) noexcept
{
	...
	constexpr bool ebcdic{::ufio::details::is_ebcdic<char_type>};
	if constexpr (::std::same_as<char_type, wchar_t> && ::ufio::details::wide_is_none_utf_endian)
	{
		ch = static_cast<char_type>(::ufio::byte_swap(static_cast<unsigned_char_type>(ch)));
	}
...
inline ::std::uint_least32_t detect_length(char unsigned const *buffer) noexcept
{
	...
	using namespace ufio::intrinsics;
	x86_64_v16qu chunk;
...
scan_int_contiguous_none_space_part_define_impl(char_type const *first, char_type const *last, T &t) noexcept
{
	...
	if (first != last)
	{
		...
		else if (first_ch == zero)
		{
			...
			{
				++first;
				first = ::ufio::details::find_none_zero_simd_impl(first, last);
				if (first == last)
				{
					t = 0;
																				 ...
																				 char_type const *last, T &t) noexcept
{
	...
	{
		first = ::ufio::details::find_space_common_impl<false, true>(first, last);
		if (first == last)
		{
...
namespace details
{
template <char8_t base, ::std::integral char_type, ::ufio::details::my_integral T>
inline constexpr auto scan_context_type_impl_int() noexcept
{
	...
	constexpr ::std::size_t max_size{
		(::ufio::details::print_integer_reserved_size_cache<base, false, ::ufio::details::my_signed_integral<T>,
															   unsigned_type>)+2};
...
template <::std::size_t bs, bool noskipws = false, bool skipzero = false, bool prefix = false, ::ufio::details::my_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<bs, noskipws, (bs == 10 ? false : prefix), skipzero>,
								scalar_type &>
...
template <bool noskipws = false, bool skipzero = false, bool prefix = false, ::ufio::details::my_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<2, noskipws, prefix, skipzero>,
								scalar_type &>
...
template <bool noskipws = false, bool skipzero = false, bool prefix = false, ::ufio::details::my_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<8, noskipws, prefix, skipzero>,
								scalar_type &>
...
template <bool noskipws = false, bool skipzero = false, ::ufio::details::my_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<10, noskipws, false, skipzero>,
								scalar_type &>
...
template <bool noskipws = false, bool skipzero = false, bool prefix = false, ::ufio::details::my_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<16, noskipws, prefix, skipzero>,
								scalar_type &>
...
template <bool noskipws = false, ::ufio::details::my_unsigned_integral scalar_type>
inline constexpr scalar_manip_t<::ufio::details::base_scan_mani_flags_cache<16, noskipws, true, true>, scalar_type &>
...
inline constexpr ::ufio::manipulators::scalar_manip_t<
	::ufio::details::base_scan_mani_flags_cache<10, false, false, false>, T &>
...
scan_context_type(io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_t<flags, T &>>) noexcept
{
...
template <::std::integral char_type, manipulators::scalar_flags flags, details::my_integral T>
inline constexpr parse_result<char_type const *>
scan_contiguous_define(io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_t<flags, T &>>,
...
inline constexpr parse_result<char_type const *>
scan_context_define(io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_t<flags, T &>>, State &state,
					char_type const *begin, char_type const *end,
					::ufio::manipulators::scalar_manip_t<flags, T &> t) noexcept
{
...
scan_context_eof_define(io_reserve_type_t<char_type, ::ufio::manipulators::scalar_manip_t<flags, T &>>, State &state,
						::ufio::manipulators::scalar_manip_t<flags, T &> t) noexcept
{
