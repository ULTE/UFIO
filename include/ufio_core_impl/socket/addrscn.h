...
struct ip_scan_state_t
{
	...
	static inline constexpr auto max_size{
		::ufio::details::print_integer_reserved_size_cache<10, false, false, ::std::uint_least16_t> + 1};
...
{
	begin = ::ufio::details::find_space_common_impl<false, true>(begin, end);
...
template <ip_scan_flags flags, ::ufio::details::iptypesimpl iptype>
...
[[msvc::forceinline]]
#endif
inline constexpr ::ufio::manipulators::ip_scan_manip_t<::ufio::details::inaddrimpl<iptype>
															  ? ::ufio::manipulators::ip_scan_default_inaddr_flags
															  : ::ufio::manipulators::ip_scan_default_flags,
...
template <::std::integral char_type, ::ufio::manipulators::ip_scan_flags flags,
		  ::ufio::details::iptypesimpl iptype>
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
					   ...
					   manipulators::ip_scan_manip_t<flags, iptype *> val) noexcept
{
	...
	{
		auto result{::ufio::details::scn_cnt_define_inaddr_impl(begin, end, val.reference->address)};
		if (result.code != parse_code::ok) [[unlikely]]
		{
			return result;
		}
		...
		{
			return ::ufio::details::scn_cnt_define_port_impl(begin, end, val.reference->port);
		}
	}
...
inline constexpr io_type_t<ipv4_scan_state_t<char_type>> scan_context_type(
	io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, posix_in_addr *>>) noexcept
{
	return {};
}
...
inline constexpr parse_result<char_type const *> scan_context_define(
	::ufio::io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, posix_in_addr *>>,
	ipv4_scan_state_t<char_type> &state, char_type const *begin, char_type const *end,
	::ufio::manipulators::ip_scan_manip_t<flags, posix_in_addr *> t) noexcept
{
...
inline constexpr parse_code scan_context_eof_define(
	::ufio::io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, posix_in_addr *>>,
	ipv4_scan_state_t<char_type> &state, ::ufio::manipulators::ip_scan_manip_t<flags, posix_in_addr *> t) noexcept
{
...
scan_context_type(io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, ipv4 *>>) noexcept
{
	return {};
}
...
template <::std::integral char_type, ::ufio::manipulators::ip_scan_flags flags>
inline constexpr parse_result<char_type const *>
scan_context_define(::ufio::io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, ipv4 *>>,
					ipv4_scan_state_t<char_type> &state, char_type const *begin, char_type const *end,
					::ufio::manipulators::ip_scan_manip_t<flags, ipv4 *> t) noexcept
{
	switch (state.ip_phase)
	{
	case scan_ipv4_context_phase::addr0:
...
template <::std::integral char_type, ::ufio::manipulators::ip_scan_flags flags>
inline constexpr parse_code scan_context_eof_define(
	::ufio::io_reserve_type_t<char_type, ::ufio::manipulators::ip_scan_manip_t<flags, ipv4 *>>,
	ipv4_scan_state_t<char_type> &state, ::ufio::manipulators::ip_scan_manip_t<flags, ipv4 *> t) noexcept
{
