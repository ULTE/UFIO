...
inline char_type *llvm_raw_ostream_obuffer_ptr(::llvm::raw_ostream *os) noexcept
{
	...
	char_type *ptr;
	::ufio::details::my_memcpy(__builtin_addressof(ptr), reinterpret_cast<char *>(os) + offset, sizeof(char_type *));
	return ptr;
}
...
inline void llvm_raw_ostream_set_obuffer_curr_ptr(::llvm::raw_ostream *os, char *vdptr)
{
	...
	::ufio::details::my_memcpy(reinterpret_cast<char *>(os) + offset, __builtin_addressof(vdptr), sizeof(char *));
}
...
inline int hack_fd_from_llvm_raw_fd_ostream(::llvm::raw_fd_ostream *os) noexcept
{
	...
	int fd;
	::ufio::details::my_memcpy(__builtin_addressof(fd), reinterpret_cast<char *>(os) + fdoffset, sizeof(int));
	return fd;
}

inline void hack_set_fd_to_llvm_raw_fd_ostream(::llvm::raw_fd_ostream *os, int fd) noexcept
{
	::ufio::details::my_memcpy(reinterpret_cast<char *>(os) + fdoffset, __builtin_addressof(fd), sizeof(int));
}
