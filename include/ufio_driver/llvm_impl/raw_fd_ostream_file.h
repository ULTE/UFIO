...
{
	return open_llvm_raw_fd_ostream_from_fd(::ufio::details::sys_dup(hack_fd_from_llvm_raw_fd_ostream(f)));
}
																	 ...
																	 ::llvm::raw_fd_ostream *otherfdos)
{
	...
	hack_set_fd_to_llvm_raw_fd_ostream(thisfdos,
									   ::ufio::details::sys_dup2(hack_fd_from_llvm_raw_fd_ostream(otherfdos),
...
public:
	...
	{
		this->os = ::ufio::llvm::details::open_llvm_raw_fd_ostream_from_fd_dup2(this->os, other.os);
		return *this;
	}
	basic_raw_fd_ostream_file(basic_posix_file<char_type> &&pioh, ::ufio::open_mode)
