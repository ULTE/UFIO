...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	IoDeleteSymbolicLink(::ufio::win32::nt::unicode_string *SymbolicLinkName) noexcept
...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	IoDeleteDevice(::ufio::win32::nt::device_object *DeviceObject) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX <= UINT_LEAST32_MAX && (defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
...
extern ::std::uint_least32_t
	...
	__fastcall
#endif
	IofCompleteRequest(::ufio::win32::nt::irp *Irp, char PriorityBoost) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX <= UINT_LEAST32_MAX && (defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	IoCreateDevice(::ufio::win32::nt::driver_object *DriverObject,
				   ::std::uint_least32_t DeviceExtensionSize,
				   ::ufio::win32::nt::unicode_string *DeviceName,
				   ::std::uint_least32_t DeviceType,
				   ::std::uint_least32_t DeviceCharacteristics,
				   ::std::uint_least8_t Exclusive,
				   ::ufio::win32::nt::device_object **DeviceObject) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX <= UINT_LEAST32_MAX && (defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	IoCreateSymbolicLink(::ufio::win32::nt::unicode_string *SymbolicLinkName, ::ufio::win32::nt::unicode_string *DeviceName) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX <= UINT_LEAST32_MAX && (defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
