...
using ibuf_win32_internet_io_observer = ufio::basic_ibuf<win32_internet_io_observer>;

using win32_internet_https_client = basic_win32_internet_https_client<char>;

using ibuf_win32_internet_https_client = ufio::basic_ibuf<win32_internet_https_client>;
} // namespace ufio
