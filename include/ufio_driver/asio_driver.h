...
using ibuf_ip_tcp_socket_io_observer = ufio::basic_ibuf<basic_ip_tcp_socket_io_observer<char>>;

using u8ip_tcp_socket_io_observer = basic_ip_tcp_socket_io_observer<char8_t>;
using u8ibuf_ip_tcp_socket_io_observer = ufio::basic_ibuf<basic_ip_tcp_socket_io_observer<char8_t>>;

using wip_tcp_socket_io_observer = basic_ip_tcp_socket_io_observer<wchar_t>;
using wibuf_ip_tcp_socket_io_observer = ufio::basic_ibuf<basic_ip_tcp_socket_io_observer<wchar_t>>;
