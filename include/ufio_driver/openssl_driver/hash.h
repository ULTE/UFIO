...
struct basic_ossl_hash_context
{
	...
	{
		::ufio::freestanding::nonoverlapped_bytes_copy_n(digest_buffer, digest_size, dest);
	}
...
struct md5_meta_info
{
	...
	{
		return ::ufio::noexcept_call(MD5_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(MD5_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(MD5_Final, md, c);
	}
};

using md5_context
#ifndef UFIO_NO_WARNING_DEPRECATED_CRYPTO_ALGOS
...
struct sha1_meta_info
{
	...
	static inline int init_function(ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA1_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(SHA1_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA1_Final, md, c);
	}
};
...
struct sha224_meta_info
{
	...
	static inline int init_function(ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA224_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(SHA224_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA224_Final, md, c);
	}
};
...
struct sha256_meta_info
{
	...
	static inline int init_function(ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA256_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(SHA256_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA256_Final, md, c);
	}
};
...
struct sha384_meta_info
{
	...
	static inline int init_function(ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA384_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(SHA384_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA384_Final, md, c);
	}
};
...
struct sha512_meta_info
{
	...
	static inline int init_function(ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA512_Init, c);
	}
	static inline int update_function(ctx_type *c, void const *data, ::std::size_t len) noexcept
	{
		return ::ufio::noexcept_call(SHA512_Update, c, data, len);
	}
	static inline int final_function(char unsigned *md, ctx_type *c) noexcept
	{
		return ::ufio::noexcept_call(SHA512_Final, md, c);
	}
};
