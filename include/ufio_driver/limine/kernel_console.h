...
inline void kconsole_scatter_write_impl(::ufio::limine::kernel_console::function_ptr_type func_ptr,
...
{
	::ufio::limine::details::kconsole_scatter_write_impl(console.func_ptr, scatters.base, scatters.len);
}
