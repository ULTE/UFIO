...
template <::ufio::manipulators::scalar_placement placement, ::std::integral char_type>
inline constexpr char_type *handle_common_ch(char_type *first, char_type *last, ::std::size_t wd, char_type fillch)
{
	...
	if constexpr (placement == ::ufio::manipulators::scalar_placement::left)
	{
		my_fill_n(last, to_fill_chs, fillch);
	}
	else if constexpr (placement == ::ufio::manipulators::scalar_placement::middle)
	{
...
template <::ufio::manipulators::scalar_placement placement, ::std::integral char_type, typename T>
inline constexpr char_type *print_reserve_define_width_ch_impl(char_type *iter, T t, ::std::size_t wdt,
															   char_type fillch)
{
	using value_type = ::std::remove_cvref_t<T>;
	if constexpr (placement == ::ufio::manipulators::scalar_placement::internal)
	{
		...
		{
			return print_reserve_define_width_ch_impl<::ufio::manipulators::scalar_placement::right>(iter, t, wdt,
																										fillch);
		}
	}
	else
...
template <::std::integral char_type>
inline constexpr char_type *handle_common_rt_ch(::ufio::manipulators::scalar_placement placement, char_type *first,
												char_type *last, ::std::size_t wd, char_type fillch)
{
	...
	::std::size_t const to_fill_chs{wd - diff};
	if (placement == ::ufio::manipulators::scalar_placement::left)
	{
		my_fill_n(last, to_fill_chs, fillch);
		return first + wd;
	}
	else if (placement == ::ufio::manipulators::scalar_placement::middle)
	{
		::std::size_t one{1};
		::std::size_t const left_indent{static_cast<::std::size_t>(to_fill_chs >> one)};
		::std::size_t const right_indent{to_fill_chs - left_indent};
	...
	else if (placement == ::ufio::manipulators::scalar_placement::right)
	{
		my_copy(first, last, first + to_fill_chs);
		my_fill_n(first, to_fill_chs, fillch);
		return first + wd;
...
inline constexpr char_type *print_reserve_define_width_rt_ch_impl(char_type *iter,
																  ::ufio::manipulators::scalar_placement placement,
																  T t, ::std::size_t wdt, char_type fillch)
{
	using value_type = ::std::remove_cvref_t<T>;
	if (placement == ::ufio::manipulators::scalar_placement::internal)
	{
		if constexpr (printable_internal_shift<char_type, value_type>)
		{
			if constexpr (scatter_printable<char_type, value_type>)
		...
		{
			placement = ::ufio::manipulators::scalar_placement::right;
		}
	}
	if constexpr (scatter_printable<char_type, value_type>)
	{
...
inline constexpr char_type *print_reserve_define_rt_width_impl(char_type *iter,
															   ::ufio::manipulators::scalar_placement placement, T t,
															   ::std::size_t wdt)
{
...
template <::std::integral char_type, ::ufio::manipulators::scalar_placement placement, typename T>
...
constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, ::ufio::manipulators::width_t<placement, T>>,
										   ::ufio::manipulators::width_t<placement, T> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_size_width_impl<char_type>(parameter<T>{t.reference}, t.width);
	}
	else
	{
		return ::ufio::details::print_reserve_size_width_impl<char_type>(t.reference, t.width);
	}
}
...
template <::std::integral char_type, ::ufio::manipulators::scalar_placement placement, typename T>
	requires((reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 ...
			 (static_cast<::std::size_t>(static_cast<::std::size_t>(placement) - static_cast<::std::size_t>(1u)) <
			  static_cast<::std::size_t>(4u)))
constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, ::ufio::manipulators::width_t<placement, T>>,
										  char_type *iter, ::ufio::manipulators::width_t<placement, T> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_define_width_impl<placement>(iter, parameter<T>{t.reference}, t.width);
	}
	else
	{
		return ::ufio::details::print_reserve_define_width_impl<placement>(iter, t.reference, t.width);
	}
}
...
print_reserve_size(io_reserve_type_t<char_type, ::ufio::manipulators::width_ch_t<placement, T, char_type>>,
				   ::ufio::manipulators::width_ch_t<placement, T, char_type> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_size_width_impl<char_type>(parameter<T>{t.reference}, t.width);
...
template <::std::integral char_type, ::ufio::manipulators::scalar_placement placement, typename T>
	requires((reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 ...
			 (static_cast<::std::size_t>(static_cast<::std::size_t>(placement) - static_cast<::std::size_t>(1u)) <
			  static_cast<::std::size_t>(4u)))
constexpr char_type *
print_reserve_define(io_reserve_type_t<char_type, ::ufio::manipulators::width_ch_t<placement, T, char_type>>,
					 char_type *iter, ::ufio::manipulators::width_ch_t<placement, T, char_type> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_define_width_ch_impl<placement>(iter, parameter<T>{t.reference},
																				 t.width, t.ch);
	}
	else
	{
		return ::ufio::details::print_reserve_define_width_ch_impl<placement>(iter, t.reference, t.width, t.ch);
	}
}
...
template <::std::integral char_type, typename T>
	requires(reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 dynamic_reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 scatter_printable<char_type, ::std::remove_cvref_t<T>>)
constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, ::ufio::manipulators::width_runtime_t<T>>,
										   ::ufio::manipulators::width_runtime_t<T> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_size_width_impl<char_type>(parameter<T>{t.reference}, t.width);
...
template <::std::integral char_type, typename T>
	requires(reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 dynamic_reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 scatter_printable<char_type, ::std::remove_cvref_t<T>>)
constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, ::ufio::manipulators::width_runtime_t<T>>,
										  char_type *iter, ::ufio::manipulators::width_runtime_t<T> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_define_rt_width_impl(iter, t.placement, parameter<T>{t.reference},
																	  t.width);
	}
	else
	{
		return ::ufio::details::print_reserve_define_rt_width_impl(iter, t.placement, t.reference, t.width);
	}
}
...
template <::std::integral char_type, typename T>
	requires(reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 ...
			 scatter_printable<char_type, ::std::remove_cvref_t<T>>)
constexpr ::std::size_t
print_reserve_size(io_reserve_type_t<char_type, ::ufio::manipulators::width_runtime_ch_t<T, char_type>>,
				   ::ufio::manipulators::width_runtime_ch_t<T, char_type> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_size_width_impl<char_type>(parameter<T>{t.reference}, t.width);
...
template <::std::integral char_type, typename T>
	requires(reserve_printable<char_type, ::std::remove_cvref_t<T>> ||
			 ...
			 scatter_printable<char_type, ::std::remove_cvref_t<T>>)
constexpr char_type *
print_reserve_define(io_reserve_type_t<char_type, ::ufio::manipulators::width_runtime_ch_t<T, char_type>>,
					 char_type *iter, ::ufio::manipulators::width_runtime_ch_t<T, char_type> t) noexcept
{
	if constexpr (::std::is_reference_v<T>)
	{
		return ::ufio::details::print_reserve_define_width_rt_ch_impl(iter, t.placement, parameter<T>{t.reference},
																		 t.width, t.ch);
	}
	else
	{
		return ::ufio::details::print_reserve_define_width_rt_ch_impl(iter, t.placement, t.reference, t.width, t.ch);
	}
}
