													 ...
													 ::std::size_t bfsz)
{
	...
	ibuffer.buffer_end =
		::ufio::operations::decay::read_some_decay(insm, ibuffer.buffer_begin, ibuffer.buffer_begin + bfsz);
...
{
	return ::ufio::details::io_buffer::ibuffer_underflow_rl_size_impl<allocator_type>(insm, ibuffer, bfsz);
}
														...
														::std::size_t bfsz)
{
	...
	auto ed{bg + bfsz};
	::ufio::operations::decay::read_all_decay(insm, bg, ed);
...
{
	::ufio::details::io_buffer::ibuffer_minimum_size_underflow_all_prepare_rl_size_impl<allocator_type>(
		insm, ibuffer, bfsz);
}
...
{
	using typed_allocator_type = ::ufio::typed_generic_allocator_adapter<allocator_type, char_type>;
	first = ::ufio::details::non_overlapped_copy(pointers.buffer_curr, pointers.buffer_end, first);
	...
	if constexpr (::ufio::operations::decay::defines::has_any_of_read_bytes_operations<instmtype>)
	{
		...
		auto [pos, scpos]{::ufio::operations::decay::scatter_read_some_bytes_decay(instm, scatters, 2)};
		if (pos == 2)
		{
	...
	else
	{
		...
		auto [pos, scpos]{::ufio::operations::decay::scatter_read_some_decay(instm, scatters, 2)};
		if (pos == 2)
		{
			pointers.buffer_end = (pointers.buffer_curr = pointers.buffer_begin) + bfsz;
			return last;
...
{
	return ::ufio::details::io_buffer::read_some_underflow_size_impl<allocatortype>(instm, pointers, first,
																					   last, bfsz);
}
													   ...
													   char_type *first, char_type *last)
{
	...
	return ::ufio::details::io_buffer::read_some_underflow_impl<
		io_buffer_type::traits_type::input_buffer_size, typename io_buffer_type::traits_type::allocator_type>(
		::ufio::operations::input_stream_ref(iobref.iobptr->handle), iobref.iobptr->input_buffer, first, last);
}

template <typename io_buffer_type, ::std::integral char_type>
inline constexpr char_type *pread_some_underflow_define(basic_io_buffer_ref<io_buffer_type> iobref,
														char_type *first, char_type *last, ::ufio::intfpos_t off)
{
	constexpr auto mode{io_buffer_type::traits_type::mode};
	if constexpr ((mode & buffer_mode::out) == buffer_mode::out && (mode & buffer_mode::tie) == buffer_mode::tie)
	{
	...
	return ::ufio::operations::decay::pread_some_decay(::ufio::operations::input_stream_ref(iobref.iobptr->handle), first, last, off);
}
												 ...
												 char_type *first, char_type *last, ::ufio::intfpos_t off)
{
	...
	return ::ufio::operations::decay::pread_all_decay(::ufio::operations::input_stream_ref(iobref.iobptr->handle), first, last, off);
}

template <typename io_buffer_type, ::std::integral char_type>
inline constexpr ::ufio::io_scatter_status_t scatter_pread_some_underflow_define(basic_io_buffer_ref<io_buffer_type> iobref,
																					basic_io_scatter_t<char_type> const *pscatters, ::std::size_t n, ::ufio::intfpos_t off)
{
	constexpr auto mode{io_buffer_type::traits_type::mode};
	if constexpr ((mode & buffer_mode::out) == buffer_mode::out && (mode & buffer_mode::tie) == buffer_mode::tie)
	{
	...
	return ::ufio::operations::decay::scatter_pread_some_decay(::ufio::operations::input_stream_ref(iobref.iobptr->handle), pscatters, n, off);
}
														 ...
														 basic_io_scatter_t<char_type> const *pscatters, ::std::size_t n, ::ufio::intfpos_t off)
{
	...
	::ufio::operations::decay::scatter_pread_all_decay(::ufio::operations::input_stream_ref(iobref.iobptr->handle), pscatters, n, off);
}
...
inline constexpr bool ibuffer_underflow(basic_io_buffer_ref<io_buffer_type> iobref)
{
	...
	return ::ufio::details::io_buffer::ibuffer_underflow_rl_impl<
		...
		::ufio::operations::input_stream_ref(iobref.iobptr->handle), iobref.iobptr->input_buffer);
}
...
inline constexpr ::std::size_t
	ibuffer_minimum_size_define(::ufio::io_reserve_type_t<char_type, basic_io_buffer_ref<io_buffer_type>>)
{
...
{
	::ufio::details::io_buffer::ibuffer_minimum_size_underflow_all_prepare_impl<
		io_buffer_type::traits_type::input_buffer_size, typename io_buffer_type::traits_type::input_char_type,
		typename io_buffer_type::traits_type::allocator_type>(
		::ufio::operations::input_stream_ref(iobref.iobptr->handle), iobref.iobptr->input_buffer);
}
