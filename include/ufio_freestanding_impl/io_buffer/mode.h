...
constexpr ::std::size_t compute_default_buffer_size() noexcept
{
	...
	else
	{
		constexpr ::std::size_t buffersize{
			...
			(UFIO_BUFFER_SIZE < sizeof(char_type)) ? UFIO_BUFFER_SIZE : sizeof(char_type)
...
inline constexpr ::std::size_t compute_default_input_output_buf_size(::ufio::buffer_mode req,
																	 ::ufio::buffer_mode m) noexcept
{
	if ((m & req) == req)
	{
		return ::ufio::details::compute_default_buffer_size<chtype>();
	}
	return 0;
}

template <typename chtype>
inline constexpr bool compute_whether_possible_flag_for_buffer_mode(::ufio::buffer_mode req,
																	::ufio::buffer_mode m,
...
template <typename char_type>
inline constexpr ::std::size_t default_buffer_size{::ufio::details::compute_default_buffer_size<char_type>()};

template <buffer_mode mde, typename allocatortype, typename input_chtype, typename output_chtype,
		  ::std::size_t input_buf_size =
			  ::ufio::details::compute_default_input_output_buf_size<input_chtype>(::ufio::buffer_mode::in, mde),
		  ::std::size_t output_buf_size = ::ufio::details::compute_default_input_output_buf_size<output_chtype>(
			  ::ufio::buffer_mode::out, mde)>
	requires(::ufio::details::compute_whether_possible_flag_for_buffer_mode<input_chtype>(::ufio::buffer_mode::in,
																							 mde, input_buf_size) &&
			 ::ufio::details::compute_whether_possible_flag_for_buffer_mode<output_chtype>(
				 ::ufio::buffer_mode::out, mde, output_buf_size))
