									   ...
									   dectref &&deco)
{
	using newtype = decltype(io_stream_transcode_deco_filter_define(
		io_stream_transcode_deco_filter_ref_define(::ufio::freestanding::move(rf.iobptr->handle)), deco));
	return ::ufio::basic_io_buffer<
		newtype, ::ufio::basic_io_buffer_traits<
					 ...
					 ::ufio::details::compute_transcode_buffer_size(
