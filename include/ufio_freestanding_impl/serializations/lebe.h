...
inline constexpr ::std::size_t size_lebe_float_size{::ufio::details::cal_size_lebe_floatsize<floattype>()};
...
template <::std::endian en, ::std::size_t sz, ::ufio::details::my_integral int_type>
	requires(!::std::is_const_v<int_type> && ::ufio::details::supported_lebe_size<sz>)
...
template <::std::size_t sz, ::ufio::details::my_integral int_type>
	requires(!::std::is_const_v<int_type> && ::ufio::details::supported_lebe_size<sz>)
...
template <::std::endian en, ::std::size_t sz, ::ufio::details::my_integral int_type>
	requires ::ufio::details::supported_lebe_size<sz>
inline constexpr auto lebe_put(int_type t) noexcept(
	(::std::numeric_limits<::ufio::details::my_make_unsigned_t<::std::remove_cvref_t<int_type>>>::digits) <= sz)
{
	using uint_type = ::ufio::details::my_make_unsigned_t<::std::remove_cvref_t<int_type>>;
	...
	if constexpr (sz < (::std::numeric_limits<uint_type>::digits))
	{
		...
		if (u > mx_value)
		{
			throw_parse_code(::ufio::parse_code::invalid);
		}
	}
	using proxy_type = ::std::conditional_t<
		(sz == 128), ::ufio::details::pesudo_int128type,
		::std::conditional_t<
...
inline constexpr auto iec559_lebe_put(T t)
{
	...
	if constexpr (::std::same_as<nocvref, float>)
	{
		...
		{
			return ::ufio::manipulators::lebe_put<en, 32>(
	...
	else if constexpr (::std::same_as<nocvref, double>)
	{
		if constexpr (isiec559)
		{
			return ::ufio::manipulators::lebe_put<en, 64>(
	...
	else if constexpr (::std::same_as<nocvref, long double>)
	{
		...
		using proxy_type = ::ufio::details::pesudo_int128type;
		return ::ufio::manipulators::basic_lebe_get_put<en, basic_lebe_put_integral<128, proxy_type>>{
			{::std::bit_cast<::ufio::details::pesudo_int128type>(static_cast<_Float128>(t))}};
#else
	...
	{
		return ::ufio::manipulators::lebe_put<en, 8>(::std::bit_cast<::std::uint_least8_t>(static_cast<nocvref>(t)));
	}
	else if constexpr (sizeof(T) == sizeof(::std::uint_least16_t))
	{
		return ::ufio::manipulators::lebe_put<en, 16>(
	...
	else if constexpr (sizeof(T) == sizeof(::ufio::details::pesudo_int128type))
	{
		using proxy_type = ::ufio::details::pesudo_int128type;
		return ::ufio::manipulators::basic_lebe_get_put<en, basic_lebe_put_integral<128, proxy_type>>{
			{::std::bit_cast<::ufio::details::pesudo_int128type>(static_cast<nocvref>(t))}};
	}
}
...
{
	return ::ufio::manipulators::iec559_lebe_put<::std::endian::little>(t);
}

template <::std::floating_point T>
inline constexpr auto iec559_be_put(T t)
{
	return ::ufio::manipulators::iec559_lebe_put<::std::endian::big>(t);
}
...
inline constexpr auto iec559_lebe_get(T &t) noexcept
{
	...
	return ::ufio::manipulators::basic_lebe_get_put<
		en,
		::ufio::manipulators::basic_lebe_get_integral<::ufio::details::cal_size_lebe_floatsize<nocvreft>(), T>>{
...
{
	return ::ufio::manipulators::iec559_lebe_get<::std::endian::little>(t);
}

template <::std::floating_point T>
inline constexpr auto iec559_be_get(T &t)
{
	return ::ufio::manipulators::iec559_lebe_get<::std::endian::big>(t);
}
	...
	scan_precise_reserve_define_integer_common_largechartype_impl(char_type const *iter) noexcept
{
	...
	if constexpr (::std::endian::native != endn)
	{
		...
		else
		{
			...
			t.low = ::ufio::byte_swap(high);
			t.high = ::ufio::byte_swap(low);
		}
	}
	return {false, t};
}
...
template <::std::endian endn, ::std::size_t n, ::ufio::details::my_integral int_type, ::std::integral char_type>
inline constexpr ::std::conditional_t<(1 < sizeof(char_type)), ::ufio::parse_code, void>
scan_precise_reserve_define_integer_impl(char_type const *iter, int_type &t) noexcept
{
	static_assert(n <= 128);
	using proxy_type = ::std::conditional_t<
		(n == 128), ::ufio::details::pesudo_int128type,
		::std::conditional_t<
	...
	using my_unsigned_type = ::ufio::details::my_make_unsigned_t<int_type>;
...
scan_precise_reserve_define_lebe_float_get_impl(char_type const *iter, flttypef &t) noexcept
{
	...
	constexpr ::std::size_t n{::ufio::details::size_lebe_float_size<flttype>};
	using proxy_type = ::std::conditional_t<
		(n == 128), ::ufio::details::pesudo_int128type,
		::std::conditional_t<
			(n == 64), ::std::uint_least64_t,
	...
	print_reserve_define_integer_lebe_common_impl(char_type *iter, uint_type u) noexcept
{
	...
	if constexpr (::std::endian::native != endn)
	{
		if constexpr (::ufio::details::my_unsigned_integral<uint_type>)
		{
			u = ::ufio::byte_swap(u);
		}
		else
		{
			...
			u.low = ::ufio::byte_swap(high);
			u.high = ::ufio::byte_swap(low);
		}
	}
#if __cpp_lib_bit_cast >= 201806L && (__cpp_if_consteval >= 202106L || __cpp_lib_is_constant_evaluated >= 201811L)
#if __cpp_if_consteval >= 202106L
...
#endif
	{
		::ufio::freestanding::array<char unsigned, n> buffer{
			::std::bit_cast<::ufio::freestanding::array<char unsigned, n>>(u)};
...
#endif
	{
		...
		{
			auto buffer{::std::bit_cast<::ufio::freestanding::array<char unsigned, n>>(u)};
			non_overlapped_copy_n(buffer.data(), n, iter);
		}
		else
		{
...
template <::std::integral char_type, ::std::endian end, ::std::size_t sz, typename int_type>
	requires(((sz % (::std::numeric_limits<char unsigned>::digits)) == 0) && !::std::is_const_v<int_type> &&
			 (::ufio::details::my_integral<int_type> ||
			  (::std::floating_point<int_type> && (::ufio::details::size_lebe_float_size<int_type>) == sz)))
inline constexpr ::std::size_t scan_precise_reserve_size(
	io_reserve_type_t<char_type, ::ufio::manipulators::basic_lebe_get_put<
									 end, ::ufio::manipulators::basic_lebe_get_integral<sz, int_type>>>) noexcept
{
...
inline constexpr auto scan_precise_reserve_define(
	io_reserve_type_t<char_type, ::ufio::manipulators::basic_lebe_get_put<
									 en, ::ufio::manipulators::basic_lebe_get_integral<sz, int_type>>>,
	char_type const *iter,
	::ufio::manipulators::basic_lebe_get_put<en, ::ufio::manipulators::basic_lebe_get_integral<sz, int_type>>
		t) noexcept
{
	if constexpr (::std::floating_point<int_type>)
	{
		return ::ufio::details::scan_precise_reserve_define_lebe_float_get_impl<en>(iter, *t.reference.pointer);
	}
	else
	{
		return ::ufio::details::scan_precise_reserve_define_integer_impl<en, sz>(iter, *t.reference.pointer);
	}
}

template <::std::integral char_type, ::std::endian end, ::std::size_t sz, typename int_type>
	requires(((sz % (::std::numeric_limits<char unsigned>::digits)) == 0) &&
			 (::ufio::details::my_unsigned_integral<int_type> ||
			  ::std::same_as<int_type, ::ufio::details::pesudo_int128type>))
inline constexpr ::std::size_t print_reserve_size(
	io_reserve_type_t<char_type, ::ufio::manipulators::basic_lebe_get_put<
									 end, ::ufio::manipulators::basic_lebe_put_integral<sz, int_type>>>) noexcept
{
	constexpr ::std::size_t cache{sz / (::std::numeric_limits<char unsigned>::digits)};
	return cache;
}
...
inline constexpr auto print_reserve_define(
	io_reserve_type_t<char_type, ::ufio::manipulators::basic_lebe_get_put<
									 end, ::ufio::manipulators::basic_lebe_put_integral<sz, int_type>>>,
	char_type *iter,
	::ufio::manipulators::basic_lebe_get_put<end, ::ufio::manipulators::basic_lebe_put_integral<sz, int_type>>
		v) noexcept
{
	return ::ufio::details::print_reserve_define_integer_lebe_common_impl<end>(iter, v.reference.value);
}
