...
scan_context_define_str_get_all_general_strlike_impl(char_type const *first, char_type const *last,
													 io_strlike_reference_wrapper<char_type, T> output, ::std::size_t n,
													 ::ufio::details::basic_concat_buffer<char_type> &ctx)
{
...
inline constexpr io_type_t<
	::std::conditional_t<::ufio::buffer_strlike<char_type, T>, ::ufio::details::str_get_all_context,
						 ::ufio::details::basic_concat_buffer<char_type>>>
scan_context_type(
	io_reserve_type_t<char_type,
					  ::ufio::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>>>) noexcept
{
	return {};
}
...
inline constexpr parse_result<char_type const *> scan_context_define(
	io_reserve_type_t<char_type,
					  ::ufio::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>>>,
	ctxtype &ctx, char_type const *first, char_type const *last,
	::ufio::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>> str)
{
	if constexpr (::ufio::buffer_strlike<char_type, T>)
	{
		return ::ufio::details::scan_context_define_str_get_all_buffer_strlike_impl(first, last, str.reference,
																					   str.n, ctx.copying);
	}
	else
	{
		return ::ufio::details::scan_context_define_str_get_all_general_strlike_impl(first, last, str.reference,
																						str.n, ctx);
	}
}
...
inline constexpr parse_code scan_context_eof_define(
	io_reserve_type_t<char_type,
					  ::ufio::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>>>,
	ctxtype &, ::ufio::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>>)
{
