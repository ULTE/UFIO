...
template <typename allocator, typename T>
	requires(::ufio::transcoder<T> || ::ufio::byte_transcoder<T>)
struct transcoder_file_derived final : transcoder_file_base
{
	T object;
	explicit constexpr basic_transcoder_file(::ufio::io_cookie_type_t<T>, Args &&args...)
	...
	{
		::std::destroy(this);
		::ufio::typed_allocator_adapter<allocator, ::ufio::transcoder_file_derived<allocator, T>>::deallocate(this, 1);
	}
};
...
public:
	...
	explicit constexpr basic_transcoder_file(::ufio::io_cookie_type_t<T>, Args &&args...)
		: transcoder_io_observer{::std::construct_at(typed_allocator_adapter<allocator, ::ufio::transcoder_file_derived<allocator, T>>::allocate(1), ::ufio::io_cookie_type<T>, ::std::forward<Args>(args)...)}
	{
	}
