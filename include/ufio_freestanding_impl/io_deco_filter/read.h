									   ...
									   input_char_type *first, input_char_type *last, ::std::size_t sz)
{
	using typed_allocator_type =
		::ufio::typed_generic_allocator_adapter<allocator_type, typename instmtype::input_char_type>;
	...
	for (;;)
	{
		...
		auto ret{::ufio::operations::decay::read_some_decay(instm, bufbg, bufbg + sz)};
...
{
	return ::ufio::details::decoread_some_underflow_define_sz_impl<allocator_type>(instm, indeco, input_buffer,
																					  first, last, sz);
}
						   ...
						   typename io_buffer_type::input_char_type *last)
{
	...
	return ::ufio::details::decoread_some_underflow_define_impl<typename traits_type::allocator_type,
																   traits_type::input_buffer_size>(
		::ufio::operations::input_stream_ref(idoref.handle),
		::ufio::operations::refs::input_decorators_ref(idoref.decorators), idoref.input_buffer, first, last);
}
