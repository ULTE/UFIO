...
{
	return ::ufio::details::day_diff(tsp_after.year, tsp_after.month, tsp_after.day, tsp_before.year,
															 ...
															 char_type *__restrict dest) noexcept
{
	for (; first != last; ++first)
	{
		*dest = ::ufio::char_category::to_c_lower(*first);
		++dest;
	}
	return dest;
}
											  ...
											  basic_io_scatter_t<char_type> const &format_str) noexcept
{
	...
	{
		auto p{::ufio::freestanding::find(i, end_it, char_literal_v<u8'%', char_type>)};
											 ...
											 basic_io_scatter_t<char_type> const &format_str)
{
	for (char_type const *i{format_str.base}, *end_it{i + format_str.len}; i != end_it; ++i)
	{
		char_type const *p{::ufio::freestanding::find(i, end_it, char_literal_v<u8'%', char_type>)};
			...
			case char_literal_v<u8'Y', char_type>:
			{
				...
				if (era_result != era_scatter_end) [[likely]]
				{
					...
					default:
					{
						...
						if (::ufio::details::intrinsics::sub_underflow(tsp.year, real_era_year_offset,
																		  era_year)) [[unlikely]]
						{
							if (omit)
							{
...
template <::ufio::manipulators::lc_time_flag flag>
inline constexpr ::ufio::manipulators::scalar_flags base_lc_time_flags_cache{.time_flag = flag};
...
*/
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::d_t_fmt>,
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::d_fmt>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::t_fmt>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::t_fmt_ampm>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::date_fmt>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::era_d_t_fmt>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::era_d_fmt>,
								iso8601_timestamp const &>
...
inline constexpr scalar_manip_t<::ufio::details::base_lc_time_flags_cache<lc_time_flag::era_t_fmt>,
								iso8601_timestamp const &>
...
print_reserve_size(basic_lc_all<char_type> const *all,
				   ::ufio::manipulators::scalar_manip_t<flags, iso8601_timestamp const &> tsp) noexcept
{
