...
#endif
inline void
chacha_simd16_qr4_round_impl(::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict a,
							 ::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict b,
							 ::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict c,
							 ::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict d) noexcept
{
								   ...
								   ::std::uint_least32_t const *__restrict indata) noexcept
{
	...
	::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> a, b, c, d;
	a.load(indata);
	b.load(indata + 4);
	c.load(indata + 8);
	d.load(indata + 12);
	...
	::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> t;
	t.load(indata);
	a += t;
	t.load(indata + 4);
	b += t;
