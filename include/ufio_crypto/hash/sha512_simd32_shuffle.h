...
#endif
inline void
sha512_simd32_byte_swap_message_4rounds(::ufio::intrinsics::simd_vector<::std::uint_least64_t, 4> &__restrict s1,
...
inline void sha512_simd32_compute_message_4rounds(
	::ufio::intrinsics::simd_vector<::std::uint_least64_t, 2> &__restrict s1, ::std::uint_least64_t *__restrict w,
