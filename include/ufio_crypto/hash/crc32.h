...
#endif
	{
		auto a{::std::bit_cast<::ufio::freestanding::array<::std::byte, sizeof(::std::uint_least32_t)>>(crc)};
		::ufio::freestanding::nonoverlapped_bytes_copy_n(a.data(), a.size(), ptr);
	}
	else
#endif
	{
		::ufio::freestanding::nonoverlapped_bytes_copy_n(
...
public:
	...
	{
		::ufio::details::crc32_to_byte_ptr_commom_impl(crcv, ptr);
	}
};
} // namespace details

using crc32_context = ::ufio::details::basic_crc32_scalar_context<::ufio::details::crc32_option::crc32>;
using crc32c_context = ::ufio::details::basic_crc32_scalar_context<::ufio::details::crc32_option::crc32c>;
