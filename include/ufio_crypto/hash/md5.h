...
#endif
		{
			::ufio::details::md5::md5_main(this->state, block_start, block_last);
		}
		else
#endif
		{
			...
			{
				::ufio::details::md5::md5_main_le(this->state, block_start, block_last);
			}
			else
			{
				::ufio::details::md5::md5_main(this->state, block_start, block_last);
...
struct md5_initializer
{
	...
	static inline constexpr ::ufio::details::md5::md5 initialize_value{
...
#endif
	= ::ufio::details::basic_md5_sha_context_impl<::ufio::details::md5::md5,
													 ::ufio::details::md5::md5_initializer, 64>;
} // namespace ufio
