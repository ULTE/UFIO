...
#endif
inline void
sha256_simd16_byte_swap_message_4rounds(::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict s1,
...
#endif
inline void
sha256_simd16_compute_message_4rounds(::ufio::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict s1,
									  ...
									  ::std::size_t round) noexcept
{
	...
	*/
	...
	s1.store(w + round);
	s0.load(::ufio::details::sha256::K256 + round);
	s0.wrap_add_assign(s1);
	s0.store(wt + round);
}
