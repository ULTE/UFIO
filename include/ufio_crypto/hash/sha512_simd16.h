...
#endif
inline void
sha512_simd16_byte_swap_message_2rounds(::ufio::intrinsics::simd_vector<::std::uint_least64_t, 2> &__restrict s1,
										...
										::std::uint_least64_t *__restrict wt, ::std::uint_fast16_t round) noexcept
{
	...
	s0.load(::ufio::details::sha512::K512 + round);
...
#endif
inline void
sha512_simd16_compute_message_2rounds(::ufio::intrinsics::simd_vector<::std::uint_least64_t, 2> &__restrict s1,
									  ...
									  ::std::uint_fast8_t round) noexcept
{
	...
	!defined(__AVX2__) && defined(__ELF__) && defined(UFIO_RUNTIME_DISPATCH)
...
{
	using namespace ufio::intrinsics;
	using namespace ufio::details::sha512;
