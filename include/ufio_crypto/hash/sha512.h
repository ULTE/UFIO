												   ...
												   ::std::byte const *__restrict ed) noexcept
{
	...
	while (data != ed)
	{
		...
		for (; i < 16; ++i)
		{
			...
			{
				::std::uint_least64_t value;
				::ufio::details::my_memcpy(__builtin_addressof(value), data, 8);
...
#include "sha512_scalar.h"
	...
	__has_cpp_attribute(__gnu__::__target__) && defined(__ELF__) && defined(UFIO_RUNTIME_DISPATCH)
...
#endif
		{
			::ufio::details::sha512::sha512_do_constexpr_function(state, blocks_start, blocks_last);
		}
		else
#endif
		{
			::ufio::details::sha512::sha512_runtime_routine(state, blocks_start, blocks_last);
		}
	}
};
...
struct sha512_initializer
{
	...
	static inline constexpr ::ufio::details::sha512::sha512 initialize_value{
...
using sha512_224_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha512::sha512,
												   ::ufio::details::sha512::sha512_224_initializer, 128>;
using sha512_256_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha512::sha512,
												   ::ufio::details::sha512::sha512_256_initializer, 128>;
using sha384_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha512::sha512,
												   ::ufio::details::sha512::sha384_initializer, 128>;
using sha512_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha512::sha512,
												   ::ufio::details::sha512::sha512_initializer, 128>;
} // namespace ufio
