								 ...
								 ::std::byte const *__restrict blocks_last) noexcept
{
	...
	using namespace ufio::details::sha256;
	while (data != blocks_last)
	{
		...
		for (; i < 16; ++i)
		{
...
#endif
			{
				...
				::ufio::details::my_memcpy(__builtin_addressof(value), data, 4);
	...
	!defined(__clang__) && defined(__ELF__) && defined(UFIO_RUNTIME_DISPATCH)
...
#endif
		{
			::ufio::details::sha256::sha256_do_constexpr_function(this->state, blocks_start, blocks_last);
		}
		else
#endif
		{
			::ufio::details::sha256::sha256_runtime_routine(this->state, blocks_start, blocks_last);
		}
	}
};
...
struct sha224_initializer
{
	...
	static inline constexpr ::ufio::details::sha256::sha256 initialize_value{
...
using sha224_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha256::sha256,
												   ::ufio::details::sha256::sha224_initializer, 64>;
using sha256_context =
	::ufio::details::basic_md5_sha_context_impl<::ufio::details::sha256::sha256,
												   ::ufio::details::sha256::sha256_initializer, 64>;
} // namespace ufio
