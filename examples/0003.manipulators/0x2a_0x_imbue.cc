...
int main()
{
	...
	println(imbue(loc, ufio::c_stdout()), middle(hex0x(420000U), 11, '-'), "\t", addrvw(420000U), "\n",
...
D:\hg\ufio\examples\0003.manipulators>g++ -o 0x2a_0x_imbue 0x2a_0x_imbue.cc -Ofast -std=c++23 -s -flto -march=native
-I../../include

D:\hg\ufio\examples\0003.manipulators>0x2a_0x_imbue
